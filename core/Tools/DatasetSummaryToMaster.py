...
class ParseProfileData(object):
    ...
    def __init__(self,XMLFileName):        
        ...
        self.ClearDatabaseDetails="DELETE FROM tablessummary where databasename=%s;"
        
        
        Params=(self.Options['PGDB:DBName'],)
              
        self.MasterCursor.execute(self.ClearDatabaseDetails,Params)   
