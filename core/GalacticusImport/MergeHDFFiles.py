...
if __name__ == '__main__':
    ...
    IndexInputFilePath='/lustre/projects/p014_swin/raw_data/galacticus/galacticus.h5'
    DataInputFilePath='/lustre/projects/p014_swin/raw_data/galacticus/original/galacticus.h5'
    OutputFilePath='/lustre/projects/p014_swin/raw_data/galacticus/galacticus_Output.h5'
    ...
    for RecordIndex in range(0,len(IndexInputFile['tree_counts'])):
        if IndexInputFile['tree_counts'][RecordIndex]>0:
            TotalRecordsCount=TotalRecordsCount+IndexInputFile['tree_counts'][RecordIndex]
    ...
    for RecordIndex in range(0,len(IndexInputFile['tree_displs'])):
        ...
        RecordsCount=IndexInputFile['tree_counts'][RecordIndex]
        if RecordsCount>0:
    ...
    OutputFile.create_dataset("tree_counts", data=IndexInputFile['tree_counts'])
