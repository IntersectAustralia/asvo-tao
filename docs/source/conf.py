# -*- coding: utf-8 -*-
#
# All Sky Virtual Observatory documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.coverage', 'sphinx.ext.pngmath', 'sphinx.ext.mathjax', 'sphinx.ext.viewcode', 'breathe']
...
version = settings.TAO_VERSION
# The full version, including alpha/beta/rc tags.
release = settings.TAO_VERSION
...
breathe_projects = { 'science_modules' : os.path.abspath('../doxyxml/xml') }

breathe_default_project = 'science_modules'
