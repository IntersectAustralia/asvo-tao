...
* **summary**: for each table it contain the bounding box details (minx,miny,minz,maxx,maxy,maxz), the minmimum and maximum snapshot number, and the records count.
