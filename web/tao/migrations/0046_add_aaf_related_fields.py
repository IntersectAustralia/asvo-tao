...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tao_taouser', 'account_registration_status',
                      self.gf('django.db.models.fields.CharField')(default='NA', max_length=3),
                      keep_default=False)
        ...
        db.add_column(u'tao_taouser', 'account_registration_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaoUser.aaf_shared_token'
        db.delete_column(u'tao_taouser', 'aaf_shared_token')

        # Deleting field 'TaoUser.account_registration_status'
        db.delete_column(u'tao_taouser', 'account_registration_status')

        # Deleting field 'TaoUser.account_registration_reason'
        db.delete_column(u'tao_taouser', 'account_registration_reason')

        # Deleting field 'TaoUser.account_registration_date'
        db.delete_column(u'tao_taouser', 'account_registration_date')
