...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tao_dataset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('simulation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tao.Simulation'])),
            ('galaxy_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tao.GalaxyModel'])),
        ))
        db.send_create_signal('tao', ['DataSet'])
