...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BandPassFilter.group'
        db.add_column(u'tao_bandpassfilter', 'group',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)

        # Adding field 'BandPassFilter.order'
        db.add_column(u'tao_bandpassfilter', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DataSetProperty.group'
        db.add_column(u'tao_datasetproperty', 'group',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)

        # Adding field 'DataSetProperty.order'
        db.add_column(u'tao_datasetproperty', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BandPassFilter.group'
        db.delete_column(u'tao_bandpassfilter', 'group')

        # Deleting field 'BandPassFilter.order'
        db.delete_column(u'tao_bandpassfilter', 'order')

        # Deleting field 'DataSetProperty.group'
        db.delete_column(u'tao_datasetproperty', 'group')

        # Deleting field 'DataSetProperty.order'
        db.delete_column(u'tao_datasetproperty', 'order')
    ...
    models = {
        ...
        u'tao.bandpassfilter': {
            ...
            'group': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tao.globalparameter': {
            ...
            'parameter_value': ('django.db.models.fields.CharField', [], {'max_length': '60'})
        },
        u'tao.job': {
