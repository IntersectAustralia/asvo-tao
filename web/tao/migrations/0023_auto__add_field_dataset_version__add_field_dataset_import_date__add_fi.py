...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tao_dataset', 'version',
                      self.gf('django.db.models.fields.DecimalField')(default='1.0', max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'DataSet.import_date'
        db.add_column('tao_dataset', 'import_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 1, 16, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DataSet.available'
        db.add_column('tao_dataset', 'available',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tao_dataset', 'version')

        # Deleting field 'DataSet.import_date'
        db.delete_column('tao_dataset', 'import_date')

        # Deleting field 'DataSet.available'
        db.delete_column('tao_dataset', 'available')
    ...
    models = {
        ...
        'tao.dataset': {
            ...
            'version': ('django.db.models.fields.DecimalField', [], {'default': '1.0', 'max_digits': '10', 'decimal_places': '2'})
        },
        'tao.datasetproperty': {
