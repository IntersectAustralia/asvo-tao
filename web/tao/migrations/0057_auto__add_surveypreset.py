...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SurveyPreset'
        db.create_table(u'tao_surveypreset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('parameters', self.gf('django.db.models.fields.TextField')(max_length=1000000)),
        ))
        db.send_create_signal(u'tao', ['SurveyPreset'])


    def backwards(self, orm):
        # Deleting model 'SurveyPreset'
        db.delete_table(u'tao_surveypreset')
