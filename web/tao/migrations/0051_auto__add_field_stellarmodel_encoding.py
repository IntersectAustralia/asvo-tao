...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StellarModel.encoding'
        db.add_column(u'tao_stellarmodel', 'encoding',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StellarModel.encoding'
        db.delete_column(u'tao_stellarmodel', 'encoding')
