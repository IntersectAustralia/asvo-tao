...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GlobalParameter.parameter_value'
        db.alter_column(u'tao_globalparameter', 'parameter_value', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'GlobalParameter.parameter_value'
        db.alter_column(u'tao_globalparameter', 'parameter_value', self.gf('django.db.models.fields.CharField')(max_length=60))
