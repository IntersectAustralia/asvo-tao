...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSet.default_filter_field'
        db.add_column('tao_dataset', 'default_filter_field',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='DataSetProperty', null=True, to=orm['tao.DataSetProperty']),
                      keep_default=False)

        # Adding field 'DataSet.default_filter_min'
        db.add_column('tao_dataset', 'default_filter_min',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'DataSet.default_filter_max'
        db.add_column('tao_dataset', 'default_filter_max',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSet.default_filter_field'
        db.delete_column('tao_dataset', 'default_filter_field_id')

        # Deleting field 'DataSet.default_filter_min'
        db.delete_column('tao_dataset', 'default_filter_min')

        # Deleting field 'DataSet.default_filter_max'
        db.delete_column('tao_dataset', 'default_filter_max')
    ...
    models = {
        ...
        'tao.dataset': {
            ...
            'default_filter_field': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'DataSetProperty'", 'null': 'True', 'to': "orm['tao.DataSetProperty']"}),
            'default_filter_max': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'default_filter_min': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
