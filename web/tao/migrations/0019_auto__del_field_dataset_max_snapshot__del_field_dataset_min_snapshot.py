...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DataSet.max_snapshot'
        db.delete_column('tao_dataset', 'max_snapshot')

        # Deleting field 'DataSet.min_snapshot'
        db.delete_column('tao_dataset', 'min_snapshot')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DataSet.max_snapshot'
        raise RuntimeError("Cannot reverse this migration. 'DataSet.max_snapshot' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DataSet.min_snapshot'
        raise RuntimeError("Cannot reverse this migration. 'DataSet.min_snapshot' and its values cannot be restored.")
