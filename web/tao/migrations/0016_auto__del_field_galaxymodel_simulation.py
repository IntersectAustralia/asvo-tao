...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GalaxyModel.simulation'
        db.delete_column('tao_galaxymodel', 'simulation_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GalaxyModel.simulation'
        raise RuntimeError("Cannot reverse this migration. 'GalaxyModel.simulation' and its values cannot be restored.")
