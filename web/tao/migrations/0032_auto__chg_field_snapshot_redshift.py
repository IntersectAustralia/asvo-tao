...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tao_snapshot', 'redshift', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=3))
    ...
    models = {
        ...
        'tao.snapshot': {
            ...
            'dataset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tao.DataSet']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'redshift': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '3'})
        },
        'tao.stellarmodel': {
