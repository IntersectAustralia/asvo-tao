...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        objs = orm.GlobalParameter.objects.filter(parameter_name='maximum-random-light-cones')
        if len(objs) == 0:
            obj = orm.GlobalParameter(parameter_name='maximum-random-light-cones', parameter_value='10',description="Maximum number of random light-cones")
            obj.save()
