...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StellarModel.label'
        db.add_column('tao_stellarmodel', 'label',
                      self.gf('django.db.models.fields.CharField')(default='stellar model', unique=True, max_length=200),
                      keep_default=False)

        # Adding unique constraint on 'StellarModel', fields ['name']
        db.create_unique('tao_stellarmodel', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'StellarModel', fields ['name']
        db.delete_unique('tao_stellarmodel', ['name'])

        # Deleting field 'StellarModel.label'
        db.delete_column('tao_stellarmodel', 'label')
