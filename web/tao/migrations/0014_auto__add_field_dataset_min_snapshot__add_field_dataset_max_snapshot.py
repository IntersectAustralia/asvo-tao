...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSet.min_snapshot'
        db.add_column('tao_dataset', 'min_snapshot',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=9),
                      keep_default=False)

        # Adding field 'DataSet.max_snapshot'
        db.add_column('tao_dataset', 'max_snapshot',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=9),
                      keep_default=False)
