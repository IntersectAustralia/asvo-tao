...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BandPassFilter', fields ['filter_id']
        db.create_unique('tao_bandpassfilter', ['filter_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BandPassFilter', fields ['filter_id']
        db.delete_unique('tao_bandpassfilter', ['filter_id'])
