...
class Migration(DataMigration):
    ...
    EMAILS = [
            ...
            'Template for job status update, html version. Use {{ user }} and {{ job }} template variables'),
            ('job-status.txt',
            'Dear {{ user.username }},\n'
            '\n'
            'Your TAO Job {{ job.id }} has completed.\n',
            'Template for job status update, text version. Use {{ user }} and {{ job }} template variables'),
        ]
