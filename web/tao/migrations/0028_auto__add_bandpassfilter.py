...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BandPassFilter'
        db.create_table('tao_bandpassfilter', (
            ...
            ('filter_id', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('tao', ['BandPassFilter'])


    def backwards(self, orm):
        # Deleting model 'BandPassFilter'
        db.delete_table('tao_bandpassfilter')
    ...
    models = {
        ...
        'tao.bandpassfilter': {
            ...
            'filter_id': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
