...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('tao_datasetparameter')

        # Adding model 'DataSetProperty'
        db.create_table('tao_datasetproperty', (
            ...
            ('dataset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tao.DataSet'])),
            ...
            ('is_filter', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_output', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal('tao', ['DataSetProperty'])


    def backwards(self, orm):
        # Adding model 'DataSetParameter'
        db.create_table('tao_datasetparameter', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('units', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('dataset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tao.DataSet'])),
        ...
        db.send_create_signal('tao', ['DataSetParameter'])

        # Deleting model 'DataSetProperty'
        db.delete_table('tao_datasetproperty')
