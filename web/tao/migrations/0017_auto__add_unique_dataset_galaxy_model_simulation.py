...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DataSet', fields ['galaxy_model', 'simulation']
        db.create_unique('tao_dataset', ['galaxy_model_id', 'simulation_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataSet', fields ['galaxy_model', 'simulation']
        db.delete_unique('tao_dataset', ['galaxy_model_id', 'simulation_id'])
