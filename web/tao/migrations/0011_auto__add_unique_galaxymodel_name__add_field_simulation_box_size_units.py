...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSetParameter.units'
        db.add_column('tao_datasetparameter', 'units',
                      self.gf('django.db.models.fields.CharField')(default='Mpc', max_length=20),
                      keep_default=False)

        # Adding field 'Simulation.box_size_units'
        db.add_column('tao_simulation', 'box_size_units',
                      self.gf('django.db.models.fields.CharField')(default='Mpc', max_length=10),
                      keep_default=False)


        # Changing field 'Simulation.box_size'
        db.alter_column('tao_simulation', 'box_size', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3))
        # Adding field 'DataSet.database'
        db.add_column('tao_dataset', 'database',
                      self.gf('django.db.models.fields.CharField')(default='dataset database', max_length=200),
                      keep_default=False)

        # Adding field 'DataSet.box_size'
        db.add_column('tao_dataset', 'box_size',
                      self.gf('django.db.models.fields.IntegerField')(default=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSetParameter.units'
        db.delete_column('tao_datasetparameter', 'units')

        # Deleting field 'Simulation.box_size_units'
        db.delete_column('tao_simulation', 'box_size_units')


        # Changing field 'Simulation.box_size'
        db.alter_column('tao_simulation', 'box_size', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'DataSet.database'
        db.delete_column('tao_dataset', 'database')

        # Deleting field 'DataSet.box_size'
        db.delete_column('tao_dataset', 'box_size')
    ...
    models = {
        ...
        'tao.dataset': {
            ...
            'box_size': ('django.db.models.fields.IntegerField', [], {}),
