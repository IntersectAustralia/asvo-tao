...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Snapshot.redshift'
        db.alter_column('tao_snapshot', 'redshift', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

    def backwards(self, orm):

        # Changing field 'Snapshot.redshift'
        db.alter_column('tao_snapshot', 'redshift', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5))
