...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tao_snapshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dataset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tao.DataSet'])),
            ('redshift', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5)),
        ))
        db.send_create_signal('tao', ['Snapshot'])

        # Adding unique constraint on 'Snapshot', fields ['dataset', 'redshift']
        db.create_unique('tao_snapshot', ['dataset_id', 'redshift'])


    def backwards(self, orm):
        # Removing unique constraint on 'Snapshot', fields ['dataset', 'redshift']
        db.delete_unique('tao_snapshot', ['dataset_id', 'redshift'])

        # Deleting model 'Snapshot'
        db.delete_table('tao_snapshot')
