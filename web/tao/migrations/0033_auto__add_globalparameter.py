...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GlobalParameter'
        db.create_table('tao_globalparameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parameter_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60)),
            ('parameter_value', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal('tao', ['GlobalParameter'])


    def backwards(self, orm):
        # Deleting model 'GlobalParameter'
        db.delete_table('tao_globalparameter')
