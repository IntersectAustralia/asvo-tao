...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StellarModel.description'
        db.add_column('tao_stellarmodel', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StellarModel.description'
        db.delete_column('tao_stellarmodel', 'description')
