...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GalaxyModel.kind'
        db.delete_column('tao_galaxymodel', 'kind')

        # Deleting field 'GalaxyModel.paper_url'
        db.delete_column('tao_galaxymodel', 'paper_url')

        # Deleting field 'GalaxyModel.paper_title'
        db.delete_column('tao_galaxymodel', 'paper_title')

        # Adding field 'GalaxyModel.details'
        db.add_column('tao_galaxymodel', 'details',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GalaxyModel.kind'
        db.add_column('tao_galaxymodel', 'kind',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'GalaxyModel.paper_url'
        db.add_column('tao_galaxymodel', 'paper_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'GalaxyModel.paper_title'
        db.add_column('tao_galaxymodel', 'paper_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'GalaxyModel.details'
        db.delete_column('tao_galaxymodel', 'details')
