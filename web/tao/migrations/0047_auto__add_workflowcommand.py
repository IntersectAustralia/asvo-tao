...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkflowCommand'
        db.create_table(u'tao_workflowcommand', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tao.Job'])),
            ('issued', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tao.TaoUser'])),
            ('command', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('parameters', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True)),
            ('executed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('execution_status', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('execution_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'tao', ['WorkflowCommand'])


    def backwards(self, orm):
        # Deleting model 'WorkflowCommand'
        db.delete_table(u'tao_workflowcommand')
