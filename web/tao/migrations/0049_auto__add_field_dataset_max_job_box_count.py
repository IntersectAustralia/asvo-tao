...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSet.max_job_box_count'
        db.add_column(u'tao_dataset', 'max_job_box_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSet.max_job_box_count'
        db.delete_column(u'tao_dataset', 'max_job_box_count')
