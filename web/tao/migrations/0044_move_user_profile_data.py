...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for user_profile in orm.UserProfile.objects.all():
            try:
                ...
                user.title = user_profile.title
                user.institution = user_profile.institution
                user.scientific_interests = user_profile.scientific_interests
                user.rejected = user_profile.rejected
                user.save()
            except:
                pass
    ...
    models = {
        ...
        u'tao.userprofile': {
            ...
            'scientific_interests': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tao.TaoUser']", 'unique': 'True'})
        }
    }
