...
def run():
    ...
    tao_stellarmodel_3.description = u'<p>External link: <a href="http://people.ucsc.edu/~conroy/FSPS.html" target="_blank">Flexible Stellar Population Synthesis (FSPS)</a></p>\r\n<ul>\r\n<li>All magnitudes assume the simulation little h value from General Properties</li>\r\n<li>Magnitudes are calculated in the AB system</li>\r\n<li>Note that BC03 & Conroy can take up to 4 times longer to process than Maraston based catalogues.  This is currently being optimised, but please be aware of this for now.</li>\r\n</ul>\r\n<p>Additional information is available from the <a href="../static/docs/user-manual/sed.html" target="_blank">SED Module documentation</a>.</p>'
    ...
    tao_stellarmodel_8.encoding = u'<single-stellar-population-model>bc03/ssp_chabrier.dat</single-stellar-population-model>\r\n<wavelengths-file>bc03/wavelengths.dat</wavelengths-file>\r\n<ages-file>bc03/ages.dat</ages-file>\r\n<metallicities-file>bc03/metallicities.dat</metallicities-file>\r\n'
    ...
    tao_globalparameter_9.parameter_value = u'Dear {{ user.first_name }} {{ user.last_name }},\r\n\r\nYour TAO Catalogue {{ job.id }} has completed.\r\n\r\nPlease view your catalogue at: http://tao.asvo.org.au/tao/jobs/{{ job.id }}\r\n\r\nDescription:\r\n\r\n{{ job.description|linebreaks }}'
    ...
    tao_globalparameter_10.parameter_value = u'<p><strong>Production User:</strong> {{ user.username }}</p>\r\n\r\n{{ message }}'
    ...
    tao_globalparameter_11.parameter_value = u'Production User: {{ user.username }}\r\n\r\n{{ message }}'
    ...
    tao_globalparameter_15.description = u"This will be the default quota applied unless over-ridden for an individual user. Values are in MB, and interpreted as per user quota. If absent or equal to -1, disk quotas aren't enforced."
    ...
    tao_globalparameter_16.parameter_value = u'32'
    ...
    tao_workflowcommand_1.job_id = None
    tao_workflowcommand_1.issued = datetime.datetime(2013, 9, 19, 3, 42, 4, tzinfo=pytz.UTC)
    tao_workflowcommand_1.command = u'Job_Output_Delete'
    tao_workflowcommand_1.parameters = u'alistair'
    tao_workflowcommand_1.executed = datetime.datetime(2013, 9, 19, 3, 42, 4, tzinfo=pytz.UTC)
    tao_workflowcommand_1.execution_status = u'COMPLETED'
    tao_workflowcommand_1.execution_comment = u'Job 336 successfully deleted.'
    tao_workflowcommand_1 = save_or_locate(tao_workflowcommand_1)

    tao_workflowcommand_2 = WorkflowCommand()
    tao_workflowcommand_2.job_id = None
    tao_workflowcommand_2.issued = datetime.datetime(2013, 9, 19, 10, 3, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_2.command = u'Job_Output_Delete'
    tao_workflowcommand_2.parameters = u'alistair'
    tao_workflowcommand_2.executed = datetime.datetime(2013, 9, 19, 10, 3, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_2.execution_status = u'COMPLETED'
    tao_workflowcommand_2.execution_comment = u'Job 178 successfully deleted.'
    ...
    tao_workflowcommand_3.issued = datetime.datetime(2013, 9, 19, 10, 4, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_3.command = u'Job_Output_Delete'
    tao_workflowcommand_3.parameters = u'alistair'
    tao_workflowcommand_3.executed = datetime.datetime(2013, 9, 19, 10, 4, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_3.execution_status = u'COMPLETED'
    tao_workflowcommand_3.execution_comment = u'Job 179 successfully deleted.'
    tao_workflowcommand_3 = save_or_locate(tao_workflowcommand_3)

    tao_workflowcommand_4 = WorkflowCommand()
    tao_workflowcommand_4.job_id = None
    tao_workflowcommand_4.issued = datetime.datetime(2013, 9, 19, 10, 4, 33, tzinfo=pytz.UTC)
    tao_workflowcommand_4.command = u'Job_Output_Delete'
    tao_workflowcommand_4.parameters = u'alistair'
    tao_workflowcommand_4.executed = datetime.datetime(2013, 9, 19, 10, 4, 33, tzinfo=pytz.UTC)
    tao_workflowcommand_4.execution_status = u'COMPLETED'
    tao_workflowcommand_4.execution_comment = u'Job 180 successfully deleted.'
    tao_workflowcommand_4 = save_or_locate(tao_workflowcommand_4)

    tao_workflowcommand_5 = WorkflowCommand()
    tao_workflowcommand_5.job_id = None
    tao_workflowcommand_5.issued = datetime.datetime(2013, 9, 19, 10, 5, 8, tzinfo=pytz.UTC)
    tao_workflowcommand_5.command = u'Job_Output_Delete'
    tao_workflowcommand_5.parameters = u'alistair'
    tao_workflowcommand_5.executed = datetime.datetime(2013, 9, 19, 10, 5, 8, tzinfo=pytz.UTC)
    tao_workflowcommand_5.execution_status = u'COMPLETED'
    tao_workflowcommand_5.execution_comment = u'Job 181 successfully deleted.'
    tao_workflowcommand_5 = save_or_locate(tao_workflowcommand_5)

    tao_workflowcommand_6 = WorkflowCommand()
    tao_workflowcommand_6.job_id = None
    tao_workflowcommand_6.issued = datetime.datetime(2013, 9, 19, 10, 10, 21, tzinfo=pytz.UTC)
    tao_workflowcommand_6.command = u'Job_Output_Delete'
    tao_workflowcommand_6.parameters = u'alistair'
    tao_workflowcommand_6.executed = datetime.datetime(2013, 9, 19, 10, 10, 21, tzinfo=pytz.UTC)
    tao_workflowcommand_6.execution_status = u'COMPLETED'
    tao_workflowcommand_6.execution_comment = u'Job 182 successfully deleted.'
    tao_workflowcommand_6 = save_or_locate(tao_workflowcommand_6)

    tao_workflowcommand_7 = WorkflowCommand()
    tao_workflowcommand_7.job_id = None
    tao_workflowcommand_7.issued = datetime.datetime(2013, 9, 19, 10, 10, 56, tzinfo=pytz.UTC)
    tao_workflowcommand_7.command = u'Job_Output_Delete'
    tao_workflowcommand_7.parameters = u'alistair'
    tao_workflowcommand_7.executed = datetime.datetime(2013, 9, 19, 10, 10, 56, tzinfo=pytz.UTC)
    tao_workflowcommand_7.execution_status = u'COMPLETED'
    tao_workflowcommand_7.execution_comment = u'Job 183 successfully deleted.'
    tao_workflowcommand_7 = save_or_locate(tao_workflowcommand_7)

    tao_workflowcommand_8 = WorkflowCommand()
    tao_workflowcommand_8.job_id = None
    tao_workflowcommand_8.issued = datetime.datetime(2013, 9, 19, 10, 11, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_8.command = u'Job_Output_Delete'
    tao_workflowcommand_8.parameters = u'alistair'
    tao_workflowcommand_8.executed = datetime.datetime(2013, 9, 19, 10, 11, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_8.execution_status = u'COMPLETED'
    tao_workflowcommand_8.execution_comment = u'Job 184 successfully deleted.'
    tao_workflowcommand_8 = save_or_locate(tao_workflowcommand_8)

    tao_workflowcommand_9 = WorkflowCommand()
    tao_workflowcommand_9.job_id = None
    tao_workflowcommand_9.issued = datetime.datetime(2013, 9, 19, 10, 30, 24, tzinfo=pytz.UTC)
    tao_workflowcommand_9.command = u'Job_Output_Delete'
    tao_workflowcommand_9.parameters = u'alistair'
    tao_workflowcommand_9.executed = datetime.datetime(2013, 9, 19, 10, 30, 24, tzinfo=pytz.UTC)
    tao_workflowcommand_9.execution_status = u'COMPLETED'
    tao_workflowcommand_9.execution_comment = u'Job 185 successfully deleted.'
    tao_workflowcommand_9 = save_or_locate(tao_workflowcommand_9)

    tao_workflowcommand_10 = WorkflowCommand()
    tao_workflowcommand_10.job_id = None
    tao_workflowcommand_10.issued = datetime.datetime(2013, 9, 19, 10, 30, 25, tzinfo=pytz.UTC)
    tao_workflowcommand_10.command = u'Job_Output_Delete'
    tao_workflowcommand_10.parameters = u'alistair'
    tao_workflowcommand_10.executed = datetime.datetime(2013, 9, 19, 10, 30, 25, tzinfo=pytz.UTC)
    tao_workflowcommand_10.execution_status = u'COMPLETED'
    tao_workflowcommand_10.execution_comment = u'Job 186 successfully deleted.'
    tao_workflowcommand_10 = save_or_locate(tao_workflowcommand_10)

    tao_workflowcommand_11 = WorkflowCommand()
    tao_workflowcommand_11.issued = datetime.datetime(2013, 9, 30, 23, 50, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_11.command = u'Job_Stop'
    tao_workflowcommand_11.parameters = u''
    tao_workflowcommand_11.executed = datetime.datetime(2013, 9, 30, 23, 50, 38, tzinfo=pytz.UTC)
    tao_workflowcommand_11.execution_status = u'COMPLETED'
    tao_workflowcommand_11.execution_comment = u''
    tao_workflowcommand_11 = save_or_locate(tao_workflowcommand_11)

    tao_workflowcommand_12 = WorkflowCommand()
    tao_workflowcommand_12.issued = datetime.datetime(2013, 10, 1, 4, 25, 3, tzinfo=pytz.UTC)
    tao_workflowcommand_12.command = u'Job_Stop'
    tao_workflowcommand_12.parameters = u''
    tao_workflowcommand_12.executed = datetime.datetime(2013, 10, 1, 4, 25, 7, tzinfo=pytz.UTC)
    tao_workflowcommand_12.execution_status = u'COMPLETED'
    tao_workflowcommand_12.execution_comment = u''
    tao_workflowcommand_12 = save_or_locate(tao_workflowcommand_12)

    tao_workflowcommand_13 = WorkflowCommand()
    tao_workflowcommand_13.job_id = None
    tao_workflowcommand_13.issued = datetime.datetime(2013, 10, 2, 3, 19, 50, tzinfo=pytz.UTC)
    tao_workflowcommand_13.command = u'Job_Output_Delete'
    tao_workflowcommand_13.parameters = u'gshattow'
    tao_workflowcommand_13.executed = datetime.datetime(2013, 10, 2, 3, 19, 50, tzinfo=pytz.UTC)
    tao_workflowcommand_13.execution_status = u'COMPLETED'
    tao_workflowcommand_13.execution_comment = u'Job 369 successfully deleted.'
    tao_workflowcommand_13 = save_or_locate(tao_workflowcommand_13)

    tao_workflowcommand_14 = WorkflowCommand()
    tao_workflowcommand_14.job_id = None
    tao_workflowcommand_14.issued = datetime.datetime(2013, 10, 2, 3, 25, 52, tzinfo=pytz.UTC)
    tao_workflowcommand_14.command = u'Job_Output_Delete'
    tao_workflowcommand_14.parameters = u'gshattow'
    tao_workflowcommand_14.executed = datetime.datetime(2013, 10, 2, 3, 25, 52, tzinfo=pytz.UTC)
    tao_workflowcommand_14.execution_status = u'COMPLETED'
    tao_workflowcommand_14.execution_comment = u'Job 373 successfully deleted.'
    tao_workflowcommand_14 = save_or_locate(tao_workflowcommand_14)

    tao_workflowcommand_15 = WorkflowCommand()
    tao_workflowcommand_15.job_id = None
    tao_workflowcommand_15.issued = datetime.datetime(2013, 10, 2, 3, 26, 36, tzinfo=pytz.UTC)
    tao_workflowcommand_15.command = u'Job_Output_Delete'
    tao_workflowcommand_15.parameters = u'gshattow'
    tao_workflowcommand_15.executed = datetime.datetime(2013, 10, 2, 3, 26, 36, tzinfo=pytz.UTC)
    tao_workflowcommand_15.execution_status = u'COMPLETED'
    tao_workflowcommand_15.execution_comment = u'Job 372 successfully deleted.'
    tao_workflowcommand_15 = save_or_locate(tao_workflowcommand_15)

    tao_workflowcommand_16 = WorkflowCommand()
    tao_workflowcommand_16.job_id = None
    tao_workflowcommand_16.issued = datetime.datetime(2013, 10, 2, 3, 26, 38, tzinfo=pytz.UTC)
    tao_workflowcommand_16.command = u'Job_Output_Delete'
    tao_workflowcommand_16.parameters = u'gshattow'
    tao_workflowcommand_16.executed = datetime.datetime(2013, 10, 2, 3, 26, 38, tzinfo=pytz.UTC)
    tao_workflowcommand_16.execution_status = u'COMPLETED'
    tao_workflowcommand_16.execution_comment = u'Job 370 successfully deleted.'
    tao_workflowcommand_16 = save_or_locate(tao_workflowcommand_16)

    tao_workflowcommand_17 = WorkflowCommand()
    tao_workflowcommand_17.job_id = None
    tao_workflowcommand_17.issued = datetime.datetime(2013, 10, 2, 3, 26, 40, tzinfo=pytz.UTC)
    tao_workflowcommand_17.command = u'Job_Output_Delete'
    tao_workflowcommand_17.parameters = u'gshattow'
    tao_workflowcommand_17.executed = datetime.datetime(2013, 10, 2, 3, 26, 40, tzinfo=pytz.UTC)
    tao_workflowcommand_17.execution_status = u'COMPLETED'
    tao_workflowcommand_17.execution_comment = u'Job 371 successfully deleted.'
    tao_workflowcommand_17 = save_or_locate(tao_workflowcommand_17)

    tao_workflowcommand_18 = WorkflowCommand()
    tao_workflowcommand_18.issued = datetime.datetime(2013, 10, 2, 4, 13, 23, tzinfo=pytz.UTC)
    tao_workflowcommand_18.command = u'Job_Stop'
    tao_workflowcommand_18.parameters = u''
    tao_workflowcommand_18.executed = datetime.datetime(2013, 10, 2, 4, 13, 58, tzinfo=pytz.UTC)
    tao_workflowcommand_18.execution_status = u'COMPLETED'
    tao_workflowcommand_18.execution_comment = u''
    tao_workflowcommand_18 = save_or_locate(tao_workflowcommand_18)

    tao_workflowcommand_19 = WorkflowCommand()
    tao_workflowcommand_19.job_id = None
    tao_workflowcommand_19.issued = datetime.datetime(2013, 10, 2, 23, 46, 3, tzinfo=pytz.UTC)
    tao_workflowcommand_19.command = u'Job_Output_Delete'
    tao_workflowcommand_19.parameters = u'alanrduffy'
    tao_workflowcommand_19.executed = datetime.datetime(2013, 10, 2, 23, 46, 3, tzinfo=pytz.UTC)
    tao_workflowcommand_19.execution_status = u'COMPLETED'
    tao_workflowcommand_19.execution_comment = u'Job 363 successfully deleted.'
    tao_workflowcommand_19 = save_or_locate(tao_workflowcommand_19)

    tao_workflowcommand_20 = WorkflowCommand()
    tao_workflowcommand_20.job_id = None
    tao_workflowcommand_20.issued = datetime.datetime(2013, 10, 2, 23, 49, 10, tzinfo=pytz.UTC)
    tao_workflowcommand_20.command = u'Job_Output_Delete'
    tao_workflowcommand_20.parameters = u'alanrduffy'
    tao_workflowcommand_20.executed = datetime.datetime(2013, 10, 2, 23, 49, 10, tzinfo=pytz.UTC)
    tao_workflowcommand_20.execution_status = u'COMPLETED'
    tao_workflowcommand_20.execution_comment = u'Job 243 successfully deleted.'
    tao_workflowcommand_20 = save_or_locate(tao_workflowcommand_20)

    tao_workflowcommand_21 = WorkflowCommand()
    tao_workflowcommand_21.job_id = None
    tao_workflowcommand_21.issued = datetime.datetime(2013, 10, 2, 23, 49, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_21.command = u'Job_Output_Delete'
    tao_workflowcommand_21.parameters = u'alanrduffy'
    tao_workflowcommand_21.executed = datetime.datetime(2013, 10, 2, 23, 49, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_21.execution_status = u'COMPLETED'
    tao_workflowcommand_21.execution_comment = u'Job 244 successfully deleted.'
    tao_workflowcommand_21 = save_or_locate(tao_workflowcommand_21)

    tao_workflowcommand_22 = WorkflowCommand()
    tao_workflowcommand_22.job_id = None
    tao_workflowcommand_22.issued = datetime.datetime(2013, 10, 2, 23, 49, 43, tzinfo=pytz.UTC)
    tao_workflowcommand_22.command = u'Job_Output_Delete'
    tao_workflowcommand_22.parameters = u'alanrduffy'
    tao_workflowcommand_22.executed = datetime.datetime(2013, 10, 2, 23, 49, 43, tzinfo=pytz.UTC)
    tao_workflowcommand_22.execution_status = u'COMPLETED'
    tao_workflowcommand_22.execution_comment = u'Job 245 successfully deleted.'
    tao_workflowcommand_22 = save_or_locate(tao_workflowcommand_22)

    tao_workflowcommand_23 = WorkflowCommand()
    tao_workflowcommand_23.job_id = None
    tao_workflowcommand_23.issued = datetime.datetime(2013, 10, 2, 23, 49, 57, tzinfo=pytz.UTC)
    tao_workflowcommand_23.command = u'Job_Output_Delete'
    tao_workflowcommand_23.parameters = u'alanrduffy'
    tao_workflowcommand_23.executed = datetime.datetime(2013, 10, 2, 23, 49, 57, tzinfo=pytz.UTC)
    tao_workflowcommand_23.execution_status = u'COMPLETED'
    tao_workflowcommand_23.execution_comment = u'Job 249 successfully deleted.'
    tao_workflowcommand_23 = save_or_locate(tao_workflowcommand_23)

    tao_workflowcommand_24 = WorkflowCommand()
    tao_workflowcommand_24.job_id = None
    tao_workflowcommand_24.issued = datetime.datetime(2013, 10, 2, 23, 50, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_24.command = u'Job_Output_Delete'
    tao_workflowcommand_24.parameters = u'alanrduffy'
    tao_workflowcommand_24.executed = datetime.datetime(2013, 10, 2, 23, 50, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_24.execution_status = u'COMPLETED'
    tao_workflowcommand_24.execution_comment = u'Job 291 successfully deleted.'
    tao_workflowcommand_24 = save_or_locate(tao_workflowcommand_24)

    tao_workflowcommand_25 = WorkflowCommand()
    tao_workflowcommand_25.job_id = None
    tao_workflowcommand_25.issued = datetime.datetime(2013, 10, 3, 4, 39, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_25.command = u'Job_Output_Delete'
    tao_workflowcommand_25.parameters = u'gshattow'
    tao_workflowcommand_25.executed = datetime.datetime(2013, 10, 3, 4, 39, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_25.execution_status = u'COMPLETED'
    tao_workflowcommand_25.execution_comment = u'Job 365 successfully deleted.'
    tao_workflowcommand_25 = save_or_locate(tao_workflowcommand_25)

    tao_workflowcommand_26 = WorkflowCommand()
    tao_workflowcommand_26.job_id = None
    tao_workflowcommand_26.issued = datetime.datetime(2013, 10, 4, 0, 2, 55, tzinfo=pytz.UTC)
    tao_workflowcommand_26.command = u'Job_Output_Delete'
    tao_workflowcommand_26.parameters = u'alanrduffy'
    tao_workflowcommand_26.executed = datetime.datetime(2013, 10, 4, 0, 2, 55, tzinfo=pytz.UTC)
    tao_workflowcommand_26.execution_status = u'COMPLETED'
    tao_workflowcommand_26.execution_comment = u'Job 380 successfully deleted.'
    tao_workflowcommand_26 = save_or_locate(tao_workflowcommand_26)

    tao_workflowcommand_27 = WorkflowCommand()
    tao_workflowcommand_27.job_id = None
    tao_workflowcommand_27.issued = datetime.datetime(2013, 10, 9, 22, 31, 36, tzinfo=pytz.UTC)
    tao_workflowcommand_27.command = u'Job_Output_Delete'
    tao_workflowcommand_27.parameters = u'alanrduffy'
    tao_workflowcommand_27.executed = datetime.datetime(2013, 10, 9, 22, 31, 36, tzinfo=pytz.UTC)
    tao_workflowcommand_27.execution_status = u'COMPLETED'
    tao_workflowcommand_27.execution_comment = u'Job 387 successfully deleted.'
    tao_workflowcommand_27 = save_or_locate(tao_workflowcommand_27)

    tao_workflowcommand_28 = WorkflowCommand()
    tao_workflowcommand_28.job_id = None
    tao_workflowcommand_28.issued = datetime.datetime(2013, 10, 10, 23, 45, 31, tzinfo=pytz.UTC)
    tao_workflowcommand_28.command = u'Job_Output_Delete'
    tao_workflowcommand_28.parameters = u'alanrduffy'
    tao_workflowcommand_28.executed = datetime.datetime(2013, 10, 10, 23, 45, 31, tzinfo=pytz.UTC)
    tao_workflowcommand_28.execution_status = u'COMPLETED'
    tao_workflowcommand_28.execution_comment = u'Job 390 successfully deleted.'
    tao_workflowcommand_28 = save_or_locate(tao_workflowcommand_28)

    tao_workflowcommand_29 = WorkflowCommand()
    tao_workflowcommand_29.issued = datetime.datetime(2013, 10, 11, 1, 52, 18, tzinfo=pytz.UTC)
    tao_workflowcommand_29.command = u'Job_Stop'
    tao_workflowcommand_29.parameters = u''
    tao_workflowcommand_29.executed = datetime.datetime(2013, 10, 11, 1, 52, 23, tzinfo=pytz.UTC)
    tao_workflowcommand_29.execution_status = u'ERROR'
    tao_workflowcommand_29.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_29 = save_or_locate(tao_workflowcommand_29)

    tao_workflowcommand_30 = WorkflowCommand()
    tao_workflowcommand_30.issued = datetime.datetime(2013, 10, 11, 2, 39, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_30.command = u'Job_Stop'
    tao_workflowcommand_30.parameters = u''
    tao_workflowcommand_30.executed = datetime.datetime(2013, 10, 11, 2, 39, 37, tzinfo=pytz.UTC)
    tao_workflowcommand_30.execution_status = u'COMPLETED'
    tao_workflowcommand_30.execution_comment = u''
    tao_workflowcommand_30 = save_or_locate(tao_workflowcommand_30)

    tao_workflowcommand_31 = WorkflowCommand()
    tao_workflowcommand_31.job_id = None
    tao_workflowcommand_31.issued = datetime.datetime(2013, 10, 11, 3, 44, 33, tzinfo=pytz.UTC)
    tao_workflowcommand_31.command = u'Job_Output_Delete'
    tao_workflowcommand_31.parameters = u'gshattow'
    tao_workflowcommand_31.executed = datetime.datetime(2013, 10, 11, 3, 44, 33, tzinfo=pytz.UTC)
    tao_workflowcommand_31.execution_status = u'COMPLETED'
    tao_workflowcommand_31.execution_comment = u'Job 394 successfully deleted.'
    tao_workflowcommand_31 = save_or_locate(tao_workflowcommand_31)

    tao_workflowcommand_32 = WorkflowCommand()
    tao_workflowcommand_32.job_id = None
    tao_workflowcommand_32.issued = datetime.datetime(2013, 10, 11, 3, 45, 13, tzinfo=pytz.UTC)
    tao_workflowcommand_32.command = u'Job_Output_Delete'
    tao_workflowcommand_32.parameters = u'gshattow'
    tao_workflowcommand_32.executed = datetime.datetime(2013, 10, 11, 3, 45, 13, tzinfo=pytz.UTC)
    tao_workflowcommand_32.execution_status = u'COMPLETED'
    tao_workflowcommand_32.execution_comment = u'Job 391 successfully deleted.'
    tao_workflowcommand_32 = save_or_locate(tao_workflowcommand_32)

    tao_workflowcommand_33 = WorkflowCommand()
    tao_workflowcommand_33.job_id = None
    tao_workflowcommand_33.issued = datetime.datetime(2013, 10, 11, 21, 57, 10, tzinfo=pytz.UTC)
    tao_workflowcommand_33.command = u'Job_Output_Delete'
    tao_workflowcommand_33.parameters = u'alistair'
    tao_workflowcommand_33.executed = datetime.datetime(2013, 10, 11, 21, 57, 10, tzinfo=pytz.UTC)
    tao_workflowcommand_33.execution_status = u'COMPLETED'
    tao_workflowcommand_33.execution_comment = u'Job 407 successfully deleted.'
    tao_workflowcommand_33 = save_or_locate(tao_workflowcommand_33)

    tao_workflowcommand_34 = WorkflowCommand()
    tao_workflowcommand_34.issued = datetime.datetime(2013, 10, 12, 6, 13, 11, tzinfo=pytz.UTC)
    tao_workflowcommand_34.command = u'Job_Stop'
    tao_workflowcommand_34.parameters = u''
    tao_workflowcommand_34.executed = datetime.datetime(2013, 10, 12, 6, 13, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_34.execution_status = u'ERROR'
    tao_workflowcommand_34.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_34 = save_or_locate(tao_workflowcommand_34)

    tao_workflowcommand_35 = WorkflowCommand()
    tao_workflowcommand_35.issued = datetime.datetime(2013, 10, 12, 6, 13, 12, tzinfo=pytz.UTC)
    tao_workflowcommand_35.command = u'Job_Stop'
    tao_workflowcommand_35.parameters = u''
    tao_workflowcommand_35.executed = datetime.datetime(2013, 10, 12, 6, 13, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_35.execution_status = u'ERROR'
    tao_workflowcommand_35.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_35 = save_or_locate(tao_workflowcommand_35)

    tao_workflowcommand_36 = WorkflowCommand()
    tao_workflowcommand_36.issued = datetime.datetime(2013, 10, 12, 6, 13, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_36.command = u'Job_Stop'
    tao_workflowcommand_36.parameters = u''
    tao_workflowcommand_36.executed = datetime.datetime(2013, 10, 12, 6, 13, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_36.execution_status = u'ERROR'
    tao_workflowcommand_36.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_36 = save_or_locate(tao_workflowcommand_36)

    tao_workflowcommand_37 = WorkflowCommand()
    tao_workflowcommand_37.issued = datetime.datetime(2013, 10, 12, 6, 13, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_37.command = u'Job_Stop'
    tao_workflowcommand_37.parameters = u''
    tao_workflowcommand_37.executed = datetime.datetime(2013, 10, 12, 6, 13, 30, tzinfo=pytz.UTC)
    tao_workflowcommand_37.execution_status = u'ERROR'
    tao_workflowcommand_37.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_37 = save_or_locate(tao_workflowcommand_37)

    tao_workflowcommand_38 = WorkflowCommand()
    tao_workflowcommand_38.issued = datetime.datetime(2013, 10, 12, 6, 13, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_38.command = u'Job_Stop'
    tao_workflowcommand_38.parameters = u''
    tao_workflowcommand_38.executed = datetime.datetime(2013, 10, 12, 6, 13, 30, tzinfo=pytz.UTC)
    tao_workflowcommand_38.execution_status = u'ERROR'
    tao_workflowcommand_38.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_38 = save_or_locate(tao_workflowcommand_38)

    tao_workflowcommand_39 = WorkflowCommand()
    tao_workflowcommand_39.issued = datetime.datetime(2013, 10, 12, 6, 13, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_39.command = u'Job_Stop'
    tao_workflowcommand_39.parameters = u''
    tao_workflowcommand_39.executed = datetime.datetime(2013, 10, 12, 6, 13, 30, tzinfo=pytz.UTC)
    tao_workflowcommand_39.execution_status = u'ERROR'
    tao_workflowcommand_39.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_39 = save_or_locate(tao_workflowcommand_39)

    tao_workflowcommand_40 = WorkflowCommand()
    tao_workflowcommand_40.issued = datetime.datetime(2013, 10, 12, 6, 13, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_40.command = u'Job_Stop'
    tao_workflowcommand_40.parameters = u''
    tao_workflowcommand_40.executed = datetime.datetime(2013, 10, 12, 6, 13, 30, tzinfo=pytz.UTC)
    tao_workflowcommand_40.execution_status = u'ERROR'
    tao_workflowcommand_40.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_40 = save_or_locate(tao_workflowcommand_40)

    tao_workflowcommand_41 = WorkflowCommand()
    tao_workflowcommand_41.issued = datetime.datetime(2013, 10, 12, 6, 13, 15, tzinfo=pytz.UTC)
    tao_workflowcommand_41.command = u'Job_Stop'
    tao_workflowcommand_41.parameters = u''
    tao_workflowcommand_41.executed = datetime.datetime(2013, 10, 12, 6, 13, 30, tzinfo=pytz.UTC)
    tao_workflowcommand_41.execution_status = u'ERROR'
    tao_workflowcommand_41.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_41 = save_or_locate(tao_workflowcommand_41)

    tao_workflowcommand_42 = WorkflowCommand()
    tao_workflowcommand_42.issued = datetime.datetime(2013, 10, 13, 0, 6, 15, tzinfo=pytz.UTC)
    tao_workflowcommand_42.command = u'Job_Stop'
    tao_workflowcommand_42.parameters = u''
    tao_workflowcommand_42.executed = datetime.datetime(2013, 10, 13, 0, 6, 22, tzinfo=pytz.UTC)
    tao_workflowcommand_42.execution_status = u'ERROR'
    tao_workflowcommand_42.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_42 = save_or_locate(tao_workflowcommand_42)

    tao_workflowcommand_43 = WorkflowCommand()
    tao_workflowcommand_43.issued = datetime.datetime(2013, 10, 14, 3, 48, 46, tzinfo=pytz.UTC)
    tao_workflowcommand_43.command = u'Job_Stop'
    tao_workflowcommand_43.parameters = u''
    tao_workflowcommand_43.executed = datetime.datetime(2013, 10, 14, 3, 49, 15, tzinfo=pytz.UTC)
    tao_workflowcommand_43.execution_status = u'COMPLETED'
    tao_workflowcommand_43.execution_comment = u''
    tao_workflowcommand_43 = save_or_locate(tao_workflowcommand_43)

    tao_workflowcommand_44 = WorkflowCommand()
    tao_workflowcommand_44.issued = datetime.datetime(2013, 10, 14, 3, 48, 50, tzinfo=pytz.UTC)
    tao_workflowcommand_44.command = u'Job_Stop'
    tao_workflowcommand_44.parameters = u''
    tao_workflowcommand_44.executed = datetime.datetime(2013, 10, 14, 3, 49, 16, tzinfo=pytz.UTC)
    tao_workflowcommand_44.execution_status = u'COMPLETED'
    tao_workflowcommand_44.execution_comment = u''
    tao_workflowcommand_44 = save_or_locate(tao_workflowcommand_44)

    tao_workflowcommand_45 = WorkflowCommand()
    tao_workflowcommand_45.job_id = None
    tao_workflowcommand_45.issued = datetime.datetime(2013, 10, 14, 4, 40, 51, tzinfo=pytz.UTC)
    tao_workflowcommand_45.command = u'Job_Output_Delete'
    tao_workflowcommand_45.parameters = u'amr'
    tao_workflowcommand_45.executed = datetime.datetime(2013, 10, 14, 4, 40, 51, tzinfo=pytz.UTC)
    tao_workflowcommand_45.execution_status = u'COMPLETED'
    tao_workflowcommand_45.execution_comment = u'Job 213 successfully deleted.'
    tao_workflowcommand_45 = save_or_locate(tao_workflowcommand_45)

    tao_workflowcommand_46 = WorkflowCommand()
    tao_workflowcommand_46.job_id = None
    tao_workflowcommand_46.issued = datetime.datetime(2013, 10, 14, 4, 41, 26, tzinfo=pytz.UTC)
    tao_workflowcommand_46.command = u'Job_Output_Delete'
    tao_workflowcommand_46.parameters = u'amr'
    tao_workflowcommand_46.executed = datetime.datetime(2013, 10, 14, 4, 41, 26, tzinfo=pytz.UTC)
    tao_workflowcommand_46.execution_status = u'COMPLETED'
    tao_workflowcommand_46.execution_comment = u'Job 171 successfully deleted.'
    tao_workflowcommand_46 = save_or_locate(tao_workflowcommand_46)

    tao_workflowcommand_47 = WorkflowCommand()
    tao_workflowcommand_47.job_id = None
    tao_workflowcommand_47.issued = datetime.datetime(2013, 10, 14, 4, 42, 2, tzinfo=pytz.UTC)
    tao_workflowcommand_47.command = u'Job_Output_Delete'
    tao_workflowcommand_47.parameters = u'amr'
    tao_workflowcommand_47.executed = datetime.datetime(2013, 10, 14, 4, 42, 2, tzinfo=pytz.UTC)
    tao_workflowcommand_47.execution_status = u'COMPLETED'
    tao_workflowcommand_47.execution_comment = u'Job 158 successfully deleted.'
    tao_workflowcommand_47 = save_or_locate(tao_workflowcommand_47)

    tao_workflowcommand_48 = WorkflowCommand()
    tao_workflowcommand_48.job_id = None
    tao_workflowcommand_48.issued = datetime.datetime(2013, 10, 14, 4, 42, 33, tzinfo=pytz.UTC)
    tao_workflowcommand_48.command = u'Job_Output_Delete'
    tao_workflowcommand_48.parameters = u'amr'
    tao_workflowcommand_48.executed = datetime.datetime(2013, 10, 14, 4, 42, 33, tzinfo=pytz.UTC)
    tao_workflowcommand_48.execution_status = u'COMPLETED'
    tao_workflowcommand_48.execution_comment = u'Job 428 successfully deleted.'
    tao_workflowcommand_48 = save_or_locate(tao_workflowcommand_48)

    tao_workflowcommand_49 = WorkflowCommand()
    tao_workflowcommand_49.issued = datetime.datetime(2013, 10, 14, 5, 24, tzinfo=pytz.UTC)
    tao_workflowcommand_49.command = u'Job_Stop'
    tao_workflowcommand_49.parameters = u''
    tao_workflowcommand_49.executed = datetime.datetime(2013, 10, 14, 5, 24, 9, tzinfo=pytz.UTC)
    tao_workflowcommand_49.execution_status = u'ERROR'
    tao_workflowcommand_49.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_49 = save_or_locate(tao_workflowcommand_49)

    tao_workflowcommand_50 = WorkflowCommand()
    tao_workflowcommand_50.issued = datetime.datetime(2013, 10, 14, 6, 2, 59, tzinfo=pytz.UTC)
    tao_workflowcommand_50.command = u'Job_Stop'
    tao_workflowcommand_50.parameters = u''
    tao_workflowcommand_50.executed = datetime.datetime(2013, 10, 14, 6, 3, 1, tzinfo=pytz.UTC)
    tao_workflowcommand_50.execution_status = u'ERROR'
    tao_workflowcommand_50.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_50 = save_or_locate(tao_workflowcommand_50)

    tao_workflowcommand_51 = WorkflowCommand()
    tao_workflowcommand_51.issued = datetime.datetime(2013, 10, 14, 14, 13, 5, tzinfo=pytz.UTC)
    tao_workflowcommand_51.command = u'Job_Stop'
    tao_workflowcommand_51.parameters = u''
    tao_workflowcommand_51.executed = datetime.datetime(2013, 10, 14, 14, 13, 11, tzinfo=pytz.UTC)
    tao_workflowcommand_51.execution_status = u'ERROR'
    tao_workflowcommand_51.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_51 = save_or_locate(tao_workflowcommand_51)

    tao_workflowcommand_52 = WorkflowCommand()
    tao_workflowcommand_52.job_id = None
    tao_workflowcommand_52.issued = datetime.datetime(2013, 10, 17, 1, 49, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_52.command = u'Job_Output_Delete'
    tao_workflowcommand_52.parameters = u'alistair'
    tao_workflowcommand_52.executed = datetime.datetime(2013, 10, 17, 1, 49, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_52.execution_status = u'COMPLETED'
    tao_workflowcommand_52.execution_comment = u'Job 446 successfully deleted.'
    tao_workflowcommand_52 = save_or_locate(tao_workflowcommand_52)

    tao_workflowcommand_53 = WorkflowCommand()
    tao_workflowcommand_53.job_id = None
    tao_workflowcommand_53.issued = datetime.datetime(2013, 10, 18, 3, 46, 54, tzinfo=pytz.UTC)
    tao_workflowcommand_53.command = u'Job_Output_Delete'
    tao_workflowcommand_53.parameters = u'darrencroton'
    tao_workflowcommand_53.executed = datetime.datetime(2013, 10, 18, 3, 46, 54, tzinfo=pytz.UTC)
    tao_workflowcommand_53.execution_status = u'COMPLETED'
    tao_workflowcommand_53.execution_comment = u'Job 203 successfully deleted.'
    tao_workflowcommand_53 = save_or_locate(tao_workflowcommand_53)

    tao_workflowcommand_54 = WorkflowCommand()
    tao_workflowcommand_54.job_id = None
    tao_workflowcommand_54.issued = datetime.datetime(2013, 10, 18, 3, 47, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_54.command = u'Job_Output_Delete'
    tao_workflowcommand_54.parameters = u'darrencroton'
    tao_workflowcommand_54.executed = datetime.datetime(2013, 10, 18, 3, 47, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_54.execution_status = u'COMPLETED'
    tao_workflowcommand_54.execution_comment = u'Job 204 successfully deleted.'
    tao_workflowcommand_54 = save_or_locate(tao_workflowcommand_54)

    tao_workflowcommand_55 = WorkflowCommand()
    tao_workflowcommand_55.issued = datetime.datetime(2013, 10, 20, 23, 54, 44, tzinfo=pytz.UTC)
    tao_workflowcommand_55.command = u'Job_Stop'
    tao_workflowcommand_55.parameters = u''
    tao_workflowcommand_55.executed = datetime.datetime(2013, 10, 20, 23, 54, 53, tzinfo=pytz.UTC)
    tao_workflowcommand_55.execution_status = u'ERROR'
    tao_workflowcommand_55.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_55 = save_or_locate(tao_workflowcommand_55)

    tao_workflowcommand_56 = WorkflowCommand()
    tao_workflowcommand_56.issued = datetime.datetime(2013, 10, 20, 23, 56, 1, tzinfo=pytz.UTC)
    tao_workflowcommand_56.command = u'Job_Stop'
    tao_workflowcommand_56.parameters = u''
    tao_workflowcommand_56.executed = datetime.datetime(2013, 10, 20, 23, 56, 26, tzinfo=pytz.UTC)
    tao_workflowcommand_56.execution_status = u'ERROR'
    tao_workflowcommand_56.execution_comment = u'Job Is Not Running!'
    tao_workflowcommand_56 = save_or_locate(tao_workflowcommand_56)

    tao_workflowcommand_57 = WorkflowCommand()
    tao_workflowcommand_57.job_id = None
    tao_workflowcommand_57.issued = datetime.datetime(2013, 10, 22, 0, 59, 53, tzinfo=pytz.UTC)
    tao_workflowcommand_57.command = u'Job_Output_Delete'
    tao_workflowcommand_57.parameters = u'hanyk'
    tao_workflowcommand_57.executed = datetime.datetime(2013, 10, 22, 0, 59, 53, tzinfo=pytz.UTC)
    tao_workflowcommand_57.execution_status = u'COMPLETED'
    tao_workflowcommand_57.execution_comment = u'Job 460 successfully deleted.'
    tao_workflowcommand_57 = save_or_locate(tao_workflowcommand_57)

    tao_workflowcommand_58 = WorkflowCommand()
    tao_workflowcommand_58.issued = datetime.datetime(2013, 10, 23, 22, 7, 25, tzinfo=pytz.UTC)
    tao_workflowcommand_58.command = u'Job_Stop'
    tao_workflowcommand_58.parameters = u''
    tao_workflowcommand_58.executed = datetime.datetime(2013, 10, 23, 22, 7, 48, tzinfo=pytz.UTC)
    tao_workflowcommand_58.execution_status = u'COMPLETED'
    tao_workflowcommand_58.execution_comment = u''
    tao_workflowcommand_58 = save_or_locate(tao_workflowcommand_58)

    tao_workflowcommand_59 = WorkflowCommand()
    tao_workflowcommand_59.job_id = None
    tao_workflowcommand_59.issued = datetime.datetime(2013, 10, 24, 11, 7, 11, tzinfo=pytz.UTC)
    tao_workflowcommand_59.command = u'Job_Output_Delete'
    tao_workflowcommand_59.parameters = u'alistair'
    tao_workflowcommand_59.executed = datetime.datetime(2013, 10, 24, 11, 7, 11, tzinfo=pytz.UTC)
    tao_workflowcommand_59.execution_status = u'COMPLETED'
    tao_workflowcommand_59.execution_comment = u'Job 187 successfully deleted.'
    tao_workflowcommand_59 = save_or_locate(tao_workflowcommand_59)

    tao_workflowcommand_60 = WorkflowCommand()
    tao_workflowcommand_60.job_id = None
    tao_workflowcommand_60.issued = datetime.datetime(2013, 10, 24, 11, 7, 11, tzinfo=pytz.UTC)
    tao_workflowcommand_60.command = u'Job_Output_Delete'
    tao_workflowcommand_60.parameters = u'alistair'
    tao_workflowcommand_60.executed = datetime.datetime(2013, 10, 24, 11, 7, 11, tzinfo=pytz.UTC)
    tao_workflowcommand_60.execution_status = u'COMPLETED'
    tao_workflowcommand_60.execution_comment = u'Job 188 successfully deleted.'
    tao_workflowcommand_60 = save_or_locate(tao_workflowcommand_60)

    tao_workflowcommand_61 = WorkflowCommand()
    tao_workflowcommand_61.job_id = None
    tao_workflowcommand_61.issued = datetime.datetime(2013, 10, 24, 11, 7, 44, tzinfo=pytz.UTC)
    tao_workflowcommand_61.command = u'Job_Output_Delete'
    tao_workflowcommand_61.parameters = u'alistair'
    tao_workflowcommand_61.executed = datetime.datetime(2013, 10, 24, 11, 7, 44, tzinfo=pytz.UTC)
    tao_workflowcommand_61.execution_status = u'COMPLETED'
    tao_workflowcommand_61.execution_comment = u'Job 189 successfully deleted.'
    tao_workflowcommand_61 = save_or_locate(tao_workflowcommand_61)

    tao_workflowcommand_62 = WorkflowCommand()
    tao_workflowcommand_62.job_id = None
    tao_workflowcommand_62.issued = datetime.datetime(2013, 10, 24, 11, 7, 44, tzinfo=pytz.UTC)
    tao_workflowcommand_62.command = u'Job_Output_Delete'
    tao_workflowcommand_62.parameters = u'alistair'
    tao_workflowcommand_62.executed = datetime.datetime(2013, 10, 24, 11, 7, 44, tzinfo=pytz.UTC)
    tao_workflowcommand_62.execution_status = u'COMPLETED'
    tao_workflowcommand_62.execution_comment = u'Job 190 successfully deleted.'
    tao_workflowcommand_62 = save_or_locate(tao_workflowcommand_62)

    tao_workflowcommand_63 = WorkflowCommand()
    tao_workflowcommand_63.job_id = None
    tao_workflowcommand_63.issued = datetime.datetime(2013, 10, 24, 11, 7, 45, tzinfo=pytz.UTC)
    tao_workflowcommand_63.command = u'Job_Output_Delete'
    tao_workflowcommand_63.parameters = u'alistair'
    tao_workflowcommand_63.executed = datetime.datetime(2013, 10, 24, 11, 7, 45, tzinfo=pytz.UTC)
    tao_workflowcommand_63.execution_status = u'COMPLETED'
    tao_workflowcommand_63.execution_comment = u'Job 191 successfully deleted.'
    tao_workflowcommand_63 = save_or_locate(tao_workflowcommand_63)

    tao_workflowcommand_64 = WorkflowCommand()
    tao_workflowcommand_64.job_id = None
    tao_workflowcommand_64.issued = datetime.datetime(2013, 10, 24, 11, 7, 45, tzinfo=pytz.UTC)
    tao_workflowcommand_64.command = u'Job_Output_Delete'
    tao_workflowcommand_64.parameters = u'alistair'
    tao_workflowcommand_64.executed = datetime.datetime(2013, 10, 24, 11, 7, 45, tzinfo=pytz.UTC)
    tao_workflowcommand_64.execution_status = u'COMPLETED'
    tao_workflowcommand_64.execution_comment = u'Job 192 successfully deleted.'
    tao_workflowcommand_64 = save_or_locate(tao_workflowcommand_64)

    tao_workflowcommand_65 = WorkflowCommand()
    tao_workflowcommand_65.job_id = None
    tao_workflowcommand_65.issued = datetime.datetime(2013, 10, 24, 11, 8, 17, tzinfo=pytz.UTC)
    tao_workflowcommand_65.command = u'Job_Output_Delete'
    tao_workflowcommand_65.parameters = u'alistair'
    tao_workflowcommand_65.executed = datetime.datetime(2013, 10, 24, 11, 8, 17, tzinfo=pytz.UTC)
    tao_workflowcommand_65.execution_status = u'COMPLETED'
    tao_workflowcommand_65.execution_comment = u'Job 193 successfully deleted.'
    tao_workflowcommand_65 = save_or_locate(tao_workflowcommand_65)

    tao_workflowcommand_66 = WorkflowCommand()
    tao_workflowcommand_66.job_id = None
    tao_workflowcommand_66.issued = datetime.datetime(2013, 10, 24, 11, 8, 17, tzinfo=pytz.UTC)
    tao_workflowcommand_66.command = u'Job_Output_Delete'
    tao_workflowcommand_66.parameters = u'alistair'
    tao_workflowcommand_66.executed = datetime.datetime(2013, 10, 24, 11, 8, 17, tzinfo=pytz.UTC)
    tao_workflowcommand_66.execution_status = u'COMPLETED'
    tao_workflowcommand_66.execution_comment = u'Job 194 successfully deleted.'
    tao_workflowcommand_66 = save_or_locate(tao_workflowcommand_66)

    tao_workflowcommand_67 = WorkflowCommand()
    tao_workflowcommand_67.job_id = None
    tao_workflowcommand_67.issued = datetime.datetime(2013, 10, 24, 11, 8, 18, tzinfo=pytz.UTC)
    tao_workflowcommand_67.command = u'Job_Output_Delete'
    tao_workflowcommand_67.parameters = u'alistair'
    tao_workflowcommand_67.executed = datetime.datetime(2013, 10, 24, 11, 8, 18, tzinfo=pytz.UTC)
    tao_workflowcommand_67.execution_status = u'COMPLETED'
    tao_workflowcommand_67.execution_comment = u'Job 195 successfully deleted.'
    tao_workflowcommand_67 = save_or_locate(tao_workflowcommand_67)

    tao_workflowcommand_68 = WorkflowCommand()
    tao_workflowcommand_68.job_id = None
    tao_workflowcommand_68.issued = datetime.datetime(2013, 10, 24, 11, 8, 49, tzinfo=pytz.UTC)
    tao_workflowcommand_68.command = u'Job_Output_Delete'
    tao_workflowcommand_68.parameters = u'alistair'
    tao_workflowcommand_68.executed = datetime.datetime(2013, 10, 24, 11, 8, 49, tzinfo=pytz.UTC)
    tao_workflowcommand_68.execution_status = u'COMPLETED'
    tao_workflowcommand_68.execution_comment = u'Job 196 successfully deleted.'
    tao_workflowcommand_68 = save_or_locate(tao_workflowcommand_68)

    tao_workflowcommand_69 = WorkflowCommand()
    tao_workflowcommand_69.job_id = None
    tao_workflowcommand_69.issued = datetime.datetime(2013, 10, 24, 11, 8, 49, tzinfo=pytz.UTC)
    tao_workflowcommand_69.command = u'Job_Output_Delete'
    tao_workflowcommand_69.parameters = u'alistair'
    tao_workflowcommand_69.executed = datetime.datetime(2013, 10, 24, 11, 8, 49, tzinfo=pytz.UTC)
    tao_workflowcommand_69.execution_status = u'COMPLETED'
    tao_workflowcommand_69.execution_comment = u'Job 216 successfully deleted.'
    tao_workflowcommand_69 = save_or_locate(tao_workflowcommand_69)

    tao_workflowcommand_70 = WorkflowCommand()
    tao_workflowcommand_70.job_id = None
    tao_workflowcommand_70.issued = datetime.datetime(2013, 10, 24, 11, 8, 50, tzinfo=pytz.UTC)
    tao_workflowcommand_70.command = u'Job_Output_Delete'
    tao_workflowcommand_70.parameters = u'alistair'
    tao_workflowcommand_70.executed = datetime.datetime(2013, 10, 24, 11, 8, 50, tzinfo=pytz.UTC)
    tao_workflowcommand_70.execution_status = u'COMPLETED'
    tao_workflowcommand_70.execution_comment = u'Job 225 successfully deleted.'
    tao_workflowcommand_70 = save_or_locate(tao_workflowcommand_70)

    tao_workflowcommand_71 = WorkflowCommand()
    tao_workflowcommand_71.job_id = None
    tao_workflowcommand_71.issued = datetime.datetime(2013, 10, 24, 11, 8, 51, tzinfo=pytz.UTC)
    tao_workflowcommand_71.command = u'Job_Output_Delete'
    tao_workflowcommand_71.parameters = u'alistair'
    tao_workflowcommand_71.executed = datetime.datetime(2013, 10, 24, 11, 8, 51, tzinfo=pytz.UTC)
    tao_workflowcommand_71.execution_status = u'COMPLETED'
    tao_workflowcommand_71.execution_comment = u'Job 230 successfully deleted.'
    tao_workflowcommand_71 = save_or_locate(tao_workflowcommand_71)

    tao_workflowcommand_72 = WorkflowCommand()
    tao_workflowcommand_72.job_id = None
    tao_workflowcommand_72.issued = datetime.datetime(2013, 10, 24, 11, 9, 22, tzinfo=pytz.UTC)
    tao_workflowcommand_72.command = u'Job_Output_Delete'
    tao_workflowcommand_72.parameters = u'alistair'
    tao_workflowcommand_72.executed = datetime.datetime(2013, 10, 24, 11, 9, 22, tzinfo=pytz.UTC)
    tao_workflowcommand_72.execution_status = u'COMPLETED'
    tao_workflowcommand_72.execution_comment = u'Job 240 successfully deleted.'
    tao_workflowcommand_72 = save_or_locate(tao_workflowcommand_72)

    tao_workflowcommand_73 = WorkflowCommand()
    tao_workflowcommand_73.job_id = None
    tao_workflowcommand_73.issued = datetime.datetime(2013, 10, 24, 11, 9, 22, tzinfo=pytz.UTC)
    tao_workflowcommand_73.command = u'Job_Output_Delete'
    tao_workflowcommand_73.parameters = u'alistair'
    tao_workflowcommand_73.executed = datetime.datetime(2013, 10, 24, 11, 9, 22, tzinfo=pytz.UTC)
    tao_workflowcommand_73.execution_status = u'COMPLETED'
    tao_workflowcommand_73.execution_comment = u'Job 241 successfully deleted.'
    tao_workflowcommand_73 = save_or_locate(tao_workflowcommand_73)

    tao_workflowcommand_74 = WorkflowCommand()
    tao_workflowcommand_74.job_id = None
    tao_workflowcommand_74.issued = datetime.datetime(2013, 10, 24, 11, 9, 23, tzinfo=pytz.UTC)
    tao_workflowcommand_74.command = u'Job_Output_Delete'
    tao_workflowcommand_74.parameters = u'alistair'
    tao_workflowcommand_74.executed = datetime.datetime(2013, 10, 24, 11, 9, 23, tzinfo=pytz.UTC)
    tao_workflowcommand_74.execution_status = u'COMPLETED'
    tao_workflowcommand_74.execution_comment = u'Job 251 successfully deleted.'
    tao_workflowcommand_74 = save_or_locate(tao_workflowcommand_74)

    tao_workflowcommand_75 = WorkflowCommand()
    tao_workflowcommand_75.job_id = None
    tao_workflowcommand_75.issued = datetime.datetime(2013, 10, 24, 11, 9, 23, tzinfo=pytz.UTC)
    tao_workflowcommand_75.command = u'Job_Output_Delete'
    tao_workflowcommand_75.parameters = u'alistair'
    tao_workflowcommand_75.executed = datetime.datetime(2013, 10, 24, 11, 9, 23, tzinfo=pytz.UTC)
    tao_workflowcommand_75.execution_status = u'COMPLETED'
    tao_workflowcommand_75.execution_comment = u'Job 252 successfully deleted.'
    tao_workflowcommand_75 = save_or_locate(tao_workflowcommand_75)

    tao_workflowcommand_76 = WorkflowCommand()
    tao_workflowcommand_76.job_id = None
    tao_workflowcommand_76.issued = datetime.datetime(2013, 10, 24, 11, 9, 55, tzinfo=pytz.UTC)
    tao_workflowcommand_76.command = u'Job_Output_Delete'
    tao_workflowcommand_76.parameters = u'alistair'
    tao_workflowcommand_76.executed = datetime.datetime(2013, 10, 24, 11, 9, 55, tzinfo=pytz.UTC)
    tao_workflowcommand_76.execution_status = u'COMPLETED'
    tao_workflowcommand_76.execution_comment = u'Job 256 successfully deleted.'
    tao_workflowcommand_76 = save_or_locate(tao_workflowcommand_76)

    tao_workflowcommand_77 = WorkflowCommand()
    tao_workflowcommand_77.job_id = None
    tao_workflowcommand_77.issued = datetime.datetime(2013, 10, 24, 11, 9, 55, tzinfo=pytz.UTC)
    tao_workflowcommand_77.command = u'Job_Output_Delete'
    tao_workflowcommand_77.parameters = u'alistair'
    tao_workflowcommand_77.executed = datetime.datetime(2013, 10, 24, 11, 9, 55, tzinfo=pytz.UTC)
    tao_workflowcommand_77.execution_status = u'COMPLETED'
    tao_workflowcommand_77.execution_comment = u'Job 259 successfully deleted.'
    tao_workflowcommand_77 = save_or_locate(tao_workflowcommand_77)

    tao_workflowcommand_78 = WorkflowCommand()
    tao_workflowcommand_78.job_id = None
    tao_workflowcommand_78.issued = datetime.datetime(2013, 10, 24, 11, 9, 56, tzinfo=pytz.UTC)
    tao_workflowcommand_78.command = u'Job_Output_Delete'
    tao_workflowcommand_78.parameters = u'alistair'
    tao_workflowcommand_78.executed = datetime.datetime(2013, 10, 24, 11, 9, 56, tzinfo=pytz.UTC)
    tao_workflowcommand_78.execution_status = u'COMPLETED'
    tao_workflowcommand_78.execution_comment = u'Job 267 successfully deleted.'
    tao_workflowcommand_78 = save_or_locate(tao_workflowcommand_78)

    tao_workflowcommand_79 = WorkflowCommand()
    tao_workflowcommand_79.job_id = None
    tao_workflowcommand_79.issued = datetime.datetime(2013, 10, 24, 11, 10, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_79.command = u'Job_Output_Delete'
    tao_workflowcommand_79.parameters = u'alistair'
    tao_workflowcommand_79.executed = datetime.datetime(2013, 10, 24, 11, 10, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_79.execution_status = u'COMPLETED'
    tao_workflowcommand_79.execution_comment = u'Job 273 successfully deleted.'
    tao_workflowcommand_79 = save_or_locate(tao_workflowcommand_79)

    tao_workflowcommand_80 = WorkflowCommand()
    tao_workflowcommand_80.job_id = None
    tao_workflowcommand_80.issued = datetime.datetime(2013, 10, 24, 11, 10, 28, tzinfo=pytz.UTC)
    tao_workflowcommand_80.command = u'Job_Output_Delete'
    tao_workflowcommand_80.parameters = u'alistair'
    tao_workflowcommand_80.executed = datetime.datetime(2013, 10, 24, 11, 10, 28, tzinfo=pytz.UTC)
    tao_workflowcommand_80.execution_status = u'COMPLETED'
    tao_workflowcommand_80.execution_comment = u'Job 274 successfully deleted.'
    tao_workflowcommand_80 = save_or_locate(tao_workflowcommand_80)

    tao_workflowcommand_81 = WorkflowCommand()
    tao_workflowcommand_81.job_id = None
    tao_workflowcommand_81.issued = datetime.datetime(2013, 10, 24, 11, 10, 28, tzinfo=pytz.UTC)
    tao_workflowcommand_81.command = u'Job_Output_Delete'
    tao_workflowcommand_81.parameters = u'alistair'
    tao_workflowcommand_81.executed = datetime.datetime(2013, 10, 24, 11, 10, 28, tzinfo=pytz.UTC)
    tao_workflowcommand_81.execution_status = u'COMPLETED'
    tao_workflowcommand_81.execution_comment = u'Job 275 successfully deleted.'
    tao_workflowcommand_81 = save_or_locate(tao_workflowcommand_81)

    tao_workflowcommand_82 = WorkflowCommand()
    tao_workflowcommand_82.job_id = None
    tao_workflowcommand_82.issued = datetime.datetime(2013, 10, 24, 11, 10, 59, tzinfo=pytz.UTC)
    tao_workflowcommand_82.command = u'Job_Output_Delete'
    tao_workflowcommand_82.parameters = u'alistair'
    tao_workflowcommand_82.executed = datetime.datetime(2013, 10, 24, 11, 10, 59, tzinfo=pytz.UTC)
    tao_workflowcommand_82.execution_status = u'COMPLETED'
    tao_workflowcommand_82.execution_comment = u'Job 278 successfully deleted.'
    tao_workflowcommand_82 = save_or_locate(tao_workflowcommand_82)

    tao_workflowcommand_83 = WorkflowCommand()
    tao_workflowcommand_83.job_id = None
    tao_workflowcommand_83.issued = datetime.datetime(2013, 10, 24, 11, 11, 31, tzinfo=pytz.UTC)
    tao_workflowcommand_83.command = u'Job_Output_Delete'
    tao_workflowcommand_83.parameters = u'alistair'
    tao_workflowcommand_83.executed = datetime.datetime(2013, 10, 24, 11, 11, 31, tzinfo=pytz.UTC)
    tao_workflowcommand_83.execution_status = u'COMPLETED'
    tao_workflowcommand_83.execution_comment = u'Job 281 successfully deleted.'
    tao_workflowcommand_83 = save_or_locate(tao_workflowcommand_83)

    tao_workflowcommand_84 = WorkflowCommand()
    tao_workflowcommand_84.job_id = None
    tao_workflowcommand_84.issued = datetime.datetime(2013, 10, 24, 11, 11, 31, tzinfo=pytz.UTC)
    tao_workflowcommand_84.command = u'Job_Output_Delete'
    tao_workflowcommand_84.parameters = u'alistair'
    tao_workflowcommand_84.executed = datetime.datetime(2013, 10, 24, 11, 11, 31, tzinfo=pytz.UTC)
    tao_workflowcommand_84.execution_status = u'COMPLETED'
    tao_workflowcommand_84.execution_comment = u'Job 282 successfully deleted.'
    tao_workflowcommand_84 = save_or_locate(tao_workflowcommand_84)

    tao_workflowcommand_85 = WorkflowCommand()
    tao_workflowcommand_85.job_id = None
    tao_workflowcommand_85.issued = datetime.datetime(2013, 10, 24, 11, 11, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_85.command = u'Job_Output_Delete'
    tao_workflowcommand_85.parameters = u'alistair'
    tao_workflowcommand_85.executed = datetime.datetime(2013, 10, 24, 11, 11, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_85.execution_status = u'COMPLETED'
    tao_workflowcommand_85.execution_comment = u'Job 283 successfully deleted.'
    tao_workflowcommand_85 = save_or_locate(tao_workflowcommand_85)

    tao_workflowcommand_86 = WorkflowCommand()
    tao_workflowcommand_86.job_id = None
    tao_workflowcommand_86.issued = datetime.datetime(2013, 10, 24, 11, 11, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_86.command = u'Job_Output_Delete'
    tao_workflowcommand_86.parameters = u'alistair'
    tao_workflowcommand_86.executed = datetime.datetime(2013, 10, 24, 11, 11, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_86.execution_status = u'COMPLETED'
    tao_workflowcommand_86.execution_comment = u'Job 284 successfully deleted.'
    tao_workflowcommand_86 = save_or_locate(tao_workflowcommand_86)

    tao_workflowcommand_87 = WorkflowCommand()
    tao_workflowcommand_87.job_id = None
    tao_workflowcommand_87.issued = datetime.datetime(2013, 10, 24, 11, 12, 3, tzinfo=pytz.UTC)
    tao_workflowcommand_87.command = u'Job_Output_Delete'
    tao_workflowcommand_87.parameters = u'alistair'
    tao_workflowcommand_87.executed = datetime.datetime(2013, 10, 24, 11, 12, 3, tzinfo=pytz.UTC)
    tao_workflowcommand_87.execution_status = u'COMPLETED'
    tao_workflowcommand_87.execution_comment = u'Job 285 successfully deleted.'
    tao_workflowcommand_87 = save_or_locate(tao_workflowcommand_87)

    tao_workflowcommand_88 = WorkflowCommand()
    tao_workflowcommand_88.job_id = None
    tao_workflowcommand_88.issued = datetime.datetime(2013, 10, 24, 11, 12, 4, tzinfo=pytz.UTC)
    tao_workflowcommand_88.command = u'Job_Output_Delete'
    tao_workflowcommand_88.parameters = u'alistair'
    tao_workflowcommand_88.executed = datetime.datetime(2013, 10, 24, 11, 12, 4, tzinfo=pytz.UTC)
    tao_workflowcommand_88.execution_status = u'COMPLETED'
    tao_workflowcommand_88.execution_comment = u'Job 286 successfully deleted.'
    tao_workflowcommand_88 = save_or_locate(tao_workflowcommand_88)

    tao_workflowcommand_89 = WorkflowCommand()
    tao_workflowcommand_89.job_id = None
    tao_workflowcommand_89.issued = datetime.datetime(2013, 10, 24, 11, 12, 4, tzinfo=pytz.UTC)
    tao_workflowcommand_89.command = u'Job_Output_Delete'
    tao_workflowcommand_89.parameters = u'alistair'
    tao_workflowcommand_89.executed = datetime.datetime(2013, 10, 24, 11, 12, 4, tzinfo=pytz.UTC)
    tao_workflowcommand_89.execution_status = u'COMPLETED'
    tao_workflowcommand_89.execution_comment = u'Job 303 successfully deleted.'
    tao_workflowcommand_89 = save_or_locate(tao_workflowcommand_89)

    tao_workflowcommand_90 = WorkflowCommand()
    tao_workflowcommand_90.job_id = None
    tao_workflowcommand_90.issued = datetime.datetime(2013, 10, 24, 11, 12, 36, tzinfo=pytz.UTC)
    tao_workflowcommand_90.command = u'Job_Output_Delete'
    tao_workflowcommand_90.parameters = u'alistair'
    tao_workflowcommand_90.executed = datetime.datetime(2013, 10, 24, 11, 12, 36, tzinfo=pytz.UTC)
    tao_workflowcommand_90.execution_status = u'COMPLETED'
    tao_workflowcommand_90.execution_comment = u'Job 306 successfully deleted.'
    tao_workflowcommand_90 = save_or_locate(tao_workflowcommand_90)

    tao_workflowcommand_91 = WorkflowCommand()
    tao_workflowcommand_91.job_id = None
    tao_workflowcommand_91.issued = datetime.datetime(2013, 10, 24, 11, 12, 37, tzinfo=pytz.UTC)
    tao_workflowcommand_91.command = u'Job_Output_Delete'
    tao_workflowcommand_91.parameters = u'alistair'
    tao_workflowcommand_91.executed = datetime.datetime(2013, 10, 24, 11, 12, 37, tzinfo=pytz.UTC)
    tao_workflowcommand_91.execution_status = u'COMPLETED'
    tao_workflowcommand_91.execution_comment = u'Job 308 successfully deleted.'
    tao_workflowcommand_91 = save_or_locate(tao_workflowcommand_91)

    tao_workflowcommand_92 = WorkflowCommand()
    tao_workflowcommand_92.job_id = None
    tao_workflowcommand_92.issued = datetime.datetime(2013, 10, 24, 11, 12, 37, tzinfo=pytz.UTC)
    tao_workflowcommand_92.command = u'Job_Output_Delete'
    tao_workflowcommand_92.parameters = u'alistair'
    tao_workflowcommand_92.executed = datetime.datetime(2013, 10, 24, 11, 12, 37, tzinfo=pytz.UTC)
    tao_workflowcommand_92.execution_status = u'COMPLETED'
    tao_workflowcommand_92.execution_comment = u'Job 318 successfully deleted.'
    tao_workflowcommand_92 = save_or_locate(tao_workflowcommand_92)

    tao_workflowcommand_93 = WorkflowCommand()
    tao_workflowcommand_93.job_id = None
    tao_workflowcommand_93.issued = datetime.datetime(2013, 10, 24, 11, 13, 9, tzinfo=pytz.UTC)
    tao_workflowcommand_93.command = u'Job_Output_Delete'
    tao_workflowcommand_93.parameters = u'alistair'
    tao_workflowcommand_93.executed = datetime.datetime(2013, 10, 24, 11, 13, 9, tzinfo=pytz.UTC)
    tao_workflowcommand_93.execution_status = u'COMPLETED'
    tao_workflowcommand_93.execution_comment = u'Job 320 successfully deleted.'
    tao_workflowcommand_93 = save_or_locate(tao_workflowcommand_93)

    tao_workflowcommand_94 = WorkflowCommand()
    tao_workflowcommand_94.job_id = None
    tao_workflowcommand_94.issued = datetime.datetime(2013, 10, 24, 11, 26, 13, tzinfo=pytz.UTC)
    tao_workflowcommand_94.command = u'Job_Output_Delete'
    tao_workflowcommand_94.parameters = u'alistair'
    tao_workflowcommand_94.executed = datetime.datetime(2013, 10, 24, 11, 26, 13, tzinfo=pytz.UTC)
    tao_workflowcommand_94.execution_status = u'COMPLETED'
    tao_workflowcommand_94.execution_comment = u'Job 321 successfully deleted.'
    tao_workflowcommand_94 = save_or_locate(tao_workflowcommand_94)

    tao_workflowcommand_95 = WorkflowCommand()
    tao_workflowcommand_95.job_id = None
    tao_workflowcommand_95.issued = datetime.datetime(2013, 10, 24, 11, 26, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_95.command = u'Job_Output_Delete'
    tao_workflowcommand_95.parameters = u'alistair'
    tao_workflowcommand_95.executed = datetime.datetime(2013, 10, 24, 11, 26, 14, tzinfo=pytz.UTC)
    tao_workflowcommand_95.execution_status = u'COMPLETED'
    tao_workflowcommand_95.execution_comment = u'Job 322 successfully deleted.'
    tao_workflowcommand_95 = save_or_locate(tao_workflowcommand_95)

    tao_workflowcommand_96 = WorkflowCommand()
    tao_workflowcommand_96.job_id = None
    tao_workflowcommand_96.issued = datetime.datetime(2013, 10, 24, 11, 26, 45, tzinfo=pytz.UTC)
    tao_workflowcommand_96.command = u'Job_Output_Delete'
    tao_workflowcommand_96.parameters = u'alistair'
    tao_workflowcommand_96.executed = datetime.datetime(2013, 10, 24, 11, 26, 45, tzinfo=pytz.UTC)
    tao_workflowcommand_96.execution_status = u'COMPLETED'
    tao_workflowcommand_96.execution_comment = u'Job 323 successfully deleted.'
    tao_workflowcommand_96 = save_or_locate(tao_workflowcommand_96)

    tao_workflowcommand_97 = WorkflowCommand()
    tao_workflowcommand_97.job_id = None
    tao_workflowcommand_97.issued = datetime.datetime(2013, 10, 24, 11, 26, 45, tzinfo=pytz.UTC)
    tao_workflowcommand_97.command = u'Job_Output_Delete'
    tao_workflowcommand_97.parameters = u'alistair'
    tao_workflowcommand_97.executed = datetime.datetime(2013, 10, 24, 11, 26, 45, tzinfo=pytz.UTC)
    tao_workflowcommand_97.execution_status = u'COMPLETED'
    tao_workflowcommand_97.execution_comment = u'Job 324 successfully deleted.'
    tao_workflowcommand_97 = save_or_locate(tao_workflowcommand_97)

    tao_workflowcommand_98 = WorkflowCommand()
    tao_workflowcommand_98.job_id = None
    tao_workflowcommand_98.issued = datetime.datetime(2013, 10, 24, 11, 26, 46, tzinfo=pytz.UTC)
    tao_workflowcommand_98.command = u'Job_Output_Delete'
    tao_workflowcommand_98.parameters = u'alistair'
    tao_workflowcommand_98.executed = datetime.datetime(2013, 10, 24, 11, 26, 46, tzinfo=pytz.UTC)
    tao_workflowcommand_98.execution_status = u'COMPLETED'
    tao_workflowcommand_98.execution_comment = u'Job 325 successfully deleted.'
    tao_workflowcommand_98 = save_or_locate(tao_workflowcommand_98)

    tao_workflowcommand_99 = WorkflowCommand()
    tao_workflowcommand_99.job_id = None
    tao_workflowcommand_99.issued = datetime.datetime(2013, 10, 24, 11, 26, 46, tzinfo=pytz.UTC)
    tao_workflowcommand_99.command = u'Job_Output_Delete'
    tao_workflowcommand_99.parameters = u'alistair'
    tao_workflowcommand_99.executed = datetime.datetime(2013, 10, 24, 11, 26, 46, tzinfo=pytz.UTC)
    tao_workflowcommand_99.execution_status = u'COMPLETED'
    tao_workflowcommand_99.execution_comment = u'Job 327 successfully deleted.'
    tao_workflowcommand_99 = save_or_locate(tao_workflowcommand_99)

    tao_workflowcommand_100 = WorkflowCommand()
    tao_workflowcommand_100.job_id = None
    tao_workflowcommand_100.issued = datetime.datetime(2013, 10, 24, 11, 27, 18, tzinfo=pytz.UTC)
    tao_workflowcommand_100.command = u'Job_Output_Delete'
    tao_workflowcommand_100.parameters = u'alistair'
    tao_workflowcommand_100.executed = datetime.datetime(2013, 10, 24, 11, 27, 18, tzinfo=pytz.UTC)
    tao_workflowcommand_100.execution_status = u'COMPLETED'
    tao_workflowcommand_100.execution_comment = u'Job 331 successfully deleted.'
    tao_workflowcommand_100 = save_or_locate(tao_workflowcommand_100)

    tao_workflowcommand_101 = WorkflowCommand()
    tao_workflowcommand_101.job_id = None
    tao_workflowcommand_101.issued = datetime.datetime(2013, 10, 24, 11, 27, 18, tzinfo=pytz.UTC)
    tao_workflowcommand_101.command = u'Job_Output_Delete'
    tao_workflowcommand_101.parameters = u'alistair'
    tao_workflowcommand_101.executed = datetime.datetime(2013, 10, 24, 11, 27, 18, tzinfo=pytz.UTC)
    tao_workflowcommand_101.execution_status = u'COMPLETED'
    tao_workflowcommand_101.execution_comment = u'Job 343 successfully deleted.'
    tao_workflowcommand_101 = save_or_locate(tao_workflowcommand_101)

    tao_workflowcommand_102 = WorkflowCommand()
    tao_workflowcommand_102.job_id = None
    tao_workflowcommand_102.issued = datetime.datetime(2013, 10, 24, 11, 27, 19, tzinfo=pytz.UTC)
    tao_workflowcommand_102.command = u'Job_Output_Delete'
    tao_workflowcommand_102.parameters = u'alistair'
    tao_workflowcommand_102.executed = datetime.datetime(2013, 10, 24, 11, 27, 19, tzinfo=pytz.UTC)
    tao_workflowcommand_102.execution_status = u'COMPLETED'
    tao_workflowcommand_102.execution_comment = u'Job 345 successfully deleted.'
    tao_workflowcommand_102 = save_or_locate(tao_workflowcommand_102)

    tao_workflowcommand_103 = WorkflowCommand()
    tao_workflowcommand_103.job_id = None
    tao_workflowcommand_103.issued = datetime.datetime(2013, 10, 24, 11, 27, 51, tzinfo=pytz.UTC)
    tao_workflowcommand_103.command = u'Job_Output_Delete'
    tao_workflowcommand_103.parameters = u'alistair'
    tao_workflowcommand_103.executed = datetime.datetime(2013, 10, 24, 11, 27, 51, tzinfo=pytz.UTC)
    tao_workflowcommand_103.execution_status = u'COMPLETED'
    tao_workflowcommand_103.execution_comment = u'Job 346 successfully deleted.'
    tao_workflowcommand_103 = save_or_locate(tao_workflowcommand_103)

    tao_workflowcommand_104 = WorkflowCommand()
    tao_workflowcommand_104.job_id = None
    tao_workflowcommand_104.issued = datetime.datetime(2013, 10, 24, 11, 27, 51, tzinfo=pytz.UTC)
    tao_workflowcommand_104.command = u'Job_Output_Delete'
    tao_workflowcommand_104.parameters = u'alistair'
    tao_workflowcommand_104.executed = datetime.datetime(2013, 10, 24, 11, 27, 51, tzinfo=pytz.UTC)
    tao_workflowcommand_104.execution_status = u'COMPLETED'
    tao_workflowcommand_104.execution_comment = u'Job 347 successfully deleted.'
    tao_workflowcommand_104 = save_or_locate(tao_workflowcommand_104)

    tao_workflowcommand_105 = WorkflowCommand()
    tao_workflowcommand_105.job_id = None
    tao_workflowcommand_105.issued = datetime.datetime(2013, 10, 24, 11, 27, 52, tzinfo=pytz.UTC)
    tao_workflowcommand_105.command = u'Job_Output_Delete'
    tao_workflowcommand_105.parameters = u'alistair'
    tao_workflowcommand_105.executed = datetime.datetime(2013, 10, 24, 11, 27, 52, tzinfo=pytz.UTC)
    tao_workflowcommand_105.execution_status = u'COMPLETED'
    tao_workflowcommand_105.execution_comment = u'Job 348 successfully deleted.'
    tao_workflowcommand_105 = save_or_locate(tao_workflowcommand_105)

    tao_workflowcommand_106 = WorkflowCommand()
    tao_workflowcommand_106.job_id = None
    tao_workflowcommand_106.issued = datetime.datetime(2013, 10, 24, 11, 27, 52, tzinfo=pytz.UTC)
    tao_workflowcommand_106.command = u'Job_Output_Delete'
    tao_workflowcommand_106.parameters = u'alistair'
    tao_workflowcommand_106.executed = datetime.datetime(2013, 10, 24, 11, 27, 52, tzinfo=pytz.UTC)
    tao_workflowcommand_106.execution_status = u'COMPLETED'
    tao_workflowcommand_106.execution_comment = u'Job 349 successfully deleted.'
    tao_workflowcommand_106 = save_or_locate(tao_workflowcommand_106)

    tao_workflowcommand_107 = WorkflowCommand()
    tao_workflowcommand_107.job_id = None
    tao_workflowcommand_107.issued = datetime.datetime(2013, 10, 24, 11, 28, 24, tzinfo=pytz.UTC)
    tao_workflowcommand_107.command = u'Job_Output_Delete'
    tao_workflowcommand_107.parameters = u'alistair'
    tao_workflowcommand_107.executed = datetime.datetime(2013, 10, 24, 11, 28, 24, tzinfo=pytz.UTC)
    tao_workflowcommand_107.execution_status = u'COMPLETED'
    tao_workflowcommand_107.execution_comment = u'Job 350 successfully deleted.'
    tao_workflowcommand_107 = save_or_locate(tao_workflowcommand_107)

    tao_workflowcommand_108 = WorkflowCommand()
    tao_workflowcommand_108.job_id = None
    tao_workflowcommand_108.issued = datetime.datetime(2013, 10, 24, 11, 28, 55, tzinfo=pytz.UTC)
    tao_workflowcommand_108.command = u'Job_Output_Delete'
    tao_workflowcommand_108.parameters = u'alistair'
    tao_workflowcommand_108.executed = datetime.datetime(2013, 10, 24, 11, 28, 55, tzinfo=pytz.UTC)
    tao_workflowcommand_108.execution_status = u'COMPLETED'
    tao_workflowcommand_108.execution_comment = u'Job 451 successfully deleted.'
    tao_workflowcommand_108 = save_or_locate(tao_workflowcommand_108)

    tao_workflowcommand_109 = WorkflowCommand()
    tao_workflowcommand_109.job_id = None
    tao_workflowcommand_109.issued = datetime.datetime(2013, 10, 24, 11, 28, 56, tzinfo=pytz.UTC)
    tao_workflowcommand_109.command = u'Job_Output_Delete'
    tao_workflowcommand_109.parameters = u'alistair'
    tao_workflowcommand_109.executed = datetime.datetime(2013, 10, 24, 11, 28, 56, tzinfo=pytz.UTC)
    tao_workflowcommand_109.execution_status = u'COMPLETED'
    tao_workflowcommand_109.execution_comment = u'Job 450 successfully deleted.'
    tao_workflowcommand_109 = save_or_locate(tao_workflowcommand_109)

    tao_workflowcommand_110 = WorkflowCommand()
    tao_workflowcommand_110.job_id = None
    tao_workflowcommand_110.issued = datetime.datetime(2013, 10, 24, 11, 28, 56, tzinfo=pytz.UTC)
    tao_workflowcommand_110.command = u'Job_Output_Delete'
    tao_workflowcommand_110.parameters = u'alistair'
    tao_workflowcommand_110.executed = datetime.datetime(2013, 10, 24, 11, 28, 56, tzinfo=pytz.UTC)
    tao_workflowcommand_110.execution_status = u'COMPLETED'
    tao_workflowcommand_110.execution_comment = u'Job 447 successfully deleted.'
    tao_workflowcommand_110 = save_or_locate(tao_workflowcommand_110)

    tao_workflowcommand_111 = WorkflowCommand()
    tao_workflowcommand_111.job_id = None
    tao_workflowcommand_111.issued = datetime.datetime(2013, 10, 24, 11, 28, 57, tzinfo=pytz.UTC)
    tao_workflowcommand_111.command = u'Job_Output_Delete'
    tao_workflowcommand_111.parameters = u'alistair'
    tao_workflowcommand_111.executed = datetime.datetime(2013, 10, 24, 11, 28, 57, tzinfo=pytz.UTC)
    tao_workflowcommand_111.execution_status = u'COMPLETED'
    tao_workflowcommand_111.execution_comment = u'Job 441 successfully deleted.'
    tao_workflowcommand_111 = save_or_locate(tao_workflowcommand_111)

    tao_workflowcommand_112 = WorkflowCommand()
    tao_workflowcommand_112.job_id = None
    tao_workflowcommand_112.issued = datetime.datetime(2013, 10, 24, 11, 29, 28, tzinfo=pytz.UTC)
    tao_workflowcommand_112.command = u'Job_Output_Delete'
    tao_workflowcommand_112.parameters = u'alistair'
    tao_workflowcommand_112.executed = datetime.datetime(2013, 10, 24, 11, 29, 28, tzinfo=pytz.UTC)
    tao_workflowcommand_112.execution_status = u'COMPLETED'
    tao_workflowcommand_112.execution_comment = u'Job 440 successfully deleted.'
    tao_workflowcommand_112 = save_or_locate(tao_workflowcommand_112)

    tao_workflowcommand_113 = WorkflowCommand()
    tao_workflowcommand_113.job_id = None
    tao_workflowcommand_113.issued = datetime.datetime(2013, 10, 24, 11, 29, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_113.command = u'Job_Output_Delete'
    tao_workflowcommand_113.parameters = u'alistair'
    tao_workflowcommand_113.executed = datetime.datetime(2013, 10, 24, 11, 29, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_113.execution_status = u'COMPLETED'
    tao_workflowcommand_113.execution_comment = u'Job 439 successfully deleted.'
    tao_workflowcommand_113 = save_or_locate(tao_workflowcommand_113)

    tao_workflowcommand_114 = WorkflowCommand()
    tao_workflowcommand_114.job_id = None
    tao_workflowcommand_114.issued = datetime.datetime(2013, 10, 24, 11, 29, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_114.command = u'Job_Output_Delete'
    tao_workflowcommand_114.parameters = u'alistair'
    tao_workflowcommand_114.executed = datetime.datetime(2013, 10, 24, 11, 29, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_114.execution_status = u'COMPLETED'
    tao_workflowcommand_114.execution_comment = u'Job 438 successfully deleted.'
    tao_workflowcommand_114 = save_or_locate(tao_workflowcommand_114)

    tao_workflowcommand_115 = WorkflowCommand()
    tao_workflowcommand_115.job_id = None
    tao_workflowcommand_115.issued = datetime.datetime(2013, 10, 24, 11, 29, 30, tzinfo=pytz.UTC)
    tao_workflowcommand_115.command = u'Job_Output_Delete'
    tao_workflowcommand_115.parameters = u'alistair'
    tao_workflowcommand_115.executed = datetime.datetime(2013, 10, 24, 11, 29, 30, tzinfo=pytz.UTC)
    tao_workflowcommand_115.execution_status = u'COMPLETED'
    tao_workflowcommand_115.execution_comment = u'Job 437 successfully deleted.'
    tao_workflowcommand_115 = save_or_locate(tao_workflowcommand_115)

    tao_workflowcommand_116 = WorkflowCommand()
    tao_workflowcommand_116.job_id = None
    tao_workflowcommand_116.issued = datetime.datetime(2013, 10, 24, 11, 29, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_116.command = u'Job_Output_Delete'
    tao_workflowcommand_116.parameters = u'alistair'
    tao_workflowcommand_116.executed = datetime.datetime(2013, 10, 24, 11, 29, 32, tzinfo=pytz.UTC)
    tao_workflowcommand_116.execution_status = u'COMPLETED'
    tao_workflowcommand_116.execution_comment = u'Job 435 successfully deleted.'
    tao_workflowcommand_116 = save_or_locate(tao_workflowcommand_116)

    tao_workflowcommand_117 = WorkflowCommand()
    tao_workflowcommand_117.job_id = None
    tao_workflowcommand_117.issued = datetime.datetime(2013, 10, 24, 11, 30, 34, tzinfo=pytz.UTC)
    tao_workflowcommand_117.command = u'Job_Output_Delete'
    tao_workflowcommand_117.parameters = u'alistair'
    tao_workflowcommand_117.executed = datetime.datetime(2013, 10, 24, 11, 30, 34, tzinfo=pytz.UTC)
    tao_workflowcommand_117.execution_status = u'COMPLETED'
    tao_workflowcommand_117.execution_comment = u'Job 408 successfully deleted.'
    tao_workflowcommand_117 = save_or_locate(tao_workflowcommand_117)

    tao_workflowcommand_118 = WorkflowCommand()
    tao_workflowcommand_118.job_id = None
    tao_workflowcommand_118.issued = datetime.datetime(2013, 10, 24, 11, 30, 34, tzinfo=pytz.UTC)
    tao_workflowcommand_118.command = u'Job_Output_Delete'
    tao_workflowcommand_118.parameters = u'alistair'
    tao_workflowcommand_118.executed = datetime.datetime(2013, 10, 24, 11, 30, 34, tzinfo=pytz.UTC)
    tao_workflowcommand_118.execution_status = u'COMPLETED'
    tao_workflowcommand_118.execution_comment = u'Job 404 successfully deleted.'
    tao_workflowcommand_118 = save_or_locate(tao_workflowcommand_118)

    tao_workflowcommand_119 = WorkflowCommand()
    tao_workflowcommand_119.job_id = None
    tao_workflowcommand_119.issued = datetime.datetime(2013, 10, 24, 11, 30, 34, tzinfo=pytz.UTC)
    tao_workflowcommand_119.command = u'Job_Output_Delete'
    tao_workflowcommand_119.parameters = u'alistair'
    tao_workflowcommand_119.executed = datetime.datetime(2013, 10, 24, 11, 30, 34, tzinfo=pytz.UTC)
    tao_workflowcommand_119.execution_status = u'COMPLETED'
    tao_workflowcommand_119.execution_comment = u'Job 403 successfully deleted.'
    tao_workflowcommand_119 = save_or_locate(tao_workflowcommand_119)

    tao_workflowcommand_120 = WorkflowCommand()
    tao_workflowcommand_120.job_id = None
    tao_workflowcommand_120.issued = datetime.datetime(2013, 10, 24, 11, 31, 6, tzinfo=pytz.UTC)
    tao_workflowcommand_120.command = u'Job_Output_Delete'
    tao_workflowcommand_120.parameters = u'alistair'
    tao_workflowcommand_120.executed = datetime.datetime(2013, 10, 24, 11, 31, 5, tzinfo=pytz.UTC)
    tao_workflowcommand_120.execution_status = u'COMPLETED'
    tao_workflowcommand_120.execution_comment = u'Job 402 successfully deleted.'
    tao_workflowcommand_120 = save_or_locate(tao_workflowcommand_120)

    tao_workflowcommand_121 = WorkflowCommand()
    tao_workflowcommand_121.job_id = None
    tao_workflowcommand_121.issued = datetime.datetime(2013, 10, 24, 11, 31, 6, tzinfo=pytz.UTC)
    tao_workflowcommand_121.command = u'Job_Output_Delete'
    tao_workflowcommand_121.parameters = u'alistair'
    tao_workflowcommand_121.executed = datetime.datetime(2013, 10, 24, 11, 31, 6, tzinfo=pytz.UTC)
    tao_workflowcommand_121.execution_status = u'COMPLETED'
    tao_workflowcommand_121.execution_comment = u'Job 401 successfully deleted.'
    tao_workflowcommand_121 = save_or_locate(tao_workflowcommand_121)

    tao_workflowcommand_122 = WorkflowCommand()
    tao_workflowcommand_122.job_id = None
    tao_workflowcommand_122.issued = datetime.datetime(2013, 10, 24, 11, 31, 7, tzinfo=pytz.UTC)
    tao_workflowcommand_122.command = u'Job_Output_Delete'
    tao_workflowcommand_122.parameters = u'alistair'
    tao_workflowcommand_122.executed = datetime.datetime(2013, 10, 24, 11, 31, 7, tzinfo=pytz.UTC)
    tao_workflowcommand_122.execution_status = u'COMPLETED'
    tao_workflowcommand_122.execution_comment = u'Job 400 successfully deleted.'
    tao_workflowcommand_122 = save_or_locate(tao_workflowcommand_122)

    tao_workflowcommand_123 = WorkflowCommand()
    tao_workflowcommand_123.job_id = None
    tao_workflowcommand_123.issued = datetime.datetime(2013, 10, 24, 11, 31, 7, tzinfo=pytz.UTC)
    tao_workflowcommand_123.command = u'Job_Output_Delete'
    tao_workflowcommand_123.parameters = u'alistair'
    tao_workflowcommand_123.executed = datetime.datetime(2013, 10, 24, 11, 31, 7, tzinfo=pytz.UTC)
    tao_workflowcommand_123.execution_status = u'COMPLETED'
    tao_workflowcommand_123.execution_comment = u'Job 393 successfully deleted.'
    tao_workflowcommand_123 = save_or_locate(tao_workflowcommand_123)

    tao_workflowcommand_124 = WorkflowCommand()
    tao_workflowcommand_124.job_id = None
    tao_workflowcommand_124.issued = datetime.datetime(2013, 10, 24, 11, 31, 7, tzinfo=pytz.UTC)
    tao_workflowcommand_124.command = u'Job_Output_Delete'
    tao_workflowcommand_124.parameters = u'alistair'
    tao_workflowcommand_124.executed = datetime.datetime(2013, 10, 24, 11, 31, 7, tzinfo=pytz.UTC)
    tao_workflowcommand_124.execution_status = u'COMPLETED'
    tao_workflowcommand_124.execution_comment = u'Job 392 successfully deleted.'
    tao_workflowcommand_124 = save_or_locate(tao_workflowcommand_124)

    tao_workflowcommand_125 = WorkflowCommand()
    tao_workflowcommand_125.job_id = None
    tao_workflowcommand_125.issued = datetime.datetime(2013, 10, 24, 11, 31, 39, tzinfo=pytz.UTC)
    tao_workflowcommand_125.command = u'Job_Output_Delete'
    tao_workflowcommand_125.parameters = u'alistair'
    tao_workflowcommand_125.executed = datetime.datetime(2013, 10, 24, 11, 31, 39, tzinfo=pytz.UTC)
    tao_workflowcommand_125.execution_status = u'COMPLETED'
    tao_workflowcommand_125.execution_comment = u'Job 389 successfully deleted.'
    tao_workflowcommand_125 = save_or_locate(tao_workflowcommand_125)

    tao_workflowcommand_126 = WorkflowCommand()
    tao_workflowcommand_126.job_id = None
    tao_workflowcommand_126.issued = datetime.datetime(2013, 10, 24, 11, 31, 39, tzinfo=pytz.UTC)
    tao_workflowcommand_126.command = u'Job_Output_Delete'
    tao_workflowcommand_126.parameters = u'alistair'
    tao_workflowcommand_126.executed = datetime.datetime(2013, 10, 24, 11, 31, 39, tzinfo=pytz.UTC)
    tao_workflowcommand_126.execution_status = u'COMPLETED'
    tao_workflowcommand_126.execution_comment = u'Job 388 successfully deleted.'
    tao_workflowcommand_126 = save_or_locate(tao_workflowcommand_126)

    tao_workflowcommand_127 = WorkflowCommand()
    tao_workflowcommand_127.job_id = None
    tao_workflowcommand_127.issued = datetime.datetime(2013, 10, 24, 11, 31, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_127.command = u'Job_Output_Delete'
    tao_workflowcommand_127.parameters = u'alistair'
    tao_workflowcommand_127.executed = datetime.datetime(2013, 10, 24, 11, 31, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_127.execution_status = u'COMPLETED'
    tao_workflowcommand_127.execution_comment = u'Job 352 successfully deleted.'
    tao_workflowcommand_127 = save_or_locate(tao_workflowcommand_127)

    tao_workflowcommand_128 = WorkflowCommand()
    tao_workflowcommand_128.job_id = None
    tao_workflowcommand_128.issued = datetime.datetime(2013, 10, 24, 11, 31, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_128.command = u'Job_Output_Delete'
    tao_workflowcommand_128.parameters = u'alistair'
    tao_workflowcommand_128.executed = datetime.datetime(2013, 10, 24, 11, 31, 41, tzinfo=pytz.UTC)
    tao_workflowcommand_128.execution_status = u'COMPLETED'
    tao_workflowcommand_128.execution_comment = u'Job 351 successfully deleted.'
    tao_workflowcommand_128 = save_or_locate(tao_workflowcommand_128)

    tao_workflowcommand_129 = WorkflowCommand()
    tao_workflowcommand_129.job_id = None
    tao_workflowcommand_129.issued = datetime.datetime(2013, 10, 28, 4, 55, 23, tzinfo=pytz.UTC)
    tao_workflowcommand_129.command = u'Job_Output_Delete'
    tao_workflowcommand_129.parameters = u'amr'
    tao_workflowcommand_129.executed = datetime.datetime(2013, 10, 28, 4, 55, 23, tzinfo=pytz.UTC)
    tao_workflowcommand_129.execution_status = u'COMPLETED'
    tao_workflowcommand_129.execution_comment = u'Job 164 successfully deleted.'
    tao_workflowcommand_129 = save_or_locate(tao_workflowcommand_129)

    tao_workflowcommand_130 = WorkflowCommand()
    tao_workflowcommand_130.job_id = None
    tao_workflowcommand_130.issued = datetime.datetime(2013, 10, 28, 4, 56, 26, tzinfo=pytz.UTC)
    tao_workflowcommand_130.command = u'Job_Output_Delete'
    tao_workflowcommand_130.parameters = u'amr'
    tao_workflowcommand_130.executed = datetime.datetime(2013, 10, 28, 4, 56, 26, tzinfo=pytz.UTC)
    tao_workflowcommand_130.execution_status = u'COMPLETED'
    tao_workflowcommand_130.execution_comment = u'Job 429 successfully deleted.'
    tao_workflowcommand_130 = save_or_locate(tao_workflowcommand_130)

    tao_workflowcommand_131 = WorkflowCommand()
    tao_workflowcommand_131.job_id = None
    tao_workflowcommand_131.issued = datetime.datetime(2013, 10, 28, 4, 57, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_131.command = u'Job_Output_Delete'
    tao_workflowcommand_131.parameters = u'amr'
    tao_workflowcommand_131.executed = datetime.datetime(2013, 10, 28, 4, 57, 27, tzinfo=pytz.UTC)
    tao_workflowcommand_131.execution_status = u'COMPLETED'
    tao_workflowcommand_131.execution_comment = u'Job 93 successfully deleted.'
    tao_workflowcommand_131 = save_or_locate(tao_workflowcommand_131)

    tao_workflowcommand_132 = WorkflowCommand()
    tao_workflowcommand_132.job_id = None
    tao_workflowcommand_132.issued = datetime.datetime(2013, 11, 4, 4, 41, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_132.command = u'Job_Output_Delete'
    tao_workflowcommand_132.parameters = u'alistair'
    tao_workflowcommand_132.executed = datetime.datetime(2013, 11, 4, 4, 41, 29, tzinfo=pytz.UTC)
    tao_workflowcommand_132.execution_status = u'COMPLETED'
    tao_workflowcommand_132.execution_comment = u'Job 518 successfully deleted.'
    tao_workflowcommand_132 = save_or_locate(tao_workflowcommand_132)

    tao_workflowcommand_133 = WorkflowCommand()
    tao_workflowcommand_133.job_id = None
    tao_workflowcommand_133.issued = datetime.datetime(2013, 11, 4, 5, 32, 46, tzinfo=pytz.UTC)
    tao_workflowcommand_133.command = u'Job_Output_Delete'
    tao_workflowcommand_133.parameters = u'alistair'
    tao_workflowcommand_133.executed = datetime.datetime(2013, 11, 4, 5, 32, 46, tzinfo=pytz.UTC)
    tao_workflowcommand_133.execution_status = u'COMPLETED'
    tao_workflowcommand_133.execution_comment = u'Job 520 successfully deleted.'
    tao_workflowcommand_133 = save_or_locate(tao_workflowcommand_133)

    tao_workflowcommand_134 = WorkflowCommand()
    tao_workflowcommand_134.job_id = None
    tao_workflowcommand_134.issued = datetime.datetime(2013, 11, 4, 5, 33, 19, tzinfo=pytz.UTC)
    tao_workflowcommand_134.command = u'Job_Output_Delete'
    tao_workflowcommand_134.parameters = u'alistair'
    tao_workflowcommand_134.executed = datetime.datetime(2013, 11, 4, 5, 33, 19, tzinfo=pytz.UTC)
    tao_workflowcommand_134.execution_status = u'COMPLETED'
    tao_workflowcommand_134.execution_comment = u'Job 519 successfully deleted.'
    tao_workflowcommand_134 = save_or_locate(tao_workflowcommand_134)

    tao_workflowcommand_135 = WorkflowCommand()
    tao_workflowcommand_135.job_id = None
    tao_workflowcommand_135.issued = datetime.datetime(2013, 11, 6, 3, 58, 9, tzinfo=pytz.UTC)
    tao_workflowcommand_135.command = u'Job_Output_Delete'
    tao_workflowcommand_135.parameters = u'hdenes'
    tao_workflowcommand_135.executed = datetime.datetime(2013, 11, 6, 3, 58, 9, tzinfo=pytz.UTC)
    tao_workflowcommand_135.execution_status = u'COMPLETED'
    tao_workflowcommand_135.execution_comment = u'Job 523 successfully deleted.'
    tao_workflowcommand_135 = save_or_locate(tao_workflowcommand_135)
    ...
    tao_taouser_1.password = u'pbkdf2_sha256$10000$6fE5LfP0fboC$yHOiLfaxTJHmLlAzpaMnVx+rUMcVvnaMNSsrNRgOKUk='
    tao_taouser_1.last_login = datetime.datetime(2013, 10, 23, 23, 44, 39, tzinfo=pytz.UTC)
    tao_taouser_1.is_superuser = False
    tao_taouser_1.username = u'kali'
    tao_taouser_1.first_name = u'Kali'
    tao_taouser_1.last_name = u''
    tao_taouser_1.email = u'kali@intersect.org.au'
    tao_taouser_1.is_staff = False
    tao_taouser_1.is_active = True
    tao_taouser_1.date_joined = datetime.datetime(2012, 9, 6, 9, 47, 26, tzinfo=pytz.UTC)
    tao_taouser_1.institution = u'Intersect'
    tao_taouser_1.scientific_interests = u"Kali's interests"
    tao_taouser_1.title = u'Ms'
    tao_taouser_1.rejected = False
    tao_taouser_1.aaf_shared_token = u''
    tao_taouser_1.account_registration_status = u'NA'
    tao_taouser_1.account_registration_reason = None
    tao_taouser_1.account_registration_date = None
    tao_taouser_1.disk_quota = 0L
    tao_taouser_1 = save_or_locate(tao_taouser_1)

    tao_taouser_2 = TaoUser()
    tao_taouser_2.password = u'pbkdf2_sha256$10000$BcLRdGjf74uC$YudRGlE9ylpj5NX6cVxoPG02zdvMbTa2lyPzlSvbNMk='
    tao_taouser_2.last_login = datetime.datetime(2013, 11, 4, 5, 43, 45, tzinfo=pytz.UTC)
    tao_taouser_2.is_superuser = True
    tao_taouser_2.username = u'amr'
    tao_taouser_2.first_name = u'Amr'
    tao_taouser_2.last_name = u'Hassan'
    tao_taouser_2.email = u'ahassan@swin.edu.au'
    tao_taouser_2.is_staff = True
    tao_taouser_2.is_active = True
    tao_taouser_2.date_joined = datetime.datetime(2012, 9, 10, 15, 25, 36, tzinfo=pytz.UTC)
    tao_taouser_2.institution = u'SUT'
    tao_taouser_2.scientific_interests = u'astronomy'
    ...
    tao_taouser_2.account_registration_reason = None
    tao_taouser_2.account_registration_date = None
    tao_taouser_2.disk_quota = 0L
    tao_taouser_2 = save_or_locate(tao_taouser_2)

    tao_taouser_3 = TaoUser()
    tao_taouser_3.password = u'pbkdf2_sha256$10000$W9ltEQlYgryE$HYWja8zPHnoCtvHfueobnYf2M3bW9HibAJN5/YRA938='
    tao_taouser_3.last_login = datetime.datetime(2013, 11, 4, 9, 45, 31, tzinfo=pytz.UTC)
    tao_taouser_3.is_superuser = True
    tao_taouser_3.username = u'alistair'
    tao_taouser_3.first_name = u'Alistair'
    tao_taouser_3.last_name = u'Grant'
    tao_taouser_3.email = u'akgrant@gmail.com'
    tao_taouser_3.is_staff = True
    tao_taouser_3.is_active = True
    tao_taouser_3.date_joined = datetime.datetime(2012, 11, 15, 0, 28, 23, tzinfo=pytz.UTC)
    tao_taouser_3.institution = u'Intersect'
    tao_taouser_3.scientific_interests = u'A working TAO system.'
    tao_taouser_3.title = u'Mr'
    tao_taouser_3.rejected = False
    tao_taouser_3.aaf_shared_token = u''
    tao_taouser_3.account_registration_status = u'NA'
    tao_taouser_3.account_registration_reason = None
    tao_taouser_3.account_registration_date = None
    tao_taouser_3.disk_quota = 0L
    tao_taouser_3 = save_or_locate(tao_taouser_3)

    tao_taouser_4 = TaoUser()
    tao_taouser_4.password = u'pbkdf2_sha256$10000$DqPcCKlhfFoQ$eEvP3QoacmDUMyK36tgt8DZ1GSpljLtRWpKzgzvXZj4='
    tao_taouser_4.last_login = datetime.datetime(2013, 8, 26, 23, 8, 48, tzinfo=pytz.UTC)
    tao_taouser_4.is_superuser = True
    tao_taouser_4.username = u'kohsin'
    tao_taouser_4.first_name = u'Ko-Hsin'
    tao_taouser_4.last_name = u'Wang'
    tao_taouser_4.email = u'cindy@intersect.org.au'
    tao_taouser_4.is_staff = True
    tao_taouser_4.is_active = True
    tao_taouser_4.date_joined = datetime.datetime(2012, 12, 11, 23, 43, 23, tzinfo=pytz.UTC)
    tao_taouser_4.institution = u'Intersect'
    tao_taouser_4.scientific_interests = u''
    tao_taouser_4.title = u'Miss'
    tao_taouser_4.rejected = False
    tao_taouser_4.aaf_shared_token = u''
    tao_taouser_4.account_registration_status = u'NA'
    tao_taouser_4.account_registration_reason = None
    tao_taouser_4.account_registration_date = None
    tao_taouser_4.disk_quota = 0L
    tao_taouser_4 = save_or_locate(tao_taouser_4)

    tao_taouser_5 = TaoUser()
    tao_taouser_5.password = u'pbkdf2_sha256$10000$DWbaF0U2q65N$8JdzXtLlaQ2M8pzrJ63ulYHw/Gm0+bKHynGrPI9Hc+c='
    tao_taouser_5.last_login = datetime.datetime(2013, 10, 28, 1, 29, 4, tzinfo=pytz.UTC)
    tao_taouser_5.is_superuser = True
    tao_taouser_5.username = u'max'
    tao_taouser_5.first_name = u'Max'
    tao_taouser_5.last_name = u'Bernyk'
    tao_taouser_5.email = u'mbernyk@swin.edu.au'
    tao_taouser_5.is_staff = True
    tao_taouser_5.is_active = True
    tao_taouser_5.date_joined = datetime.datetime(2013, 2, 7, 4, 59, 48, tzinfo=pytz.UTC)
    tao_taouser_5.institution = u'Swinburne'
    tao_taouser_5.scientific_interests = u'Lightcones, AGN feedback'
    ...
    tao_taouser_5.account_registration_reason = None
    tao_taouser_5.account_registration_date = None
    tao_taouser_5.disk_quota = 50000L
    tao_taouser_5 = save_or_locate(tao_taouser_5)

    tao_taouser_6 = TaoUser()
    tao_taouser_6.password = u'pbkdf2_sha256$10000$dFuKlZyB8WcP$HMtgKnh5PJGGjE7GjHJ6ufDD7h7Xmh60GiPfI68erQs='
    tao_taouser_6.last_login = datetime.datetime(2013, 11, 6, 11, 6, 25, tzinfo=pytz.UTC)
    ...
    tao_taouser_6.date_joined = datetime.datetime(2013, 2, 7, 5, 0, 58, tzinfo=pytz.UTC)
    tao_taouser_6.institution = u'Swinburne University of Technology'
    tao_taouser_6.scientific_interests = u'Galaxies, cosmology, simulations, models, survey science.'
    ...
    tao_taouser_6.account_registration_reason = None
    tao_taouser_6.account_registration_date = None
    tao_taouser_6.disk_quota = 200000L
    tao_taouser_6 = save_or_locate(tao_taouser_6)

    tao_taouser_7 = TaoUser()
    tao_taouser_7.password = u'pbkdf2_sha256$10000$k424nXYSFrtf$DBHD8yVcK8uETsxqSmnidOrSY42RSj3AVi/ZvpefDzc='
    tao_taouser_7.last_login = datetime.datetime(2013, 9, 11, 3, 57, 27, tzinfo=pytz.UTC)
    tao_taouser_7.is_superuser = False
    tao_taouser_7.username = u'tgarel'
    tao_taouser_7.first_name = u'Thibault'
    tao_taouser_7.last_name = u'Garel'
    tao_taouser_7.email = u'tgarel@swin.edu.au'
    tao_taouser_7.is_staff = False
    tao_taouser_7.is_active = True
    tao_taouser_7.date_joined = datetime.datetime(2013, 2, 27, 0, 51, 27, tzinfo=pytz.UTC)
    tao_taouser_7.institution = u'Swinburne'
    tao_taouser_7.scientific_interests = u'Galaxy formation'
    tao_taouser_7.title = u'Dr.'
    tao_taouser_7.rejected = False
    tao_taouser_7.aaf_shared_token = u''
    tao_taouser_7.account_registration_status = u'NA'
    tao_taouser_7.account_registration_reason = None
    tao_taouser_7.account_registration_date = None
    tao_taouser_7.disk_quota = 0L
    tao_taouser_7 = save_or_locate(tao_taouser_7)

    tao_taouser_8 = TaoUser()
    tao_taouser_8.password = u'pbkdf2_sha256$10000$Hb4XHqCBgtb7$PHX5YWASviFeIiNNn5ToeSlNdWz+g8AJk0Nz1roITgE='
    tao_taouser_8.last_login = datetime.datetime(2013, 3, 7, 0, 45, 49, tzinfo=pytz.UTC)
    tao_taouser_8.is_superuser = False
    tao_taouser_8.username = u'cmaxwell'
    tao_taouser_8.first_name = u'Cameron'
    tao_taouser_8.last_name = u'Maxwell'
    tao_taouser_8.email = u'cameron@intersect.org.au'
    tao_taouser_8.is_staff = False
    tao_taouser_8.is_active = True
    tao_taouser_8.date_joined = datetime.datetime(2013, 3, 1, 0, 45, 45, tzinfo=pytz.UTC)
    tao_taouser_8.institution = u'Intersect'
    tao_taouser_8.scientific_interests = u''
    tao_taouser_8.title = u'Dr'
    tao_taouser_8.rejected = False
    tao_taouser_8.aaf_shared_token = u''
    tao_taouser_8.account_registration_status = u'NA'
    tao_taouser_8.account_registration_reason = None
    tao_taouser_8.account_registration_date = None
    tao_taouser_8.disk_quota = 0L
    tao_taouser_8 = save_or_locate(tao_taouser_8)

    tao_taouser_9 = TaoUser()
    tao_taouser_9.password = u'pbkdf2_sha256$10000$jNx2tOOryuQv$mxIUTAUuaMo7i1zE7bjxVY1sirBjrSeaLzzAkLgt9FM='
    tao_taouser_9.last_login = datetime.datetime(2013, 10, 6, 5, 9, 59, tzinfo=pytz.UTC)
    tao_taouser_9.is_superuser = True
    tao_taouser_9.username = u'luke'
    tao_taouser_9.first_name = u'Luke'
    tao_taouser_9.last_name = u'Hodkinson'
    tao_taouser_9.email = u'furious.luke@gmail.com'
    tao_taouser_9.is_staff = True
    tao_taouser_9.is_active = True
    tao_taouser_9.date_joined = datetime.datetime(2013, 6, 4, 4, 46, 54, tzinfo=pytz.UTC)
    tao_taouser_9.institution = u'Swinburne University of Technology'
    tao_taouser_9.scientific_interests = u'The Captcha box is a little too large in the y-axis; the background is repeating.'
    tao_taouser_9.title = u'Mr'
    tao_taouser_9.rejected = False
    tao_taouser_9.aaf_shared_token = u''
    tao_taouser_9.account_registration_status = u'NA'
    tao_taouser_9.account_registration_reason = None
    tao_taouser_9.account_registration_date = None
    tao_taouser_9.disk_quota = 0L
    tao_taouser_9 = save_or_locate(tao_taouser_9)

    tao_taouser_10 = TaoUser()
    tao_taouser_10.password = u'pbkdf2_sha256$10000$wkcWixbsLjLX$opfpsweShklhMg1Lhenr4SR10Yu0P6QVR9B1ae70T4w='
    tao_taouser_10.last_login = datetime.datetime(2013, 6, 8, 4, 34, 17, tzinfo=pytz.UTC)
    tao_taouser_10.is_superuser = True
    tao_taouser_10.username = u'akgtest'
    tao_taouser_10.first_name = u'Alistair'
    tao_taouser_10.last_name = u'Grant'
    tao_taouser_10.email = u'akgrant0710@gmail.com'
    tao_taouser_10.is_staff = True
    tao_taouser_10.is_active = True
    tao_taouser_10.date_joined = datetime.datetime(2013, 6, 8, 4, 33, 29, tzinfo=pytz.UTC)
    tao_taouser_10.institution = u'Intersect'
    tao_taouser_10.scientific_interests = u'TAO'
    tao_taouser_10.title = u'Mr'
    tao_taouser_10.rejected = False
    tao_taouser_10.aaf_shared_token = u''
    tao_taouser_10.account_registration_status = u'NA'
    tao_taouser_10.account_registration_reason = None
    tao_taouser_10.account_registration_date = None
    tao_taouser_10.disk_quota = 0L
    tao_taouser_10 = save_or_locate(tao_taouser_10)

    tao_taouser_11 = TaoUser()
    tao_taouser_11.password = u'pbkdf2_sha256$10000$0fOZn8mviN1p$9RFh+CDsF1IGHkDI+FoP93TGCddlgC0h26kfxGuJyxk='
    tao_taouser_11.last_login = datetime.datetime(2013, 10, 10, 23, 45, 2, tzinfo=pytz.UTC)
    tao_taouser_11.is_superuser = False
    tao_taouser_11.username = u'alanrduffy'
    tao_taouser_11.first_name = u'Alan'
    tao_taouser_11.last_name = u'Duffy'
    tao_taouser_11.email = u'alan.duffy@unimelb.edu.au'
    tao_taouser_11.is_staff = False
    tao_taouser_11.is_active = True
    tao_taouser_11.date_joined = datetime.datetime(2013, 6, 19, 4, 28, 15, tzinfo=pytz.UTC)
    tao_taouser_11.institution = u'University of Melbourne'
    tao_taouser_11.scientific_interests = u'Dark Matter, Dark Energy, Galaxy Formation, Cosmology'
    tao_taouser_11.title = u'Dr'
    tao_taouser_11.rejected = False
    tao_taouser_11.aaf_shared_token = u''
    tao_taouser_11.account_registration_status = u'NA'
    tao_taouser_11.account_registration_reason = None
    tao_taouser_11.account_registration_date = None
    tao_taouser_11.disk_quota = 0L
    tao_taouser_11 = save_or_locate(tao_taouser_11)

    tao_taouser_12 = TaoUser()
    tao_taouser_12.password = u'pbkdf2_sha256$10000$WJOPwr2xbuu3$86OT/DxpJZToB2k5VKDSC9Gulp6QNbe4sV9dAhxv7+c='
    tao_taouser_12.last_login = datetime.datetime(2013, 11, 6, 3, 56, 32, tzinfo=pytz.UTC)
    tao_taouser_12.is_superuser = False
    tao_taouser_12.username = u'hdenes'
    tao_taouser_12.first_name = u'Helga'
    tao_taouser_12.last_name = u'Denes'
    tao_taouser_12.email = u'hdenes@astro.swin.edu.au'
    tao_taouser_12.is_staff = False
    tao_taouser_12.is_active = True
    tao_taouser_12.date_joined = datetime.datetime(2013, 6, 19, 6, 55, 18, tzinfo=pytz.UTC)
    tao_taouser_12.institution = u'Swinburne University of Technology'
    tao_taouser_12.scientific_interests = u'HI content of galaxies, galaxy evolution, environmental effects on galaxies'
    tao_taouser_12.title = u'Ms.'
    tao_taouser_12.rejected = False
    tao_taouser_12.aaf_shared_token = u''
    tao_taouser_12.account_registration_status = u'NA'
    tao_taouser_12.account_registration_reason = None
    tao_taouser_12.account_registration_date = None
    tao_taouser_12.disk_quota = 0L
    tao_taouser_12 = save_or_locate(tao_taouser_12)

    tao_taouser_13 = TaoUser()
    tao_taouser_13.password = u'pbkdf2_sha256$10000$a2rbNNkbnwI0$lqPxUF493xKnCMyMS5q3gW9xNqk+4p2Py4C8C9cptDM='
    tao_taouser_13.last_login = datetime.datetime(2013, 6, 20, 19, 27, 13, tzinfo=pytz.UTC)
    tao_taouser_13.is_superuser = False
    tao_taouser_13.username = u'greensander'
    tao_taouser_13.first_name = u'Sam'
    tao_taouser_13.last_name = u'Kim'
    tao_taouser_13.email = u'greensander@gmail.com'
    tao_taouser_13.is_staff = False
    tao_taouser_13.is_active = True
    tao_taouser_13.date_joined = datetime.datetime(2013, 6, 20, 14, 47, 2, tzinfo=pytz.UTC)
    tao_taouser_13.institution = u'Pontificia Universidad Catolica de Chile'
    tao_taouser_13.scientific_interests = u'Compact overdensity around starbursting  galaxy/ Galaxy morphology '
    tao_taouser_13.title = u'Dr.'
    tao_taouser_13.rejected = False
    tao_taouser_13.aaf_shared_token = u''
    tao_taouser_13.account_registration_status = u'NA'
    tao_taouser_13.account_registration_reason = None
    tao_taouser_13.account_registration_date = None
    tao_taouser_13.disk_quota = 0L
    tao_taouser_13 = save_or_locate(tao_taouser_13)

    tao_taouser_14 = TaoUser()
    tao_taouser_14.password = u'pbkdf2_sha256$10000$dZk6dqitE6QN$b+zLcl9ULUA4+vwG7FCSmdqibQm6wDNSDn42m83F2xE='
    tao_taouser_14.last_login = datetime.datetime(2013, 10, 23, 6, 54, 20, tzinfo=pytz.UTC)
    tao_taouser_14.is_superuser = False
    tao_taouser_14.username = u'asgr'
    tao_taouser_14.first_name = u'Aaron'
    tao_taouser_14.last_name = u'Robotham'
    tao_taouser_14.email = u'aaron.robotham@uwa.edu.au'
    tao_taouser_14.is_staff = False
    tao_taouser_14.is_active = True
    tao_taouser_14.date_joined = datetime.datetime(2013, 7, 1, 2, 34, 23, tzinfo=pytz.UTC)
    tao_taouser_14.institution = u'ICRAR / UWA'
    tao_taouser_14.scientific_interests = u'Extra Galactic Astronomy'
    tao_taouser_14.title = u'Dr'
    tao_taouser_14.rejected = False
    tao_taouser_14.aaf_shared_token = u''
    tao_taouser_14.account_registration_status = u'NA'
    tao_taouser_14.account_registration_reason = None
    tao_taouser_14.account_registration_date = None
    tao_taouser_14.disk_quota = 66000L
    tao_taouser_14 = save_or_locate(tao_taouser_14)

    tao_taouser_15 = TaoUser()
    tao_taouser_15.password = u'pbkdf2_sha256$10000$JDZ6ddikJptH$foKHyGBhB52TfG5tnR+PX6DQ4UAZK1AawuptU+K2rm8='
    tao_taouser_15.last_login = datetime.datetime(2013, 7, 1, 9, 51, 58, tzinfo=pytz.UTC)
    tao_taouser_15.is_superuser = False
    tao_taouser_15.username = u'ent'
    tao_taouser_15.first_name = u'Edward'
    tao_taouser_15.last_name = u'Taylor'
    tao_taouser_15.email = u'ent@ph.unimelb.edu.au'
    tao_taouser_15.is_staff = False
    tao_taouser_15.is_active = True
    tao_taouser_15.date_joined = datetime.datetime(2013, 7, 1, 4, 6, 58, tzinfo=pytz.UTC)
    tao_taouser_15.institution = u'Univ of Melbourne'
    tao_taouser_15.scientific_interests = u'galaxy formation and evolution'
    tao_taouser_15.title = u'Dr'
    tao_taouser_15.rejected = False
    tao_taouser_15.aaf_shared_token = u''
    tao_taouser_15.account_registration_status = u'NA'
    tao_taouser_15.account_registration_reason = None
    tao_taouser_15.account_registration_date = None
    tao_taouser_15.disk_quota = 0L
    tao_taouser_15 = save_or_locate(tao_taouser_15)

    tao_taouser_16 = TaoUser()
    tao_taouser_16.password = u'pbkdf2_sha256$10000$iltqyCL4raNn$524Ns8hIlVIxFU3lYIAxlB36QdzqRw0vIjV8bvqro4c='
    tao_taouser_16.last_login = datetime.datetime(2013, 8, 11, 15, 6, 40, tzinfo=pytz.UTC)
    tao_taouser_16.is_superuser = False
    tao_taouser_16.username = u'luyu'
    tao_taouser_16.first_name = u'Yu'
    tao_taouser_16.last_name = u'Lu'
    tao_taouser_16.email = u'luyu@stanford.edu'
    tao_taouser_16.is_staff = False
    tao_taouser_16.is_active = True
    tao_taouser_16.date_joined = datetime.datetime(2013, 7, 2, 17, 48, 4, tzinfo=pytz.UTC)
    tao_taouser_16.institution = u'Stanford'
    tao_taouser_16.scientific_interests = u''
    tao_taouser_16.title = u'Dr.'
    tao_taouser_16.rejected = False
    tao_taouser_16.aaf_shared_token = u''
    tao_taouser_16.account_registration_status = u'NA'
    tao_taouser_16.account_registration_reason = None
    tao_taouser_16.account_registration_date = None
    tao_taouser_16.disk_quota = 0L
    tao_taouser_16 = save_or_locate(tao_taouser_16)

    tao_taouser_17 = TaoUser()
    tao_taouser_17.password = u'pbkdf2_sha256$10000$X1RZfrFy4C3T$4jr+qjyMpYUa960Uwa59RS99oL7ImEDZ67CNK+YHSFg='
    tao_taouser_17.last_login = datetime.datetime(2013, 7, 26, 14, 13, 29, tzinfo=pytz.UTC)
    tao_taouser_17.is_superuser = False
    tao_taouser_17.username = u'itrharrison'
    tao_taouser_17.first_name = u'Ian'
    tao_taouser_17.last_name = u'Harrison'
    tao_taouser_17.email = u'ian.harrison@astro.cf.ac.uk'
    tao_taouser_17.is_staff = False
    tao_taouser_17.is_active = True
    tao_taouser_17.date_joined = datetime.datetime(2013, 7, 26, 14, 13, 29, tzinfo=pytz.UTC)
    tao_taouser_17.institution = u'Cardiff University'
    tao_taouser_17.scientific_interests = u'Cosmology'
    tao_taouser_17.title = u'Mr'
    tao_taouser_17.rejected = False
    tao_taouser_17.aaf_shared_token = u''
    tao_taouser_17.account_registration_status = u'NA'
    tao_taouser_17.account_registration_reason = None
    tao_taouser_17.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 47, tzinfo=pytz.UTC)
    tao_taouser_17.disk_quota = 0L
    tao_taouser_17 = save_or_locate(tao_taouser_17)

    tao_taouser_18 = TaoUser()
    tao_taouser_18.password = u'pbkdf2_sha256$10000$2ylBjZd1LFUq$wGEHwCb1q/6XYG4ksItCItKRla9vQiujKzn87bO4/l4='
    tao_taouser_18.last_login = datetime.datetime(2013, 7, 28, 11, 55, 52, tzinfo=pytz.UTC)
    tao_taouser_18.is_superuser = False
    tao_taouser_18.username = u'danielaff'
    tao_taouser_18.first_name = u'daniel'
    tao_taouser_18.last_name = u'aff'
    tao_taouser_18.email = u'daniel@affactive.com'
    tao_taouser_18.is_staff = False
    tao_taouser_18.is_active = False
    tao_taouser_18.date_joined = datetime.datetime(2013, 7, 28, 11, 55, 52, tzinfo=pytz.UTC)
    tao_taouser_18.institution = u'st petersburg scientific institute '
    tao_taouser_18.scientific_interests = u'philosophy\r\nphysics\r\n'
    tao_taouser_18.title = u'mr'
    tao_taouser_18.rejected = True
    tao_taouser_18.aaf_shared_token = u''
    tao_taouser_18.account_registration_status = u'NA'
    tao_taouser_18.account_registration_reason = None
    tao_taouser_18.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 41, tzinfo=pytz.UTC)
    tao_taouser_18.disk_quota = 0L
    tao_taouser_18 = save_or_locate(tao_taouser_18)

    tao_taouser_19 = TaoUser()
    tao_taouser_19.password = u'pbkdf2_sha256$10000$rfFTQsO9sTS7$QXLaM4XDDkgUxo/IAYAT0DG0h6XYo7CRHzsyrvaytJc='
    tao_taouser_19.last_login = datetime.datetime(2013, 8, 7, 23, 5, 4, tzinfo=pytz.UTC)
    tao_taouser_19.is_superuser = False
    tao_taouser_19.username = u'fmarinp'
    tao_taouser_19.first_name = u'Felipe'
    tao_taouser_19.last_name = u'Marin'
    tao_taouser_19.email = u'fmarin@astro.swin.edu.au'
    tao_taouser_19.is_staff = False
    tao_taouser_19.is_active = True
    tao_taouser_19.date_joined = datetime.datetime(2013, 8, 7, 23, 5, 4, tzinfo=pytz.UTC)
    tao_taouser_19.institution = u'Swinburne'
    tao_taouser_19.scientific_interests = u'Cosmology, galaxy formation'
    tao_taouser_19.title = u'Dr'
    tao_taouser_19.rejected = False
    tao_taouser_19.aaf_shared_token = u''
    tao_taouser_19.account_registration_status = u'NA'
    tao_taouser_19.account_registration_reason = None
    tao_taouser_19.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 34, tzinfo=pytz.UTC)
    tao_taouser_19.disk_quota = 0L
    tao_taouser_19 = save_or_locate(tao_taouser_19)

    tao_taouser_20 = TaoUser()
    tao_taouser_20.password = u'pbkdf2_sha256$10000$DWkrbFI9kSZL$eNdxpCuCYNfb2yaGPWk6exBKDFOd1JxEHkCYqGd9LzE='
    tao_taouser_20.last_login = datetime.datetime(2013, 8, 16, 18, 40, 44, tzinfo=pytz.UTC)
    tao_taouser_20.is_superuser = False
    tao_taouser_20.username = u'yomori'
    tao_taouser_20.first_name = u'Yuuki'
    tao_taouser_20.last_name = u'Omori'
    tao_taouser_20.email = u'yomori@physics.mcgill.ca'
    tao_taouser_20.is_staff = False
    tao_taouser_20.is_active = True
    tao_taouser_20.date_joined = datetime.datetime(2013, 8, 16, 18, 40, 44, tzinfo=pytz.UTC)
    tao_taouser_20.institution = u'McGill University'
    tao_taouser_20.scientific_interests = u'Large-scale structure\r\nGalaxy formation/evolution'
    tao_taouser_20.title = u'Mr.'
    tao_taouser_20.rejected = False
    tao_taouser_20.aaf_shared_token = u''
    tao_taouser_20.account_registration_status = u'NA'
    tao_taouser_20.account_registration_reason = None
    tao_taouser_20.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 32, tzinfo=pytz.UTC)
    tao_taouser_20.disk_quota = 0L
    tao_taouser_20 = save_or_locate(tao_taouser_20)

    tao_taouser_21 = TaoUser()
    tao_taouser_21.password = u''
    tao_taouser_21.last_login = datetime.datetime(2013, 10, 6, 23, 57, 30, tzinfo=pytz.UTC)
    tao_taouser_21.is_superuser = False
    tao_taouser_21.username = u'zyZA-oewS8KX35-TfkvhFAdMuB0'
    tao_taouser_21.first_name = u'Alistair'
    tao_taouser_21.last_name = u'Grant'
    tao_taouser_21.email = u'alistair@intersect.org.au'
    tao_taouser_21.is_staff = False
    tao_taouser_21.is_active = True
    tao_taouser_21.date_joined = datetime.datetime(2013, 8, 19, 4, 30, 48, tzinfo=pytz.UTC)
    tao_taouser_21.institution = u'Intersect'
    tao_taouser_21.scientific_interests = None
    tao_taouser_21.title = u'Mr'
    tao_taouser_21.rejected = False
    tao_taouser_21.aaf_shared_token = u'zyZA-oewS8KX35-TfkvhFAdMuB0'
    tao_taouser_21.account_registration_status = u'APR'
    tao_taouser_21.account_registration_reason = u''
    tao_taouser_21.account_registration_date = datetime.datetime(2013, 8, 19, 4, 32, 57, tzinfo=pytz.UTC)
    tao_taouser_21.disk_quota = 0L
    tao_taouser_21 = save_or_locate(tao_taouser_21)

    tao_taouser_22 = TaoUser()
    tao_taouser_22.password = u''
    tao_taouser_22.last_login = datetime.datetime(2013, 8, 21, 5, 26, 41, tzinfo=pytz.UTC)
    tao_taouser_22.is_superuser = False
    tao_taouser_22.username = u'B-5MPnQoShsQGh3d29kV42s65_E'
    tao_taouser_22.first_name = u'Yeshe'
    tao_taouser_22.last_name = u'Fenner'
    tao_taouser_22.email = u'YESHEFENNER@exchange.swin.edu.au'
    tao_taouser_22.is_staff = False
    tao_taouser_22.is_active = True
    tao_taouser_22.date_joined = datetime.datetime(2013, 8, 21, 5, 4, 39, tzinfo=pytz.UTC)
    tao_taouser_22.institution = u'AAL'
    tao_taouser_22.scientific_interests = None
    tao_taouser_22.title = u'Dr'
    tao_taouser_22.rejected = False
    tao_taouser_22.aaf_shared_token = u'B-5MPnQoShsQGh3d29kV42s65_E'
    tao_taouser_22.account_registration_status = u'APR'
    tao_taouser_22.account_registration_reason = u''
    tao_taouser_22.account_registration_date = datetime.datetime(2013, 8, 21, 5, 5, 44, tzinfo=pytz.UTC)
    tao_taouser_22.disk_quota = 0L
    tao_taouser_22 = save_or_locate(tao_taouser_22)

    tao_taouser_23 = TaoUser()
    tao_taouser_23.password = u'pbkdf2_sha256$10000$mGIK2FtuB7er$6wrjJCZ11PzGlb+/p0AMyIVJbIrs7ezXXrk+E2J+Jk4='
    tao_taouser_23.last_login = datetime.datetime(2013, 8, 22, 10, 59, 6, tzinfo=pytz.UTC)
    tao_taouser_23.is_superuser = False
    tao_taouser_23.username = u'charlot'
    tao_taouser_23.first_name = u'Stephane'
    tao_taouser_23.last_name = u'Charlot'
    tao_taouser_23.email = u'charlot@iap.fr'
    tao_taouser_23.is_staff = False
    tao_taouser_23.is_active = True
    tao_taouser_23.date_joined = datetime.datetime(2013, 8, 21, 13, 20, 40, tzinfo=pytz.UTC)
    tao_taouser_23.institution = u'IAP (CNRS/UPMC)'
    tao_taouser_23.scientific_interests = u'Galaxy spectral modeling'
    tao_taouser_23.title = u'Dr'
    tao_taouser_23.rejected = False
    tao_taouser_23.aaf_shared_token = u''
    tao_taouser_23.account_registration_status = u'NA'
    tao_taouser_23.account_registration_reason = u''
    tao_taouser_23.account_registration_date = datetime.datetime(2013, 8, 21, 13, 21, 5, tzinfo=pytz.UTC)
    tao_taouser_23.disk_quota = 0L
    tao_taouser_23 = save_or_locate(tao_taouser_23)

    tao_taouser_24 = TaoUser()
    tao_taouser_24.password = u'pbkdf2_sha256$10000$QWuJthTrpB9Y$pBbcnMjJ9rW7jktgO/wVLtLi/h+rQ3hc9yL+9QuNRHo='
    tao_taouser_24.last_login = datetime.datetime(2013, 8, 23, 4, 32, 26, tzinfo=pytz.UTC)
    tao_taouser_24.is_superuser = False
    tao_taouser_24.username = u'hcferguson'
    tao_taouser_24.first_name = u'Henry'
    tao_taouser_24.last_name = u'Ferguson'
    tao_taouser_24.email = u'ferguson@stsci.edu'
    tao_taouser_24.is_staff = False
    tao_taouser_24.is_active = True
    tao_taouser_24.date_joined = datetime.datetime(2013, 8, 23, 4, 24, 11, tzinfo=pytz.UTC)
    tao_taouser_24.institution = u'Space Telescope Science Institute'
    tao_taouser_24.scientific_interests = u'Galaxy Evolution, Cosmology\r\nCANDELS collaboration\r\nLSST galaxies collaboration'
    tao_taouser_24.title = u'Dr.'
    tao_taouser_24.rejected = False
    tao_taouser_24.aaf_shared_token = u''
    tao_taouser_24.account_registration_status = u'NA'
    tao_taouser_24.account_registration_reason = u''
    tao_taouser_24.account_registration_date = datetime.datetime(2013, 8, 23, 4, 27, 30, tzinfo=pytz.UTC)
    tao_taouser_24.disk_quota = 0L
    tao_taouser_24 = save_or_locate(tao_taouser_24)

    tao_taouser_25 = TaoUser()
    tao_taouser_25.password = u'pbkdf2_sha256$10000$PkNi4ucERfiI$1o92CIYUWoLfCNQ4bX6cQggjRwLRulSHlAogIS8BCU0='
    tao_taouser_25.last_login = datetime.datetime(2013, 9, 12, 1, 55, 45, tzinfo=pytz.UTC)
    tao_taouser_25.is_superuser = False
    tao_taouser_25.username = u'chiaratonini'
    tao_taouser_25.first_name = u'Chiara'
    tao_taouser_25.last_name = u'Tonini'
    tao_taouser_25.email = u'chiaratonini19@gmail.com'
    tao_taouser_25.is_staff = False
    tao_taouser_25.is_active = True
    tao_taouser_25.date_joined = datetime.datetime(2013, 8, 26, 5, 5, 23, tzinfo=pytz.UTC)
    tao_taouser_25.institution = u'Swinburne'
    tao_taouser_25.scientific_interests = u'TAO :)'
    tao_taouser_25.title = u'Dr'
    tao_taouser_25.rejected = False
    tao_taouser_25.aaf_shared_token = u''
    tao_taouser_25.account_registration_status = u'NA'
    tao_taouser_25.account_registration_reason = u''
    tao_taouser_25.account_registration_date = datetime.datetime(2013, 8, 26, 5, 9, 3, tzinfo=pytz.UTC)
    tao_taouser_25.disk_quota = 0L
    tao_taouser_25 = save_or_locate(tao_taouser_25)

    tao_taouser_26 = TaoUser()
    tao_taouser_26.password = u'pbkdf2_sha256$10000$nqdxxeXgzLth$hdorzXTrykXW2+YznRB6HqeGesL9n+3N2sfOtPMW0uo='
    tao_taouser_26.last_login = datetime.datetime(2013, 8, 26, 7, 57, 37, tzinfo=pytz.UTC)
    tao_taouser_26.is_superuser = False
    tao_taouser_26.username = u'Simon_White'
    tao_taouser_26.first_name = u'Simon'
    tao_taouser_26.last_name = u'White'
    tao_taouser_26.email = u'swhite@mpa-garching.mpg.de'
    tao_taouser_26.is_staff = False
    tao_taouser_26.is_active = True
    tao_taouser_26.date_joined = datetime.datetime(2013, 8, 26, 7, 57, 37, tzinfo=pytz.UTC)
    tao_taouser_26.institution = u'MPA'
    tao_taouser_26.scientific_interests = u'Astrophysiics'
    tao_taouser_26.title = u'Prof'
    tao_taouser_26.rejected = False
    tao_taouser_26.aaf_shared_token = u''
    tao_taouser_26.account_registration_status = u'NA'
    tao_taouser_26.account_registration_reason = u''
    tao_taouser_26.account_registration_date = datetime.datetime(2013, 8, 26, 7, 58, 44, tzinfo=pytz.UTC)
    tao_taouser_26.disk_quota = 0L
    tao_taouser_26 = save_or_locate(tao_taouser_26)

    tao_taouser_27 = TaoUser()
    tao_taouser_27.password = u'pbkdf2_sha256$10000$WT5R912agu5d$VbU3+O7ei3ND66FoZr0LZoH13G8gLMfd07dXPBvUOmE='
    tao_taouser_27.last_login = datetime.datetime(2013, 8, 27, 7, 40, 12, tzinfo=pytz.UTC)
    tao_taouser_27.is_superuser = False
    tao_taouser_27.username = u'GerardLemson'
    tao_taouser_27.first_name = u'Gerard'
    tao_taouser_27.last_name = u'Lemson'
    tao_taouser_27.email = u'lemson@mpa-garching.mpg.de'
    tao_taouser_27.is_staff = False
    tao_taouser_27.is_active = True
    tao_taouser_27.date_joined = datetime.datetime(2013, 8, 26, 8, 11, 25, tzinfo=pytz.UTC)
    tao_taouser_27.institution = u'MPA'
    tao_taouser_27.scientific_interests = u'TVO'
    tao_taouser_27.title = u'Mr'
    tao_taouser_27.rejected = False
    tao_taouser_27.aaf_shared_token = u''
    tao_taouser_27.account_registration_status = u'NA'
    tao_taouser_27.account_registration_reason = u''
    tao_taouser_27.account_registration_date = datetime.datetime(2013, 8, 26, 8, 12, 11, tzinfo=pytz.UTC)
    tao_taouser_27.disk_quota = 0L
    tao_taouser_27 = save_or_locate(tao_taouser_27)

    tao_taouser_28 = TaoUser()
    tao_taouser_28.password = u'pbkdf2_sha256$10000$E7Q87WoFwiVK$0WPHLxLyxcd0CNyhQF/bkFwG2yM12rbtUzaB0ipvw7o='
    tao_taouser_28.last_login = datetime.datetime(2013, 8, 26, 11, 53, 21, tzinfo=pytz.UTC)
    tao_taouser_28.is_superuser = False
    tao_taouser_28.username = u'swyithe'
    tao_taouser_28.first_name = u'Stuart'
    tao_taouser_28.last_name = u'Wyithe'
    tao_taouser_28.email = u'swyithe@unimelb.edu.au'
    tao_taouser_28.is_staff = False
    tao_taouser_28.is_active = True
    tao_taouser_28.date_joined = datetime.datetime(2013, 8, 26, 11, 53, 21, tzinfo=pytz.UTC)
    tao_taouser_28.institution = u'The University of Melbourne'
    tao_taouser_28.scientific_interests = u'Cosmology'
    tao_taouser_28.title = u'Prof'
    tao_taouser_28.rejected = False
    tao_taouser_28.aaf_shared_token = u''
    tao_taouser_28.account_registration_status = u'NA'
    tao_taouser_28.account_registration_reason = u''
    tao_taouser_28.account_registration_date = datetime.datetime(2013, 8, 26, 11, 54, 10, tzinfo=pytz.UTC)
    tao_taouser_28.disk_quota = 0L
    tao_taouser_28 = save_or_locate(tao_taouser_28)

    tao_taouser_29 = TaoUser()
    tao_taouser_29.password = u'pbkdf2_sha256$10000$9lM060z3j0Ff$kdDPTuqeD8xIf48Nwm6IrCjLMhIv4CM4X7JTBuTiInM='
    tao_taouser_29.last_login = datetime.datetime(2013, 10, 22, 0, 14, 28, tzinfo=pytz.UTC)
    tao_taouser_29.is_superuser = False
    tao_taouser_29.username = u'hanyk'
    tao_taouser_29.first_name = u'Yunkun'
    tao_taouser_29.last_name = u'Han'
    tao_taouser_29.email = u'hanyk@ynao.ac.cn'
    tao_taouser_29.is_staff = False
    tao_taouser_29.is_active = True
    tao_taouser_29.date_joined = datetime.datetime(2013, 9, 9, 0, 46, 27, tzinfo=pytz.UTC)
    tao_taouser_29.institution = u'Yunnan Astronomical Observatory'
    tao_taouser_29.scientific_interests = u'Formation and evolution of galaxies'
    tao_taouser_29.title = u'Dr.'
    tao_taouser_29.rejected = False
    tao_taouser_29.aaf_shared_token = u''
    tao_taouser_29.account_registration_status = u'NA'
    tao_taouser_29.account_registration_reason = u''
    tao_taouser_29.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 28, tzinfo=pytz.UTC)
    tao_taouser_29.disk_quota = 0L
    tao_taouser_29 = save_or_locate(tao_taouser_29)

    tao_taouser_30 = TaoUser()
    tao_taouser_30.password = u'pbkdf2_sha256$10000$xwdYsYymkLYX$YWE02Rc8hrj/DXolYjjcXDf7xbTQ2PtXBxCsc1dDtEE='
    tao_taouser_30.last_login = datetime.datetime(2013, 10, 14, 0, 58, 48, tzinfo=pytz.UTC)
    tao_taouser_30.is_superuser = True
    tao_taouser_30.username = u'ilya'
    tao_taouser_30.first_name = u'Ilya'
    tao_taouser_30.last_name = u'Anisimoff'
    tao_taouser_30.email = u'ilya@intersect.org.au'
    tao_taouser_30.is_staff = True
    tao_taouser_30.is_active = True
    tao_taouser_30.date_joined = datetime.datetime(2013, 9, 16, 0, 21, 47, tzinfo=pytz.UTC)
    tao_taouser_30.institution = u'Intersect'
    tao_taouser_30.scientific_interests = u''
    tao_taouser_30.title = u'Mr'
    tao_taouser_30.rejected = False
    tao_taouser_30.aaf_shared_token = u''
    tao_taouser_30.account_registration_status = u'NA'
    tao_taouser_30.account_registration_reason = u''
    tao_taouser_30.account_registration_date = datetime.datetime(2013, 9, 16, 0, 22, 37, tzinfo=pytz.UTC)
    tao_taouser_30.disk_quota = 0L
    tao_taouser_30 = save_or_locate(tao_taouser_30)

    tao_taouser_31 = TaoUser()
    tao_taouser_31.password = u'pbkdf2_sha256$10000$ORw137z3pt5s$Nt3kTvsBx7r4v7KkPJQQ1hWJAAwL1Ikd6XeXD0eKb+U='
    tao_taouser_31.last_login = datetime.datetime(2013, 11, 4, 13, 18, 40, tzinfo=pytz.UTC)
    tao_taouser_31.is_superuser = False
    tao_taouser_31.username = u'chrislintott'
    tao_taouser_31.first_name = u'Chris'
    tao_taouser_31.last_name = u'Lintott'
    tao_taouser_31.email = u'cjl@astro.ox.ac.uk'
    tao_taouser_31.is_staff = False
    tao_taouser_31.is_active = True
    tao_taouser_31.date_joined = datetime.datetime(2013, 9, 26, 4, 8, 56, tzinfo=pytz.UTC)
    tao_taouser_31.institution = u'University of Oxford'
    tao_taouser_31.scientific_interests = u'Interested to provide context for Galaxy Zoo studies. '
    tao_taouser_31.title = u'Dr'
    tao_taouser_31.rejected = False
    tao_taouser_31.aaf_shared_token = u''
    tao_taouser_31.account_registration_status = u'NA'
    tao_taouser_31.account_registration_reason = u''
    tao_taouser_31.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 22, tzinfo=pytz.UTC)
    tao_taouser_31.disk_quota = 0L
    tao_taouser_31 = save_or_locate(tao_taouser_31)

    tao_taouser_32 = TaoUser()
    tao_taouser_32.password = u'pbkdf2_sha256$10000$3PDLnwbIo7zW$C+FOheB2ftDc0/+R4vN67zpwn7w2b+szlIDkA33+faM='
    tao_taouser_32.last_login = datetime.datetime(2013, 10, 28, 5, 37, 39, tzinfo=pytz.UTC)
    tao_taouser_32.is_superuser = False
    tao_taouser_32.username = u'gshattow'
    tao_taouser_32.first_name = u'Genevieve'
    tao_taouser_32.last_name = u'Shattow'
    tao_taouser_32.email = u'gshattow@astro.swin.edu.au'
    tao_taouser_32.is_staff = False
    tao_taouser_32.is_active = True
    tao_taouser_32.date_joined = datetime.datetime(2013, 9, 27, 5, 53, 57, tzinfo=pytz.UTC)
    tao_taouser_32.institution = u'Swinburne University'
    tao_taouser_32.scientific_interests = u'Galaxies'
    tao_taouser_32.title = u'Ms. '
    tao_taouser_32.rejected = False
    tao_taouser_32.aaf_shared_token = u''
    tao_taouser_32.account_registration_status = u'NA'
    tao_taouser_32.account_registration_reason = u''
    tao_taouser_32.account_registration_date = datetime.datetime(2013, 9, 27, 5, 54, 12, tzinfo=pytz.UTC)
    tao_taouser_32.disk_quota = 50000L
    tao_taouser_32 = save_or_locate(tao_taouser_32)

    tao_taouser_33 = TaoUser()
    tao_taouser_33.password = u'pbkdf2_sha256$10000$HD4VNjow3WB6$qxdJsIehIJPdbRtmW1FEJxk2aKd4IXNqMA4mi/w07HU='
    tao_taouser_33.last_login = datetime.datetime(2013, 10, 3, 2, 21, 44, tzinfo=pytz.UTC)
    tao_taouser_33.is_superuser = False
    tao_taouser_33.username = u'yfenner'
    tao_taouser_33.first_name = u'Yeshe'
    tao_taouser_33.last_name = u'Fenner'
    tao_taouser_33.email = u'yeshe.fenner@astronomyaustralia.org.au'
    tao_taouser_33.is_staff = False
    tao_taouser_33.is_active = True
    tao_taouser_33.date_joined = datetime.datetime(2013, 10, 3, 1, 27, 50, tzinfo=pytz.UTC)
    tao_taouser_33.institution = u'AAL'
    tao_taouser_33.scientific_interests = u''
    tao_taouser_33.title = u'Dr'
    tao_taouser_33.rejected = False
    tao_taouser_33.aaf_shared_token = u''
    tao_taouser_33.account_registration_status = u'NA'
    tao_taouser_33.account_registration_reason = u''
    tao_taouser_33.account_registration_date = datetime.datetime(2013, 10, 3, 1, 30, 37, tzinfo=pytz.UTC)
    tao_taouser_33.disk_quota = 0L
    tao_taouser_33 = save_or_locate(tao_taouser_33)

    tao_taouser_34 = TaoUser()
    tao_taouser_34.password = u''
    tao_taouser_34.last_login = datetime.datetime(2013, 10, 7, 22, 43, 9, tzinfo=pytz.UTC)
    tao_taouser_34.is_superuser = False
    tao_taouser_34.username = u'F9uFmZOVAuDZy8QXUyShCCZf4RM'
    tao_taouser_34.first_name = u'Wei'
    tao_taouser_34.last_name = u'Hong'
    tao_taouser_34.email = u'whong@exchange.swin.edu.au'
    tao_taouser_34.is_staff = False
    tao_taouser_34.is_active = True
    tao_taouser_34.date_joined = datetime.datetime(2013, 10, 7, 0, 34, 43, tzinfo=pytz.UTC)
    tao_taouser_34.institution = None
    tao_taouser_34.scientific_interests = None
    tao_taouser_34.title = None
    tao_taouser_34.rejected = False
    tao_taouser_34.aaf_shared_token = u'F9uFmZOVAuDZy8QXUyShCCZf4RM'
    tao_taouser_34.account_registration_status = u'APR'
    tao_taouser_34.account_registration_reason = u''
    tao_taouser_34.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 20, tzinfo=pytz.UTC)
    tao_taouser_34.disk_quota = 0L
    tao_taouser_34 = save_or_locate(tao_taouser_34)

    tao_taouser_35 = TaoUser()
    tao_taouser_35.password = u''
    tao_taouser_35.last_login = datetime.datetime(2013, 10, 7, 22, 36, 53, tzinfo=pytz.UTC)
    tao_taouser_35.is_superuser = False
    tao_taouser_35.username = u'INVALID_AAF'
    tao_taouser_35.first_name = u'Unknown'
    tao_taouser_35.last_name = u'Unknown'
    tao_taouser_35.email = u''
    tao_taouser_35.is_staff = False
    tao_taouser_35.is_active = False
    tao_taouser_35.date_joined = datetime.datetime(2013, 10, 7, 22, 36, 53, tzinfo=pytz.UTC)
    tao_taouser_35.institution = None
    tao_taouser_35.scientific_interests = None
    tao_taouser_35.title = None
    tao_taouser_35.rejected = True
    tao_taouser_35.aaf_shared_token = u'INVALID_AAF'
    tao_taouser_35.account_registration_status = u'NA'
    tao_taouser_35.account_registration_reason = u''
    tao_taouser_35.account_registration_date = datetime.datetime(2013, 10, 7, 22, 36, 53, tzinfo=pytz.UTC)
    tao_taouser_35.disk_quota = 0L
    tao_taouser_35 = save_or_locate(tao_taouser_35)

    tao_taouser_36 = TaoUser()
    tao_taouser_36.password = u''
    tao_taouser_36.last_login = datetime.datetime(2013, 10, 9, 5, 56, 50, tzinfo=pytz.UTC)
    tao_taouser_36.is_superuser = False
    tao_taouser_36.username = u'O4DjHWgJ6YMDceTV6rY2ydcnTsA'
    tao_taouser_36.first_name = u'Paul'
    tao_taouser_36.last_name = u'Stepowski'
    tao_taouser_36.email = u'p.stepowski@aaf.edu.au'
    tao_taouser_36.is_staff = False
    tao_taouser_36.is_active = True
    tao_taouser_36.date_joined = datetime.datetime(2013, 10, 9, 5, 56, 50, tzinfo=pytz.UTC)
    tao_taouser_36.institution = u'AAF'
    tao_taouser_36.scientific_interests = None
    tao_taouser_36.title = u'Mr'
    tao_taouser_36.rejected = False
    tao_taouser_36.aaf_shared_token = u'O4DjHWgJ6YMDceTV6rY2ydcnTsA'
    tao_taouser_36.account_registration_status = u'APR'
    tao_taouser_36.account_registration_reason = u''
    tao_taouser_36.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 15, tzinfo=pytz.UTC)
    tao_taouser_36.disk_quota = 0L
    tao_taouser_36 = save_or_locate(tao_taouser_36)

    tao_taouser_37 = TaoUser()
    tao_taouser_37.password = u''
    tao_taouser_37.last_login = datetime.datetime(2013, 10, 22, 0, 7, 14, tzinfo=pytz.UTC)
    tao_taouser_37.is_superuser = False
    tao_taouser_37.username = u'bAk37mnrxwUh_pXLI40Sz8AlKn0'
    tao_taouser_37.first_name = u'DANIEL'
    tao_taouser_37.last_name = u'LAMBETH'
    tao_taouser_37.email = u'9883363@student.swin.edu.au'
    tao_taouser_37.is_staff = False
    tao_taouser_37.is_active = True
    tao_taouser_37.date_joined = datetime.datetime(2013, 10, 16, 10, 6, 20, tzinfo=pytz.UTC)
    tao_taouser_37.institution = u'Swinburne'
    tao_taouser_37.scientific_interests = None
    tao_taouser_37.title = u'Mr'
    tao_taouser_37.rejected = False
    tao_taouser_37.aaf_shared_token = u'bAk37mnrxwUh_pXLI40Sz8AlKn0'
    tao_taouser_37.account_registration_status = u'APR'
    tao_taouser_37.account_registration_reason = u''
    tao_taouser_37.account_registration_date = datetime.datetime(2013, 10, 21, 7, 29, 13, tzinfo=pytz.UTC)
    tao_taouser_37.disk_quota = 0L
    tao_taouser_37 = save_or_locate(tao_taouser_37)

    tao_taouser_38 = TaoUser()
    tao_taouser_38.password = u'pbkdf2_sha256$10000$Z8VguzUMO3gN$bk+yE3dLUIcZh8uaBY1Um3HlcFE5MCzfhJu1rGXZcpQ='
    tao_taouser_38.last_login = datetime.datetime(2013, 10, 16, 23, 57, 27, tzinfo=pytz.UTC)
    tao_taouser_38.is_superuser = False
    tao_taouser_38.username = u'kaliQA'
    tao_taouser_38.first_name = u'Kali'
    tao_taouser_38.last_name = u'Waterford'
    tao_taouser_38.email = u'kali.waterford@intersect.org.au'
    tao_taouser_38.is_staff = False
    tao_taouser_38.is_active = True
    tao_taouser_38.date_joined = datetime.datetime(2013, 10, 16, 23, 45, 20, tzinfo=pytz.UTC)
    tao_taouser_38.institution = u'Intersect'
    tao_taouser_38.scientific_interests = u'QA of Science Websites'
    tao_taouser_38.title = u'Ms'
    tao_taouser_38.rejected = False
    tao_taouser_38.aaf_shared_token = u''
    tao_taouser_38.account_registration_status = u'NA'
    tao_taouser_38.account_registration_reason = u''
    tao_taouser_38.account_registration_date = datetime.datetime(2013, 10, 16, 23, 48, 17, tzinfo=pytz.UTC)
    tao_taouser_38.disk_quota = 0L
    tao_taouser_38 = save_or_locate(tao_taouser_38)

    tao_taouser_39 = TaoUser()
    tao_taouser_39.password = u'pbkdf2_sha256$10000$0lTAZwLbb3GD$9TLqpVVc+gH4k0OtRvLW2rrKqVQLX2aXnMvCiOK/aug='
    tao_taouser_39.last_login = datetime.datetime(2013, 10, 18, 1, 25, 10, tzinfo=pytz.UTC)
    tao_taouser_39.is_superuser = False
    tao_taouser_39.username = u'smutch'
    tao_taouser_39.first_name = u'Simon'
    tao_taouser_39.last_name = u'Mutch'
    tao_taouser_39.email = u'smutch@unimelb.edu.au'
    tao_taouser_39.is_staff = False
    tao_taouser_39.is_active = True
    tao_taouser_39.date_joined = datetime.datetime(2013, 10, 18, 0, 54, 32, tzinfo=pytz.UTC)
    tao_taouser_39.institution = u'The University of Melbourne'
    tao_taouser_39.scientific_interests = u'- Interests: Galaxy formation and evolution, epoch of reionization, galaxy modelling techniques.\r\n\r\n- Team membership: DRAGONS, SAMI, CANDELS, WALLABY.\r\n\r\n- Collaborators: Stuart Wyithe, Darren Croton, Greg Poole, Alan Duffy, Chris Power, Andrei Mesinger\r\n\r\n- Plans for data: Comparsion with our DRAGONS semi-analytic model (which we will hopefully add to TAO in future). Construction of mock lightcones to investigate high redshift progenitors of local galaxies and their observed properties.'
    tao_taouser_39.title = u'Dr'
    tao_taouser_39.rejected = False
    tao_taouser_39.aaf_shared_token = u''
    tao_taouser_39.account_registration_status = u'NA'
    tao_taouser_39.account_registration_reason = u''
    tao_taouser_39.account_registration_date = datetime.datetime(2013, 10, 18, 0, 55, 49, tzinfo=pytz.UTC)
    tao_taouser_39.disk_quota = 0L
    tao_taouser_39 = save_or_locate(tao_taouser_39)

    tao_taouser_40 = TaoUser()
    tao_taouser_40.password = u'pbkdf2_sha256$10000$xK8xKe7cRRO0$0Wp7VIbaCqD8Sbj9+Bo/hGOZ77uL/2wMPigFUvXABS4='
    tao_taouser_40.last_login = datetime.datetime(2013, 10, 18, 3, 46, 8, tzinfo=pytz.UTC)
    tao_taouser_40.is_superuser = False
    tao_taouser_40.username = u'cooke'
    tao_taouser_40.first_name = u'Jeff'
    tao_taouser_40.last_name = u'Cooke'
    tao_taouser_40.email = u'jcooke@astro.swin.edu.au'
    tao_taouser_40.is_staff = False
    tao_taouser_40.is_active = True
    tao_taouser_40.date_joined = datetime.datetime(2013, 10, 18, 3, 39, 46, tzinfo=pytz.UTC)
    tao_taouser_40.institution = u'Swinburne'
    tao_taouser_40.scientific_interests = u'galaxy formation and evolution'
    tao_taouser_40.title = u'Dr'
    tao_taouser_40.rejected = False
    tao_taouser_40.aaf_shared_token = u''
    tao_taouser_40.account_registration_status = u'NA'
    tao_taouser_40.account_registration_reason = u''
    tao_taouser_40.account_registration_date = datetime.datetime(2013, 10, 18, 3, 41, 56, tzinfo=pytz.UTC)
    tao_taouser_40.disk_quota = 0L
    tao_taouser_40 = save_or_locate(tao_taouser_40)

    tao_taouser_41 = TaoUser()
    tao_taouser_41.password = u'pbkdf2_sha256$10000$3I5dEHDkz3DA$z8lGAVkzZV2CEMSPr02iHj0TjTLkkhhdKC4lmGAndyE='
    tao_taouser_41.last_login = datetime.datetime(2013, 10, 21, 9, 52, 4, tzinfo=pytz.UTC)
    tao_taouser_41.is_superuser = False
    tao_taouser_41.username = u'vrooje'
    tao_taouser_41.first_name = u'Brooke'
    tao_taouser_41.last_name = u'Simmons'
    tao_taouser_41.email = u'vrooje@gmail.com'
    tao_taouser_41.is_staff = False
    tao_taouser_41.is_active = True
    tao_taouser_41.date_joined = datetime.datetime(2013, 10, 21, 9, 42, 49, tzinfo=pytz.UTC)
    tao_taouser_41.institution = u'University of Oxford'
    tao_taouser_41.scientific_interests = u'Co-evolution of black holes and galaxies, galaxy evolution, citizen science\r\n\r\nTeams: Galaxy Zoo, CANDELS, COSMOS'
    tao_taouser_41.title = u'Dr'
    tao_taouser_41.rejected = False
    tao_taouser_41.aaf_shared_token = u''
    tao_taouser_41.account_registration_status = u'NA'
    tao_taouser_41.account_registration_reason = u''
    tao_taouser_41.account_registration_date = datetime.datetime(2013, 10, 21, 9, 47, 18, tzinfo=pytz.UTC)
    tao_taouser_41.disk_quota = 0L
    tao_taouser_41 = save_or_locate(tao_taouser_41)

    tao_taouser_42 = TaoUser()
    tao_taouser_42.password = u''
    tao_taouser_42.last_login = datetime.datetime(2013, 11, 1, 3, 34, 8, tzinfo=pytz.UTC)
    tao_taouser_42.is_superuser = False
    tao_taouser_42.username = u'oCjO5LJwbcMXUASnBdxPEZFT3eY'
    tao_taouser_42.first_name = u'Patricia'
    tao_taouser_42.last_name = u'McMillan'
    tao_taouser_42.email = u'patricia@intersect.org.au'
    tao_taouser_42.is_staff = False
    tao_taouser_42.is_active = True
    tao_taouser_42.date_joined = datetime.datetime(2013, 11, 1, 3, 34, 8, tzinfo=pytz.UTC)
    tao_taouser_42.institution = u'Intersect'
    tao_taouser_42.scientific_interests = None
    tao_taouser_42.title = u'Ms'
    tao_taouser_42.rejected = False
    tao_taouser_42.aaf_shared_token = u'oCjO5LJwbcMXUASnBdxPEZFT3eY'
    tao_taouser_42.account_registration_status = u'APR'
    tao_taouser_42.account_registration_reason = u''
    tao_taouser_42.account_registration_date = datetime.datetime(2013, 11, 1, 4, 14, 38, tzinfo=pytz.UTC)
    tao_taouser_42.disk_quota = 0L
    tao_taouser_42 = save_or_locate(tao_taouser_42)
    ...
    tao_dataset_1.import_date = datetime.date(2013, 8, 19)
    tao_dataset_1.available = True
    tao_dataset_1.default_filter_field = None
    tao_dataset_1.default_filter_min = None
    ...
    tao_dataset_2.import_date = datetime.date(2013, 8, 19)
    tao_dataset_2.available = True
    tao_dataset_2.default_filter_field = None
    tao_dataset_2.default_filter_min = None
    ...
    tao_dataset_3.import_date = datetime.date(2013, 8, 19)
    tao_dataset_3.available = True
    tao_dataset_3.default_filter_field = None
    tao_dataset_3.default_filter_min = None
    ...
    tao_dataset_4.database = u'millennium_mini_galacticus_4'
    tao_dataset_4.version = Decimal('1.00')
    tao_dataset_4.import_date = datetime.date(2013, 10, 12)
    tao_dataset_4.available = False
    tao_dataset_4.default_filter_field = None
    tao_dataset_4.default_filter_min = None
