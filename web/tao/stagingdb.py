...
# /home/alistair/python/tao/bin/manage.py dumpscript tao tap
#
# to restore it, run
...
def import_data():
    ...
    tao_simulation_1 = importer.save_or_locate(tao_simulation_1)
    ...
    tao_simulation_2 = importer.save_or_locate(tao_simulation_2)
    ...
    tao_simulation_3 = importer.save_or_locate(tao_simulation_3)
    ...
    tao_galaxymodel_1 = importer.save_or_locate(tao_galaxymodel_1)
    ...
    tao_galaxymodel_2 = importer.save_or_locate(tao_galaxymodel_2)
    ...
    tao_stellarmodel_1 = importer.save_or_locate(tao_stellarmodel_1)
    ...
    tao_stellarmodel_2 = importer.save_or_locate(tao_stellarmodel_2)
    ...
    tao_stellarmodel_3 = importer.save_or_locate(tao_stellarmodel_3)
    ...
    tao_stellarmodel_4 = importer.save_or_locate(tao_stellarmodel_4)
    ...
    tao_stellarmodel_5 = importer.save_or_locate(tao_stellarmodel_5)
    ...
    tao_stellarmodel_6 = importer.save_or_locate(tao_stellarmodel_6)
    ...
    tao_stellarmodel_7 = importer.save_or_locate(tao_stellarmodel_7)
    ...
    tao_stellarmodel_8 = importer.save_or_locate(tao_stellarmodel_8)

    tao_stellarmodel_9 = StellarModel()
    tao_stellarmodel_9.name = u'bc03_half/ssp_chabrier.dat'
    tao_stellarmodel_9.label = u'Bruzual & Charlot (2003), Chabrier IMF (low resolution)'
    tao_stellarmodel_9.description = u'<p>External link: <a href="http://www2.iap.fr/users/charlot/bc2003/" target="_blank">GALAXEV</a></p>\r\n<ul>\r\n<li>Both the age and wavelength bins have been reduced by half to improve performance</li>\r\n<li>All magnitudes assume the simulation little h value from General Properties</li>\r\n<li>Magnitudes are calculated in the AB system</li>\r\n</ul>\r\n<p>Additional information is available from the <a href="../static/docs/user-manual/sed.html" target="_blank">SED Module documentation</a>.</p>'
    tao_stellarmodel_9.encoding = u'<single-stellar-population-model>bc03_half/ssp_chabrier.dat</single-stellar-population-model>\r\n<wavelengths-file>bc03_half/wavelengths.dat</wavelengths-file>\r\n<ages-file>bc03_half/ages.dat</ages-file>\r\n<metallicities-file>bc03_half/metallicities.dat</metallicities-file>\r\n'
    tao_stellarmodel_9 = importer.save_or_locate(tao_stellarmodel_9)

    tao_stellarmodel_10 = StellarModel()
    tao_stellarmodel_10.name = u'bc03_half/ssp_salpeter.dat'
    tao_stellarmodel_10.label = u'Bruzual & Charlot (2003), Salpeter IMF (low resolution)'
    tao_stellarmodel_10.description = u'<p>External link: <a href="http://www2.iap.fr/users/charlot/bc2003/" target="_blank">GALAXEV</a></p>\r\n<ul>\r\n<li>Both the age and wavelength bins have been halved to improve performance</li>\r\n<li>All magnitudes assume the simulation little h value from General Properties</li>\r\n<li>Magnitudes are calculated in the AB system</li>\r\n</ul>\r\n<p>Additional information is available from the <a href="../static/docs/user-manual/sed.html" target="_blank">SED Module documentation</a>.</p>'
    tao_stellarmodel_10.encoding = u'<single-stellar-population-model>bc03_half/ssp_salpeter.dat</single-stellar-population-model>\r\n<wavelengths-file>bc03_half/wavelengths.dat</wavelengths-file>\r\n<ages-file>bc03_half/ages.dat</ages-file>\r\n<metallicities-file>bc03_half/metallicities.dat</metallicities-file>'
    tao_stellarmodel_10 = importer.save_or_locate(tao_stellarmodel_10)

    tao_stellarmodel_11 = StellarModel()
    tao_stellarmodel_11.name = u'bc03_half/ssp_kroupa.dat'
    tao_stellarmodel_11.label = u'Bruzual & Charlot (2003), Kroupa IMF (low resolution)'
    tao_stellarmodel_11.description = u'<p>External link: <a href="http://www2.iap.fr/users/charlot/bc2003/" target="_blank">GALAXEV</a></p>\r\n<ul>\r\n<li>Both the age and wavelength bins have been halved to improve performance</li>\r\n<li>All magnitudes assume the simulation little h value from General Properties</li>\r\n<li>Magnitudes are calculated in the AB system</li>\r\n</ul>\r\n<p>Additional information is available from the <a href="../static/docs/user-manual/sed.html" target="_blank">SED Module documentation</a>.</p>'
    tao_stellarmodel_11.encoding = u'<single-stellar-population-model>bc03_half/ssp_kroupa.dat</single-stellar-population-model>\r\n<wavelengths-file>bc03_half/wavelengths.dat</wavelengths-file>\r\n<ages-file>bc03_half/ages.dat</ages-file>\r\n<metallicities-file>bc03_half/metallicities.dat</metallicities-file>\r\n'
    tao_stellarmodel_11 = importer.save_or_locate(tao_stellarmodel_11)
    ...
    tao_bandpassfilter_1 = importer.save_or_locate(tao_bandpassfilter_1)
    ...
    tao_bandpassfilter_2 = importer.save_or_locate(tao_bandpassfilter_2)
    ...
    tao_bandpassfilter_3 = importer.save_or_locate(tao_bandpassfilter_3)
    ...
    tao_bandpassfilter_4 = importer.save_or_locate(tao_bandpassfilter_4)
    ...
    tao_bandpassfilter_5 = importer.save_or_locate(tao_bandpassfilter_5)
    ...
    tao_bandpassfilter_6 = importer.save_or_locate(tao_bandpassfilter_6)
    ...
    tao_bandpassfilter_7 = importer.save_or_locate(tao_bandpassfilter_7)
    ...
    tao_bandpassfilter_8 = importer.save_or_locate(tao_bandpassfilter_8)
    ...
    tao_bandpassfilter_9 = importer.save_or_locate(tao_bandpassfilter_9)
    ...
    tao_bandpassfilter_10 = importer.save_or_locate(tao_bandpassfilter_10)
    ...
    tao_bandpassfilter_11 = importer.save_or_locate(tao_bandpassfilter_11)
    ...
    tao_bandpassfilter_12 = importer.save_or_locate(tao_bandpassfilter_12)
    ...
    tao_bandpassfilter_13 = importer.save_or_locate(tao_bandpassfilter_13)
    ...
    tao_bandpassfilter_14 = importer.save_or_locate(tao_bandpassfilter_14)
    ...
    tao_bandpassfilter_15 = importer.save_or_locate(tao_bandpassfilter_15)
    ...
    tao_bandpassfilter_16 = importer.save_or_locate(tao_bandpassfilter_16)
    ...
    tao_bandpassfilter_17 = importer.save_or_locate(tao_bandpassfilter_17)
    ...
    tao_bandpassfilter_18 = importer.save_or_locate(tao_bandpassfilter_18)
    ...
    tao_bandpassfilter_19 = importer.save_or_locate(tao_bandpassfilter_19)
    ...
    tao_bandpassfilter_20 = importer.save_or_locate(tao_bandpassfilter_20)
    ...
    tao_bandpassfilter_21 = importer.save_or_locate(tao_bandpassfilter_21)
    ...
    tao_bandpassfilter_22 = importer.save_or_locate(tao_bandpassfilter_22)
    ...
    tao_bandpassfilter_23 = importer.save_or_locate(tao_bandpassfilter_23)
    ...
    tao_bandpassfilter_24 = importer.save_or_locate(tao_bandpassfilter_24)
    ...
    tao_bandpassfilter_25 = importer.save_or_locate(tao_bandpassfilter_25)
    ...
    tao_bandpassfilter_26 = importer.save_or_locate(tao_bandpassfilter_26)
    ...
    tao_bandpassfilter_27 = importer.save_or_locate(tao_bandpassfilter_27)
    ...
    tao_bandpassfilter_28 = importer.save_or_locate(tao_bandpassfilter_28)
    ...
    tao_bandpassfilter_29 = importer.save_or_locate(tao_bandpassfilter_29)
    ...
    tao_bandpassfilter_30 = importer.save_or_locate(tao_bandpassfilter_30)
    ...
    tao_bandpassfilter_31 = importer.save_or_locate(tao_bandpassfilter_31)
    ...
    tao_bandpassfilter_32 = importer.save_or_locate(tao_bandpassfilter_32)
    ...
    tao_bandpassfilter_33 = importer.save_or_locate(tao_bandpassfilter_33)
    ...
    tao_bandpassfilter_34 = importer.save_or_locate(tao_bandpassfilter_34)
    ...
    tao_bandpassfilter_35 = importer.save_or_locate(tao_bandpassfilter_35)
    ...
    tao_bandpassfilter_36 = importer.save_or_locate(tao_bandpassfilter_36)
    ...
    tao_bandpassfilter_37 = importer.save_or_locate(tao_bandpassfilter_37)
    ...
    tao_bandpassfilter_38 = importer.save_or_locate(tao_bandpassfilter_38)
    ...
    tao_bandpassfilter_39 = importer.save_or_locate(tao_bandpassfilter_39)
    ...
    tao_bandpassfilter_40 = importer.save_or_locate(tao_bandpassfilter_40)
    ...
    tao_bandpassfilter_41 = importer.save_or_locate(tao_bandpassfilter_41)
    ...
    tao_bandpassfilter_42 = importer.save_or_locate(tao_bandpassfilter_42)
    ...
    tao_bandpassfilter_43 = importer.save_or_locate(tao_bandpassfilter_43)
    ...
    tao_bandpassfilter_44 = importer.save_or_locate(tao_bandpassfilter_44)
    ...
    tao_bandpassfilter_45 = importer.save_or_locate(tao_bandpassfilter_45)
    ...
    tao_bandpassfilter_46 = importer.save_or_locate(tao_bandpassfilter_46)
    ...
    tao_bandpassfilter_47 = importer.save_or_locate(tao_bandpassfilter_47)
    ...
    tao_bandpassfilter_48 = importer.save_or_locate(tao_bandpassfilter_48)
    ...
    tao_bandpassfilter_49 = importer.save_or_locate(tao_bandpassfilter_49)
    ...
    tao_bandpassfilter_50 = importer.save_or_locate(tao_bandpassfilter_50)
    ...
    tao_bandpassfilter_51 = importer.save_or_locate(tao_bandpassfilter_51)
    ...
    tao_bandpassfilter_52 = importer.save_or_locate(tao_bandpassfilter_52)
    ...
    tao_bandpassfilter_53 = importer.save_or_locate(tao_bandpassfilter_53)
    ...
    tao_bandpassfilter_54 = importer.save_or_locate(tao_bandpassfilter_54)
    ...
    tao_bandpassfilter_55 = importer.save_or_locate(tao_bandpassfilter_55)
    ...
    tao_bandpassfilter_56 = importer.save_or_locate(tao_bandpassfilter_56)
    ...
    tao_bandpassfilter_57 = importer.save_or_locate(tao_bandpassfilter_57)
    ...
    tao_bandpassfilter_58 = importer.save_or_locate(tao_bandpassfilter_58)
    ...
    tao_bandpassfilter_59 = importer.save_or_locate(tao_bandpassfilter_59)
    ...
    tao_bandpassfilter_60 = importer.save_or_locate(tao_bandpassfilter_60)
    ...
    tao_bandpassfilter_61 = importer.save_or_locate(tao_bandpassfilter_61)
    ...
    tao_bandpassfilter_62 = importer.save_or_locate(tao_bandpassfilter_62)
    ...
    tao_bandpassfilter_63 = importer.save_or_locate(tao_bandpassfilter_63)
    ...
    tao_bandpassfilter_64 = importer.save_or_locate(tao_bandpassfilter_64)
    ...
    tao_bandpassfilter_65 = importer.save_or_locate(tao_bandpassfilter_65)
    ...
    tao_bandpassfilter_66 = importer.save_or_locate(tao_bandpassfilter_66)
    ...
    tao_bandpassfilter_67 = importer.save_or_locate(tao_bandpassfilter_67)
    ...
    tao_bandpassfilter_68 = importer.save_or_locate(tao_bandpassfilter_68)
    ...
    tao_bandpassfilter_69 = importer.save_or_locate(tao_bandpassfilter_69)
    ...
    tao_bandpassfilter_70 = importer.save_or_locate(tao_bandpassfilter_70)
    ...
    tao_bandpassfilter_71 = importer.save_or_locate(tao_bandpassfilter_71)
    ...
    tao_bandpassfilter_72 = importer.save_or_locate(tao_bandpassfilter_72)
    ...
    tao_bandpassfilter_73 = importer.save_or_locate(tao_bandpassfilter_73)
    ...
    tao_bandpassfilter_74 = importer.save_or_locate(tao_bandpassfilter_74)
    ...
    tao_bandpassfilter_75 = importer.save_or_locate(tao_bandpassfilter_75)
    ...
    tao_bandpassfilter_76 = importer.save_or_locate(tao_bandpassfilter_76)
    ...
    tao_bandpassfilter_77 = importer.save_or_locate(tao_bandpassfilter_77)
    ...
    tao_bandpassfilter_78 = importer.save_or_locate(tao_bandpassfilter_78)
    ...
    tao_bandpassfilter_79 = importer.save_or_locate(tao_bandpassfilter_79)
    ...
    tao_bandpassfilter_80 = importer.save_or_locate(tao_bandpassfilter_80)
    ...
    tao_bandpassfilter_81 = importer.save_or_locate(tao_bandpassfilter_81)
    ...
    tao_bandpassfilter_82 = importer.save_or_locate(tao_bandpassfilter_82)
    ...
    tao_bandpassfilter_83 = importer.save_or_locate(tao_bandpassfilter_83)
    ...
    tao_bandpassfilter_84 = importer.save_or_locate(tao_bandpassfilter_84)
    ...
    tao_bandpassfilter_85 = importer.save_or_locate(tao_bandpassfilter_85)
    ...
    tao_bandpassfilter_86 = importer.save_or_locate(tao_bandpassfilter_86)
    ...
    tao_bandpassfilter_87 = importer.save_or_locate(tao_bandpassfilter_87)
    ...
    tao_dustmodel_1 = importer.save_or_locate(tao_dustmodel_1)
    ...
    tao_globalparameter_1 = importer.save_or_locate(tao_globalparameter_1)
    ...
    tao_globalparameter_2 = importer.save_or_locate(tao_globalparameter_2)
    ...
    tao_globalparameter_3 = importer.save_or_locate(tao_globalparameter_3)
    ...
    tao_globalparameter_4 = importer.save_or_locate(tao_globalparameter_4)
    ...
    tao_globalparameter_5 = importer.save_or_locate(tao_globalparameter_5)

    tao_globalparameter_6 = GlobalParameter()
    tao_globalparameter_6.parameter_name = u'reject.txt'
    tao_globalparameter_6.parameter_value = u' '
    tao_globalparameter_6.description = u"Template for reject email, text version.  Currently empty as Darren doesn't want to notify users of rejection.\r\n\r\nMacros: title, first_name, last_name, reason\r\n\r\nOriginal version:\r\n\r\nHello {{ title }} {{ first_name }} {{ last_name }}.\r\n\r\nYou have been rejected from using the ASVO-TAO Staging system.\r\n\r\nReason:\r\n{{ reason }}"
    tao_globalparameter_6 = importer.save_or_locate(tao_globalparameter_6)
    ...
    tao_globalparameter_7 = importer.save_or_locate(tao_globalparameter_7)
    ...
    tao_globalparameter_8 = importer.save_or_locate(tao_globalparameter_8)
    ...
    tao_globalparameter_9 = importer.save_or_locate(tao_globalparameter_9)
    ...
    tao_globalparameter_10 = importer.save_or_locate(tao_globalparameter_10)
    ...
    tao_globalparameter_11 = importer.save_or_locate(tao_globalparameter_11)

    tao_globalparameter_12 = GlobalParameter()
    tao_globalparameter_12.parameter_name = u'support-recipients'
    tao_globalparameter_12.parameter_value = u'alistair@intersect.org.au, dcroton@astro.swin.edu.au, lhodkins@astro.swin.edu.au, ahassan@astro.swin.edu.au'
    tao_globalparameter_12.description = u'List of recipients to send support emails'
    tao_globalparameter_12 = importer.save_or_locate(tao_globalparameter_12)
    ...
    tao_globalparameter_13 = importer.save_or_locate(tao_globalparameter_13)
    ...
    tao_globalparameter_14 = importer.save_or_locate(tao_globalparameter_14)
    ...
    tao_globalparameter_15 = importer.save_or_locate(tao_globalparameter_15)
    ...
    tao_globalparameter_16 = importer.save_or_locate(tao_globalparameter_16)
    ...
    tao_globalparameter_17 = importer.save_or_locate(tao_globalparameter_17)
    ...
    tao_surveypreset_1 = importer.save_or_locate(tao_surveypreset_1)
    ...
    tao_surveypreset_2 = importer.save_or_locate(tao_surveypreset_2)
    ...
    tao_surveypreset_3 = importer.save_or_locate(tao_surveypreset_3)
    ...
    tao_dataset_1.database = u'millennium_full_dist_v2'
    ...
    tao_dataset_4 = importer.save_or_locate(tao_dataset_4)
    ...
    tao_datasetproperty_1 = importer.save_or_locate(tao_datasetproperty_1)
    ...
    tao_datasetproperty_2 = importer.save_or_locate(tao_datasetproperty_2)
    ...
    tao_datasetproperty_3 = importer.save_or_locate(tao_datasetproperty_3)
    ...
    tao_datasetproperty_4 = importer.save_or_locate(tao_datasetproperty_4)
    ...
    tao_datasetproperty_5 = importer.save_or_locate(tao_datasetproperty_5)
    ...
    tao_datasetproperty_6 = importer.save_or_locate(tao_datasetproperty_6)
    ...
    tao_datasetproperty_7 = importer.save_or_locate(tao_datasetproperty_7)
    ...
    tao_datasetproperty_8 = importer.save_or_locate(tao_datasetproperty_8)
    ...
    tao_datasetproperty_9 = importer.save_or_locate(tao_datasetproperty_9)
    ...
    tao_datasetproperty_10 = importer.save_or_locate(tao_datasetproperty_10)
    ...
    tao_datasetproperty_11 = importer.save_or_locate(tao_datasetproperty_11)
    ...
    tao_datasetproperty_12 = importer.save_or_locate(tao_datasetproperty_12)
    ...
    tao_datasetproperty_13 = importer.save_or_locate(tao_datasetproperty_13)
    ...
    tao_datasetproperty_14 = importer.save_or_locate(tao_datasetproperty_14)
    ...
    tao_datasetproperty_15 = importer.save_or_locate(tao_datasetproperty_15)
    ...
    tao_datasetproperty_16 = importer.save_or_locate(tao_datasetproperty_16)
    ...
    tao_datasetproperty_17 = importer.save_or_locate(tao_datasetproperty_17)
    ...
    tao_datasetproperty_18 = importer.save_or_locate(tao_datasetproperty_18)
    ...
    tao_datasetproperty_19 = importer.save_or_locate(tao_datasetproperty_19)
    ...
    tao_datasetproperty_20 = importer.save_or_locate(tao_datasetproperty_20)
    ...
    tao_datasetproperty_21 = importer.save_or_locate(tao_datasetproperty_21)
    ...
    tao_datasetproperty_22 = importer.save_or_locate(tao_datasetproperty_22)
    ...
    tao_datasetproperty_23 = importer.save_or_locate(tao_datasetproperty_23)
    ...
    tao_datasetproperty_24 = importer.save_or_locate(tao_datasetproperty_24)
    ...
    tao_datasetproperty_25 = importer.save_or_locate(tao_datasetproperty_25)
    ...
    tao_datasetproperty_26 = importer.save_or_locate(tao_datasetproperty_26)
    ...
    tao_datasetproperty_27 = importer.save_or_locate(tao_datasetproperty_27)
    ...
    tao_datasetproperty_28 = importer.save_or_locate(tao_datasetproperty_28)
    ...
    tao_datasetproperty_29 = importer.save_or_locate(tao_datasetproperty_29)
    ...
    tao_datasetproperty_30 = importer.save_or_locate(tao_datasetproperty_30)
    ...
    tao_datasetproperty_31 = importer.save_or_locate(tao_datasetproperty_31)
    ...
    tao_datasetproperty_32 = importer.save_or_locate(tao_datasetproperty_32)
    ...
    tao_datasetproperty_33 = importer.save_or_locate(tao_datasetproperty_33)
    ...
    tao_datasetproperty_34 = importer.save_or_locate(tao_datasetproperty_34)
    ...
    tao_datasetproperty_35 = importer.save_or_locate(tao_datasetproperty_35)
    ...
    tao_datasetproperty_36 = importer.save_or_locate(tao_datasetproperty_36)
    ...
    tao_datasetproperty_37 = importer.save_or_locate(tao_datasetproperty_37)
    ...
    tao_datasetproperty_38 = importer.save_or_locate(tao_datasetproperty_38)
    ...
    tao_datasetproperty_39 = importer.save_or_locate(tao_datasetproperty_39)
    ...
    tao_datasetproperty_40 = importer.save_or_locate(tao_datasetproperty_40)
    ...
    tao_datasetproperty_41 = importer.save_or_locate(tao_datasetproperty_41)
    ...
    tao_datasetproperty_42 = importer.save_or_locate(tao_datasetproperty_42)
    ...
    tao_datasetproperty_43 = importer.save_or_locate(tao_datasetproperty_43)
    ...
    tao_datasetproperty_44 = importer.save_or_locate(tao_datasetproperty_44)
    ...
    tao_datasetproperty_45 = importer.save_or_locate(tao_datasetproperty_45)
    ...
    tao_datasetproperty_46 = importer.save_or_locate(tao_datasetproperty_46)
    ...
    tao_datasetproperty_47 = importer.save_or_locate(tao_datasetproperty_47)
    ...
    tao_datasetproperty_48 = importer.save_or_locate(tao_datasetproperty_48)
    ...
    tao_datasetproperty_49 = importer.save_or_locate(tao_datasetproperty_49)
    ...
    tao_datasetproperty_50 = importer.save_or_locate(tao_datasetproperty_50)
    ...
    tao_datasetproperty_51 = importer.save_or_locate(tao_datasetproperty_51)
    ...
    tao_datasetproperty_52 = importer.save_or_locate(tao_datasetproperty_52)
    ...
    tao_datasetproperty_53 = importer.save_or_locate(tao_datasetproperty_53)
    ...
    tao_datasetproperty_54 = importer.save_or_locate(tao_datasetproperty_54)
    ...
    tao_datasetproperty_55 = importer.save_or_locate(tao_datasetproperty_55)
    ...
    tao_datasetproperty_56 = importer.save_or_locate(tao_datasetproperty_56)
    ...
    tao_datasetproperty_57 = importer.save_or_locate(tao_datasetproperty_57)
    ...
    tao_datasetproperty_58 = importer.save_or_locate(tao_datasetproperty_58)
    ...
    tao_datasetproperty_59 = importer.save_or_locate(tao_datasetproperty_59)
    ...
    tao_datasetproperty_60 = importer.save_or_locate(tao_datasetproperty_60)
    ...
    tao_datasetproperty_61 = importer.save_or_locate(tao_datasetproperty_61)
    ...
    tao_datasetproperty_62 = importer.save_or_locate(tao_datasetproperty_62)
    ...
    tao_datasetproperty_63 = importer.save_or_locate(tao_datasetproperty_63)
    ...
    tao_datasetproperty_64 = importer.save_or_locate(tao_datasetproperty_64)
    ...
    tao_datasetproperty_65 = importer.save_or_locate(tao_datasetproperty_65)
    ...
    tao_datasetproperty_66 = importer.save_or_locate(tao_datasetproperty_66)
    ...
    tao_datasetproperty_67 = importer.save_or_locate(tao_datasetproperty_67)
    ...
    tao_datasetproperty_68 = importer.save_or_locate(tao_datasetproperty_68)
    ...
    tao_datasetproperty_69 = importer.save_or_locate(tao_datasetproperty_69)
    ...
    tao_datasetproperty_70 = importer.save_or_locate(tao_datasetproperty_70)
    ...
    tao_datasetproperty_71 = importer.save_or_locate(tao_datasetproperty_71)
    ...
    tao_datasetproperty_72 = importer.save_or_locate(tao_datasetproperty_72)
    ...
    tao_datasetproperty_73 = importer.save_or_locate(tao_datasetproperty_73)
    ...
    tao_datasetproperty_74 = importer.save_or_locate(tao_datasetproperty_74)
    ...
    tao_datasetproperty_75 = importer.save_or_locate(tao_datasetproperty_75)
    ...
    tao_datasetproperty_76 = importer.save_or_locate(tao_datasetproperty_76)
    ...
    tao_datasetproperty_77 = importer.save_or_locate(tao_datasetproperty_77)
    ...
    tao_datasetproperty_78 = importer.save_or_locate(tao_datasetproperty_78)
    ...
    tao_datasetproperty_79 = importer.save_or_locate(tao_datasetproperty_79)
    ...
    tao_datasetproperty_80 = importer.save_or_locate(tao_datasetproperty_80)
    ...
    tao_datasetproperty_81 = importer.save_or_locate(tao_datasetproperty_81)
    ...
    tao_datasetproperty_82 = importer.save_or_locate(tao_datasetproperty_82)
    ...
    tao_datasetproperty_83 = importer.save_or_locate(tao_datasetproperty_83)
    ...
    tao_datasetproperty_84 = importer.save_or_locate(tao_datasetproperty_84)
    ...
    tao_datasetproperty_85 = importer.save_or_locate(tao_datasetproperty_85)
    ...
    tao_datasetproperty_86 = importer.save_or_locate(tao_datasetproperty_86)
    ...
    tao_datasetproperty_87 = importer.save_or_locate(tao_datasetproperty_87)
    ...
    tao_datasetproperty_88 = importer.save_or_locate(tao_datasetproperty_88)
    ...
    tao_datasetproperty_89 = importer.save_or_locate(tao_datasetproperty_89)
    ...
    tao_datasetproperty_90 = importer.save_or_locate(tao_datasetproperty_90)
    ...
    tao_datasetproperty_91 = importer.save_or_locate(tao_datasetproperty_91)
    ...
    tao_datasetproperty_92 = importer.save_or_locate(tao_datasetproperty_92)
    ...
    tao_datasetproperty_93 = importer.save_or_locate(tao_datasetproperty_93)
    ...
    tao_datasetproperty_94 = importer.save_or_locate(tao_datasetproperty_94)
    ...
    tao_datasetproperty_95 = importer.save_or_locate(tao_datasetproperty_95)
    ...
    tao_datasetproperty_96 = importer.save_or_locate(tao_datasetproperty_96)
    ...
    tao_datasetproperty_97 = importer.save_or_locate(tao_datasetproperty_97)
    ...
    tao_datasetproperty_98 = importer.save_or_locate(tao_datasetproperty_98)
    ...
    tao_datasetproperty_99 = importer.save_or_locate(tao_datasetproperty_99)
    ...
    tao_datasetproperty_100 = importer.save_or_locate(tao_datasetproperty_100)
    ...
    tao_datasetproperty_101 = importer.save_or_locate(tao_datasetproperty_101)
    ...
    tao_datasetproperty_102 = importer.save_or_locate(tao_datasetproperty_102)
    ...
    tao_datasetproperty_103 = importer.save_or_locate(tao_datasetproperty_103)
    ...
    tao_datasetproperty_104 = importer.save_or_locate(tao_datasetproperty_104)
    ...
    tao_datasetproperty_105 = importer.save_or_locate(tao_datasetproperty_105)
    ...
    tao_datasetproperty_106 = importer.save_or_locate(tao_datasetproperty_106)
    ...
    tao_datasetproperty_107 = importer.save_or_locate(tao_datasetproperty_107)
    ...
    tao_datasetproperty_108 = importer.save_or_locate(tao_datasetproperty_108)
    ...
    tao_datasetproperty_109 = importer.save_or_locate(tao_datasetproperty_109)
    ...
    tao_datasetproperty_110 = importer.save_or_locate(tao_datasetproperty_110)
    ...
    tao_datasetproperty_111 = importer.save_or_locate(tao_datasetproperty_111)
    ...
    tao_datasetproperty_112 = importer.save_or_locate(tao_datasetproperty_112)
    ...
    tao_datasetproperty_113 = importer.save_or_locate(tao_datasetproperty_113)
    ...
    tao_datasetproperty_114 = importer.save_or_locate(tao_datasetproperty_114)
    ...
    tao_datasetproperty_115 = importer.save_or_locate(tao_datasetproperty_115)
    ...
    tao_datasetproperty_116 = importer.save_or_locate(tao_datasetproperty_116)
    ...
    tao_datasetproperty_117 = importer.save_or_locate(tao_datasetproperty_117)
    ...
    tao_datasetproperty_118 = importer.save_or_locate(tao_datasetproperty_118)
    ...
    tao_datasetproperty_119 = importer.save_or_locate(tao_datasetproperty_119)
    ...
    tao_datasetproperty_120 = importer.save_or_locate(tao_datasetproperty_120)
    ...
    tao_datasetproperty_121 = importer.save_or_locate(tao_datasetproperty_121)
    ...
    tao_datasetproperty_122 = importer.save_or_locate(tao_datasetproperty_122)
    ...
    tao_datasetproperty_123 = importer.save_or_locate(tao_datasetproperty_123)
    ...
    tao_datasetproperty_124 = importer.save_or_locate(tao_datasetproperty_124)
    ...
    tao_datasetproperty_125 = importer.save_or_locate(tao_datasetproperty_125)
    ...
    tao_datasetproperty_126 = importer.save_or_locate(tao_datasetproperty_126)
    ...
    tao_datasetproperty_127 = importer.save_or_locate(tao_datasetproperty_127)
    ...
    tao_datasetproperty_128 = importer.save_or_locate(tao_datasetproperty_128)
    ...
    tao_datasetproperty_129 = importer.save_or_locate(tao_datasetproperty_129)
    ...
    tao_datasetproperty_130 = importer.save_or_locate(tao_datasetproperty_130)
    ...
    tao_datasetproperty_131 = importer.save_or_locate(tao_datasetproperty_131)
    ...
    tao_datasetproperty_132 = importer.save_or_locate(tao_datasetproperty_132)
    ...
    tao_datasetproperty_133 = importer.save_or_locate(tao_datasetproperty_133)
    ...
    tao_datasetproperty_134 = importer.save_or_locate(tao_datasetproperty_134)
    ...
    tao_datasetproperty_135 = importer.save_or_locate(tao_datasetproperty_135)
    ...
    tao_datasetproperty_136 = importer.save_or_locate(tao_datasetproperty_136)
    ...
    tao_datasetproperty_137 = importer.save_or_locate(tao_datasetproperty_137)
    ...
    tao_datasetproperty_138 = importer.save_or_locate(tao_datasetproperty_138)
    ...
    tao_datasetproperty_139 = importer.save_or_locate(tao_datasetproperty_139)
    ...
    tao_datasetproperty_140 = importer.save_or_locate(tao_datasetproperty_140)
    ...
    tao_datasetproperty_141 = importer.save_or_locate(tao_datasetproperty_141)
    ...
    tao_datasetproperty_142 = importer.save_or_locate(tao_datasetproperty_142)
    ...
    tao_datasetproperty_143 = importer.save_or_locate(tao_datasetproperty_143)
    ...
    tao_datasetproperty_144 = importer.save_or_locate(tao_datasetproperty_144)
    ...
    tao_datasetproperty_145 = importer.save_or_locate(tao_datasetproperty_145)
    ...
    tao_datasetproperty_146 = importer.save_or_locate(tao_datasetproperty_146)
    ...
    tao_datasetproperty_147 = importer.save_or_locate(tao_datasetproperty_147)
    ...
    tao_datasetproperty_148 = importer.save_or_locate(tao_datasetproperty_148)
    ...
    tao_datasetproperty_149 = importer.save_or_locate(tao_datasetproperty_149)
    ...
    tao_datasetproperty_150 = importer.save_or_locate(tao_datasetproperty_150)
    ...
    tao_datasetproperty_151 = importer.save_or_locate(tao_datasetproperty_151)
    ...
    tao_datasetproperty_152 = importer.save_or_locate(tao_datasetproperty_152)
    ...
    tao_datasetproperty_153 = importer.save_or_locate(tao_datasetproperty_153)
    ...
    tao_datasetproperty_154 = importer.save_or_locate(tao_datasetproperty_154)
    ...
    tao_datasetproperty_155 = importer.save_or_locate(tao_datasetproperty_155)
    ...
    tao_datasetproperty_156 = importer.save_or_locate(tao_datasetproperty_156)
    ...
    tao_datasetproperty_157 = importer.save_or_locate(tao_datasetproperty_157)
    ...
    tao_datasetproperty_158 = importer.save_or_locate(tao_datasetproperty_158)
    ...
    tao_datasetproperty_159 = importer.save_or_locate(tao_datasetproperty_159)
    ...
    tao_datasetproperty_160 = importer.save_or_locate(tao_datasetproperty_160)
    ...
    tao_datasetproperty_161 = importer.save_or_locate(tao_datasetproperty_161)
    ...
    tao_datasetproperty_162 = importer.save_or_locate(tao_datasetproperty_162)
    ...
    tao_datasetproperty_163 = importer.save_or_locate(tao_datasetproperty_163)
    ...
    tao_datasetproperty_164 = importer.save_or_locate(tao_datasetproperty_164)
    ...
    tao_datasetproperty_165 = importer.save_or_locate(tao_datasetproperty_165)
    ...
    tao_datasetproperty_166 = importer.save_or_locate(tao_datasetproperty_166)
    ...
    tao_datasetproperty_167 = importer.save_or_locate(tao_datasetproperty_167)
    ...
    tao_datasetproperty_168 = importer.save_or_locate(tao_datasetproperty_168)
    ...
    tao_datasetproperty_169 = importer.save_or_locate(tao_datasetproperty_169)
    ...
    tao_datasetproperty_170 = importer.save_or_locate(tao_datasetproperty_170)
    ...
    tao_datasetproperty_171 = importer.save_or_locate(tao_datasetproperty_171)
    ...
    tao_datasetproperty_172 = importer.save_or_locate(tao_datasetproperty_172)
    ...
    tao_datasetproperty_173 = importer.save_or_locate(tao_datasetproperty_173)
    ...
    tao_datasetproperty_174 = importer.save_or_locate(tao_datasetproperty_174)
    ...
    tao_datasetproperty_175 = importer.save_or_locate(tao_datasetproperty_175)
    ...
    tao_datasetproperty_176 = importer.save_or_locate(tao_datasetproperty_176)
    ...
    tao_datasetproperty_177 = importer.save_or_locate(tao_datasetproperty_177)
    ...
    tao_datasetproperty_178 = importer.save_or_locate(tao_datasetproperty_178)
    ...
    tao_datasetproperty_179 = importer.save_or_locate(tao_datasetproperty_179)
    ...
    tao_datasetproperty_180 = importer.save_or_locate(tao_datasetproperty_180)
    ...
    tao_datasetproperty_181 = importer.save_or_locate(tao_datasetproperty_181)
    ...
    tao_datasetproperty_182 = importer.save_or_locate(tao_datasetproperty_182)
    ...
    tao_datasetproperty_183 = importer.save_or_locate(tao_datasetproperty_183)
    ...
    tao_datasetproperty_184 = importer.save_or_locate(tao_datasetproperty_184)
    ...
    tao_datasetproperty_185 = importer.save_or_locate(tao_datasetproperty_185)
    ...
    tao_datasetproperty_186 = importer.save_or_locate(tao_datasetproperty_186)
    ...
    tao_datasetproperty_187 = importer.save_or_locate(tao_datasetproperty_187)
    ...
    tao_datasetproperty_188 = importer.save_or_locate(tao_datasetproperty_188)
    ...
    tao_datasetproperty_189 = importer.save_or_locate(tao_datasetproperty_189)
    ...
    tao_datasetproperty_190 = importer.save_or_locate(tao_datasetproperty_190)
    ...
    tao_datasetproperty_191 = importer.save_or_locate(tao_datasetproperty_191)
    ...
    tao_datasetproperty_192 = importer.save_or_locate(tao_datasetproperty_192)
    ...
    tao_datasetproperty_193 = importer.save_or_locate(tao_datasetproperty_193)
    ...
    tao_datasetproperty_194 = importer.save_or_locate(tao_datasetproperty_194)
    ...
    tao_datasetproperty_195 = importer.save_or_locate(tao_datasetproperty_195)
    ...
    tao_datasetproperty_196 = importer.save_or_locate(tao_datasetproperty_196)
    ...
    tao_datasetproperty_197 = importer.save_or_locate(tao_datasetproperty_197)
    ...
    tao_datasetproperty_198 = importer.save_or_locate(tao_datasetproperty_198)
    ...
    tao_datasetproperty_199 = importer.save_or_locate(tao_datasetproperty_199)
    ...
    tao_datasetproperty_200 = importer.save_or_locate(tao_datasetproperty_200)
    ...
    tao_datasetproperty_201 = importer.save_or_locate(tao_datasetproperty_201)
    ...
    tao_datasetproperty_202 = importer.save_or_locate(tao_datasetproperty_202)
    ...
    tao_datasetproperty_203 = importer.save_or_locate(tao_datasetproperty_203)
    ...
    tao_datasetproperty_204 = importer.save_or_locate(tao_datasetproperty_204)
    ...
    tao_datasetproperty_205 = importer.save_or_locate(tao_datasetproperty_205)
    ...
    tao_datasetproperty_206 = importer.save_or_locate(tao_datasetproperty_206)
    ...
    tao_datasetproperty_207 = importer.save_or_locate(tao_datasetproperty_207)
    ...
    tao_datasetproperty_208 = importer.save_or_locate(tao_datasetproperty_208)
