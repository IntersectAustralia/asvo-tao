      ...
      char* argv[] )
{
   ...
   h5::file out( "bolshoi.h5", H5F_ACC_TRUNC );
   out.write<long long>( "/info/forest_trees", forests );
   out.write<unsigned>( "/info/forest_halo_counts", forest_sizes );
   out.write<size_t>( "/info/location_file_offsets", location_offsets );
   out.write<unsigned>( "/info/location_file_indices", location_files );
   out.write<string>( "/info/location_files", file_map );
   LOGILN( "Done.", setindent( -2 ) );
