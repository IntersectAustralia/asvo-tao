...
class Form(BetterForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['ra_opening_angle'].widget.attrs['data-bind'] = 'value: ra_opening_angle, event: { change: check_input_ra_dec("RA")}'
        self.fields['dec_opening_angle'].widget.attrs['data-bind'] = 'value: dec_opening_angle, event: { change: check_input_ra_dec("Dec.")}'
        ...
        self.fields['redshift_min'].widget.attrs['data-bind'] = 'value: redshift_min, event: { change: check_input_redshift_min}'
        self.fields['redshift_max'].widget.attrs['data-bind'] = 'value: redshift_max, event: { change: check_input_redshift_max}'
