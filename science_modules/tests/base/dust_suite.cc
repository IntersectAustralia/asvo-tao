...
TEST_CASE( "/tao/base/dust/calzetti" )
{
   std::vector<tao::real_type> spec( 10 ), res( 10 ), waves( 10 );
   hpc::num::gaussian( spec.begin(), 10, 1e10 );
   hpc::num::linear( waves.begin(), 10, 5000.0, 1000000.0 );
...
TEST_CASE( "/tao/base/dust/slab/constructor/default" )
{
   tao::dust::slab dust;
...
TEST_CASE( "/tao/base/dust/slab/constructor/load" )
{
   hpc::tmpfile tmp;
   {
   ...
   hpc::num::linear( waves.begin(), 5, 1e4, 5e4 );
...
TEST_CASE( "/tao/base/dust/slab" )
{
   tao::dust::slab dust;
   {
      std::vector<tao::real_type> ext( 10 ), alb( 10 ), exp( 10 );
      hpc::num::linear( ext.begin(), 10, 9.0, 1e-3 );
      hpc::num::linear( alb.begin(), 10, 4e-1, 0.0 );
      hpc::num::linear( exp.begin(), 10, -2e-1, 0.0 );
