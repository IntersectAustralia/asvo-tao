...
namespace {
   ...
   test_case<> ANON(
      "/tao/base/simulation/constructor/default",
      "",
      []()
      {
         tao::simulation sim;
   ...
   test_case<> ANON(
      "/tao/base/simulation/constructor/vector",
      "",
      []()
      {
         hpc::vector<tao::real_type> snap_zs( 2 );
   ...
   test_case<> ANON(
      "/tao/base/simulation/constructor/expansions",
      "",
      []()
      {
   ...
   test_case<> ANON(
      "/tao/base/simulation/set_box_size",
      "",
      []()
      {
         tao::simulation sim;
