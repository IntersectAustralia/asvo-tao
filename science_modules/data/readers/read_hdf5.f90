!!
!! Read the contents of an HDF5 file generated by TAO.
!! Look for any comments starting with 'NOTE' to see how
!! you can modify this file to read additional fields
!! from the output file. Please note that this example is setup
!! to show how to stream through the datasets simultaneously
!! in chunks. It could be easier for you to open each dataset
!! one at a time.
!!
PROGRAM read_hdf5
  USE hdf5
