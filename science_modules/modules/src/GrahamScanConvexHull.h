...
struct point2d
{
   point2d(double _x = 0.0 , double _y = 0.0,int _index=0) : x(_x), y(_y),Index(_index){}
   double x;
   double y;
   int Index;
};
...
{
public:
   gs_point2d(double _x = 0.0, double _y = 0.0, double _angle = 0.0,int _index=0) : x(_x), y(_y), angle(_angle),Index(_index){}
   double x;
   double y;
   double angle;
   int Index;
